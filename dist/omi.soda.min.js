...
n.parent?e._isSubInstance(n)||t.push(n):t.push(n)}),this.instances=t}},{key:"_checkSelfUpdateInstance",value:function(e){return this.idArr.indexOf(e.id)!==-1||(e.parent?this._checkSelfUpdateInstance(e.parent):void 0)}},{key:"_isSubInstance",value:function(e){return this.idArr.indexOf(e.parent.id)!==-1||(e.parent.parent?this._isSubInstance(e.parent):void 0)}}]),e}();t.default=i},,function(e,t,n){var r,i;(function(e){"use strict";var n="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e};!function(){var o=/\{\{([^\}]*)\}\}/g,a=function(e){return new RegExp("(^|\\s+)"+e+"(\\s+|$)","g")},s=function(e,t){return e.className?void(e.className.match(a(t))||(e.className+=" "+t)):void(e.className=t)},l=function(e,t){v.lastIndex=0;var n=t.replace(v,function(t){return"undefined"==typeof e[t]?t:e[t]});if("true"===t)return!0;if("false"===t)return!1;var r=function t(r,i){var o=i.indexOf(".");if(o>-1){var a=i.substr(0,o);if(i=i.substr(o+1),"undefined"!=typeof e[a]&&m.test(a)&&(a=e[a]),"undefined"!=typeof r[a])return t(r[a],i);var s={name:n,data:e};return D("nullvalue",{type:"nullattr",data:s},s),""}"undefined"!=typeof e[i]&&m.test(i)&&(i=e[i]);var l;if("undefined"!=typeof r[i])l=r[i];else{var s={name:n,data:e};D("nullvalue",{type:"nullvalue",data:s},s),l=""}return l};return r(e,t)},u=/"([^"]*)"|'([^']*)'/g,c=/[a-zA-Z_\$]+[\w\$]*(?:\s*\.\s*(?:[a-zA-Z_\$]+[\w\$]*|\d+))*/g,d=/\[([^\[\]]*)\]/g,f=/\|\|/g,h="OR_OPERATOR",p=function(){return"$$"+~~(1e6*Math.random())},_="_$C$_",m=/^_\$C\$_/,v=/_\$C\$_[^\.]+/g,y=function(){return _+~~(1e6*Math.random())},g=function e(t,n){t=t.replace(f,h).split("|");for(var r=0;r<t.length;r++)t[r]=(t[r].replace(new RegExp(h,"g"),"||")||"").trim();var i=t[0]||"",o=t.slice(1);for(i=i.replace(u,function(e,t,r){var i=p();return n[i]=t||r,i});d.test(i);)d.lastIndex=0,i=i.replace(d,function(t,r){var i=y(),o=e(r,n);return n[i]=o,"."+i});i=i.replace(c,function(e){return"getValue(scope,'"+e.trim()+"')"});var a=function e(){var t=o.shift();if(t){for(var t=t.split(":"),n=t.slice(1)||[],r=t[0]||"",a=0;a<n.length;a++)c.test(n[a])&&(n[a]="getValue(scope,'"+n[a]+"')");C[r]&&(n.unshift(i),n=n.join(","),i="sodaFilterMap['"+r+"']("+n+")"),e()}};a();var s=new Function("getValue","sodaFilterMap","return function sodaExp(scope){ return "+i+"}")(l,C);return s(n)},b=function e(t,n){3===t.nodeType&&(t.nodeValue=t.nodeValue.replace(o,function(e,t){return g(t,n)})),t.attributes&&(k.map(function(e){var r=e.name,i=e.opt;t.getAttribute(r)&&t.parentNode&&i.link(n,t,t.attributes)}),[].map.call(t.attributes,function(e){if(!S[e.name])if(/^soda-/.test(e.name)){var r=e.name.replace(/^soda-/,"");if(r){var i=e.value.replace(o,function(e,t){return g(t,n)});t.setAttribute(r,i)}}else e.value=e.value.replace(o,function(e,t){return g(t,n)})})),[].map.call([].slice.call(t.childNodes,[]),function(t){e(t,n)})},S={},C={},k=[],T=function(e,t){var e="soda-"+e;S[e]=t(),k.push({name:e,opt:S[e]})},x=function(e,t){C[e]=t};x.get=function(e){return C[e]},x("date",function(e,t){return t}),T("repeat",function(){return{priority:10,compile:function(e,t,n){},link:function(e,t,n){var r,i,o,a=t.getAttribute("soda-repeat"),s=/\s+by\s+([^\s]+)$/;a=a.replace(s,function(e,t){return t&&(o=(t||"").trim()),""});var u=/([^\s]+)\s+in\s+([^\s]+)|\(([^,]+)\s*,\s*([^)]+)\)\s+in\s+([^\s]+)/,c=u.exec(a);if(c){if(c[1]&&c[2]){if(r=(c[1]||"").trim(),i=(c[2]||"").trim(),!r||!i)return}else c[3]&&c[4]&&c[5]&&(o=(c[3]||"").trim(),r=(c[4]||"").trim(),i=(c[5]||"").trim());o=o||"$index";var d=l(e,i)||[],f=function(n){var i=t.cloneNode(!0),a={};a[o]=n,a[r]=d[n],a.__proto__=e,i.removeAttribute("soda-repeat"),t.parentNode.insertBefore(i,t),b(i,a)};if("length"in d)for(var h=0;h<d.length;h++)f(h);else for(var h in d)d.hasOwnProperty(h)&&f(h);t.parentNode.removeChild(t)}}}}),T("if",function(){return{priority:9,link:function(e,t,n){var r=t.getAttribute("soda-if"),i=g(r,e);i||t.parentNode&&t.parentNode.removeChild(t)}}}),T("class",function(){return{link:function(e,t,n){var r=t.getAttribute("soda-class"),i=g(r,e);i&&s(t,i)}}}),T("src",function(){return{link:function(e,t,n){var r=t.getAttribute("soda-src"),i=r.replace(o,function(t,n){return g(n,e)});i&&t.setAttribute("src",i)}}}),T("bind-html",function(){return{link:function(e,t,n){var r=t.getAttribute("soda-bind-html"),i=g(r,e);if(i)return t.innerHTML=i,{command:"childDone"}}}}),T("html",function(){return{link:function(e,t,n){var r=t.getAttribute("soda-html"),i=g(r,e);if(i)return t.innerHTML=i,{command:"childDone"}}}}),T("style",function(){return{link:function(e,t,n){var r=t.getAttribute("soda-style"),i=g(r,e),o=function(e,t){var n=/opacity|z-index/;return n.test(e)?parseFloat(t):isNaN(t)?t:t+"px"};if(i){var a=[];for(var s in i)if(i.hasOwnProperty(s)){var l=o(s,i[s]);a.push([s,l].join(":"))}for(var u=t.style,s=0;s<u.length;s++){var c=u[s];i[c]||a.push([c,u[c]].join(":"))}var d=a.join(";");t.setAttribute("style",d)}}}});var E=function(e,t){k.sort(function(e,t){return Number(t.opt.priority||0)-Number(e.opt.priority||0)});var n=document.createElement("div");return n.innerHTML=e,[].map.call([].slice.call(n.childNodes,[]),function(e){b(e,t)}),n.innerHTML},A={};E.addEventListener=function(e,t){A[e]||(A[e]=[]),A[e].push(t)},E.author="dorsy";var D=function(e,t,n){for(var r=A[e]||[],i=0;i<r.length;i++){var o=r[i];o&&o(t,n)}};E.filter=x,"object"===n(t)&&"object"===n(e)?e.exports=E:(r=[],i=function(){return E}.apply(t,r),!(void 0!==i&&(e.exports=i)))}()}).call(t,n(10)(e))},function(e,t){e.exports=function(e){return e.webpackPolyfill||(e.deprecate=function(){},e.paths=[],e.children=[],e.webpackPolyfill=1),e}}])});