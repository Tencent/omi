(function () {
  ...
  define('my-counter', (_temp2 = _class$1 = function (_WeElement) {
    ...
    return _class;
  }(WeElement), _class$1.use = [{ count: 'count' }], _temp2));

  define('my-app', function (_ref) {
  ...
  render(Omi.h('my-app', null), 'body', new (function () {
    function Store() {
      var _this2 = this;
    ...
    Store.prototype.sub = function sub() {
      this.data.count--;
    };

    Store.prototype.add = function add() {
      this.data.count++;
    };
