(function () {
  ...
  define('my-counter', (_temp2 = _class = function (_WeElement) {
    ...
    _class.prototype.receiveProps = function receiveProps(props, data, old) {
      console.log(old);
  ...
  define('my-app', function (_WeElement2) {
    ...
    function _class3() {
      ...
      return _ret2 = (_temp3 = (_this2 = _possibleConstructorReturn$1(this, _WeElement2.call.apply(_WeElement2, [this].concat(args))), _this2), _this2.reset = function () {
        _this2.value = Math.floor(Math.random() * 100);
        _this2.update();
      }, _temp3), _possibleConstructorReturn$1(_this2, _ret2);
    }

    _class3.prototype.render = function render$$1() {
      return [Omi.h('my-counter', { value: this.value }), Omi.h(
        'button',
        { onClick: this.reset },
        'reset value'
      )];
