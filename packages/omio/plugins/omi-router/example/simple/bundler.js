...
!function () {
    ...
    var instances = [];
    var root = function () {
        if ('object' != (typeof global === 'undefined' ? 'undefined' : _typeof(global)) || !global || global.Math !== Math || global.Array !== Array) if ('undefined' != typeof self) return self;else if ('undefined' != typeof window) return window;else if ('undefined' != typeof global) return global;else return Function('return this')();
        return global;
    }();
    root.Omi = {
        h: h,
