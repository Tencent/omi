      ...
      {props.items.map(item => {
        ...
        return <li class={classNames('mdc-list-item', {
          'mdc-list-item--selected': item.selected
					...
					{props.checkboxLeft && this._renderCheckbox(props, item)}
					{props.radioLeft && this._renderRadio(props, item)}
