  ...
  render(props) {
    return (
      <div>
        ...
        <m-tabs ref={(e) => this.tab1 = e} defaultActive= { this.defaultActive } onTabChange={ this.onTabChange.call(this,'tab1') } width="400px">
        ...
        <m-tabs ref={(e) => this.tab2 = e} defaultActive= { this.defaultActive } onTabChange={ this.onTabChange.call(this,'tab2') } align="center" useMinWidth>
          <item label="英雄联盟" prop="lol"></item>
          <item label="QQ飞车" prop="speed"></item>
        ...
        <m-tabs ref={(e) => this.tab3 = e} defaultActive= { this.defaultActive } onTabChange={ this.onTabChange.call(this,'tab3') } align="end" useMinWidth>
          <item label="英雄联盟" prop="lol"></item>
          <item label="QQ飞车" prop="speed"></item>
          <item label="穿越火线" prop="fire"></item>
          <item label="QQ音速" prop="fly"></item>
        ...
        <m-tabs ref={(e) => this.tab4 = e} defaultActive= { this.defaultActive } onTabChange={ this.onTabChange.call(this,'tab4') }>
