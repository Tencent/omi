...
render(
  <div>
    <h3>Filled</h3>
    <m-text-field label='Label' helperText='Helper Text' />
    <br />

    <m-text-field helperText='Helper Text' iconRight path='M840.4 300H183.6c-19.7 0-30.7 20.8-18.5 35l328.4 380.8c9.4 10.9 27.5 10.9 37 0L858.9 335c12.2-14.2 1.2-35-18.5-35z' css={`
.mdc-text-field { 
  width:200px; 
}
`} label='Label2' />
...
`} helperText='Helper Text' paths={[{
    ...
    <m-text-field helperText='Helper Text' class='shaped' css={`
 .shaped {
  border-radius: 16px 16px 0 0;
    ...
    <m-text-field outlined label='Label' helperText='Helper Text' css={`
...
`} />
    ...
    <m-text-field outlined helperText='Helper Text' css={`
 .mdc-notched-outline__leading {
  border-radius: 28px 0 0 28px!important;
  width: 28px!important;
}
...
`} />
    ...
    <m-text-field style="width:200px;display:block;" css={`
.mdc-text-field { 
  width:200px; 
}
