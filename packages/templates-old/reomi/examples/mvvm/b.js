(function () {
  ...
  function mapping(from, to, rule) {
    ...
    rule && Object.keys(tempRule).forEach(function (key) {
      var arr = key.replace(/]/g, '').replace(/\[/g, '.').split('.');
  ...
  function arrayMapping(from, to, rule, path) {
    ...
    rule && Object.keys(rule).forEach(function (key) {
      var arr = key.replace(/]/g, '').replace(/\[/g, '.').split('.');
      var pathArr = path.replace(/]/g, '').replace(/\[/g, '.').split('.');
  ...
  function isArray(obj) {
    return Object.prototype.toString.call(obj) === ARRAYTYPE$1;
  }

  function isObject(obj) {
    return Object.prototype.toString.call(obj) === OBJECTTYPE$1;
  }
  ...
  var TodoItem = function TodoItem(text, completed) {
    _classCallCheck$1(this, TodoItem);
  ...
  var TodoViewModel = function () {
    function TodoViewModel() {
      _classCallCheck$3(this, TodoViewModel);
  ...
  define('todo-list', function (_WeElement) {
    ...
    function _class2() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn$1(this, _WeElement.call.apply(_WeElement, [this].concat(args))), _this), _this.onChange = function (evt, id) {
  ...
  define('todo-app', function (_ModelView) {
    _inherits$2(_class2, _ModelView);
    ...
    function _class2() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn$2(this, _ModelView.call.apply(_ModelView, [this].concat(args))), _this), _this.vm = vm, _this.handleChange = function (e) {
