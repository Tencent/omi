(function () {
  ...
  define('my-hello', function (_Component) {
    _inherits$1(_class2, _Component);
    ...
    function _class2() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn$1(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.handleClick = function (e) {
        _this.fire('myevent', { a: 2 });
  ...
  define('my-app', function (_Component2) {
    _inherits$1(_class4, _Component2);
    ...
    function _class4() {
      ...
      return _ret2 = (_temp2 = (_this2 = _possibleConstructorReturn$1(this, _Component2.call.apply(_Component2, [this].concat(args))), _this2), _this2.onMyEvent = function (e) {
        console.log(e.detail);
      }, _temp2), _possibleConstructorReturn$1(_this2, _ret2);
    }

    _class4.prototype.install = function install() {
      this.name = 'Omi';
    };
    ...
    _class4.prototype.render = function render$$1() {
      return Omi.h(
        'div',
        null,
        Omi.h('my-hello', { onMyEvent: this.onMyEvent, name: this.name })
      );
    };
