...
describe('render array', () => {
  ...
  it('render array 2', async () => {
    ...
    expect(
      parentElement.firstChild.shadowRoot.firstChild.shadowRoot.innerHTML,
    ).toBe('<div>Hello</div><div>Element</div><div>Element2</div>')
  })
  ...
  it('render array 3', async () => {
    ...
    expect(
      parentElement.firstChild.shadowRoot.firstChild.shadowRoot.innerHTML,
    ).toBe('<div>Hello2</div><div>Element</div><div>Element2</div>')
  })
  ...
  it('render array 4', async () => {
    ...
    expect(
      parentElement.firstChild.shadowRoot.firstChild.shadowRoot.innerHTML,
    ).toBe('<div>Element5</div><div>Element</div>')
  })
  ...
  it('render array 8', async () => {
    ...
    expect(
      parentElement.firstChild.shadowRoot.firstChild.shadowRoot.innerHTML,
    ).toBe('<div>Element3</div><div>Element4</div><div>Element5</div>')
  })
  ...
  it('render array 11', () => {
    ...
    expect(
      parentElement.firstChild.shadowRoot.children[1].shadowRoot.innerHTML,
    ).toBe('<span>c</span><span>d</span>')
  })
