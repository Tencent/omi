...
QUnit.test('props.children', function (assert) {
  ...
  define('my-p', class extends Component {
    render(props) {
...
QUnit.test('css', function (assert) {
  define('hello-element', class extends Component {
    static css = 'div{color:green;}'

    render() {
      return (
        h('div', null, 'Hello Element')
      )
    }

    installed() {
      assert.deepEqual(getComputedStyle(document.querySelector('#root4').firstElementChild.shadowRoot.firstChild).color, 'rgb(0, 128, 0)')
    }
  })
