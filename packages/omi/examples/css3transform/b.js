(function () {
	...
	var CSS3Transform = (_dec = tag("css3-transform"), _dec(_class = function (_WeElement) {
		_inherits$1(CSS3Transform, _WeElement);

		function CSS3Transform() {
			_classCallCheck$1(this, CSS3Transform);

			return _possibleConstructorReturn$1(this, _WeElement.apply(this, arguments));
		}

		CSS3Transform.prototype.install = function install() {
			this.css = this.parentNode.host.css;
		};

		CSS3Transform.prototype.installed = function installed() {
			Transform(this.host);
			this.transformByProps();
		};

		CSS3Transform.prototype.afterUpdate = function afterUpdate() {
			this.transformByProps();
		};

		CSS3Transform.prototype.transformByProps = function transformByProps() {
			var _this2 = this;

			["translateX", "translateY", "translateZ", "scaleX", "scaleY", "scaleZ", "rotateX", "rotateY", "rotateZ", "skewX", "skewY", "originX", "originY", "originZ", "perspective"].forEach(function (item) {
				if (_this2.props.hasOwnProperty(item)) {
					_this2.host[item] = _this2.props[item];
				}
			});
		};
	...
	var MyApp = (_dec$1 = tag("my-app"), _dec$1(_class$1 = function (_WeElement) {
