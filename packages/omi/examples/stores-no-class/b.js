(function () {
  ...
  store.add = function (_) {
  	store.data.count++;
  };

  store.sub = function (_) {
  	store.data.count--;
  };
  ...
  store$1.changeMsg = function () {
  	store$1.data.msg = 'bcd';
  };
  ...
  define('my-app', function (_) {
  	var data = _.store.counterStore.data;

  	var _$store$counterStore = _.store.counterStore,
  	    add = _$store$counterStore.add,
  	    sub = _$store$counterStore.sub;
  	...
  	return Omi.h(
  		...
  		Omi.h(
  			...
  			Omi.h(
  				'button',
  				{ onClick: _.store.msgStore.changeMsg },
  				'change storeB\'s msg'
  			)
  		)
  	);
  ...
  render(Omi.h('my-app', null), 'body', store$2);
