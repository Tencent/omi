(function () {
  ...
  define('t-g', (_temp$1 = _class$1 = function (_WeElement) {
    ...
    return _class;
  }(WeElement), _class$1.isLightDOM = true, _temp$1));

  define('my-app', function (_WeElement2) {
    _inherits$2(_class3, _WeElement2);
    ...
    function _class3() {
      ...
      return _ret = (_temp2 = (_this2 = _possibleConstructorReturn$2(this, _WeElement2.call.apply(_WeElement2, [this].concat(args))), _this2), _this2.list = [{
        name: 'abc'
      }, {
        name: 'bcd'
      }, {
        ...
        _this2.update();
      }, _this2.removeItem = function (item, index) {
          ...
          Omi.h(
            'button',
            {
              onClick: function onClick(_) {
                return _this2.removeItem(item, index);
              }
            },
            '-'
          )
    ...
    _class3.prototype.render = function render$$1() {
      return Omi.h(
        ...
        Omi.h(
          'ul',
          null,
          Omi.h('t-g', { list: this.list, renderItem: this.renderItem })
        ),
        Omi.h(
          'button',
