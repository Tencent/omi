(function () {
  ...
  define('my-counter', function (_WeElement) {
    ...
    function _class2() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn$2(this, _WeElement.call.apply(_WeElement, [this].concat(args))), _this), _this.add = function () {
        return _this.store.add();
      }, _this.sub = function () {
        return _this.store.sub();
      }, _this.addIfOdd = function () {
        if (_this.using.count % 2 !== 0) {
          _this.store.add();
        }
  ...
  define('my-app', function (_) {
    return Omi.h(
      ...
      Omi.h(
        'span',
        { onClick: _.store.random },
        _.store.data.msg
      ),
      Omi.h('my-counter', null)
    );
  }, {
    useSelf: ['msg']
  });

  render(Omi.h('my-app', null), 'body', new function Store() {
    var _this2 = this;
