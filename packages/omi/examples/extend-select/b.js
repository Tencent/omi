(function () {
  ...
  extend$1('model-select', function (el, path, scope) {
  ...
  define('my-component', function (_WeElement) {
    ...
    function _class2() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn$3(this, _WeElement.call.apply(_WeElement, [this].concat(args))), _this), _this.selected = 'b', _temp), _possibleConstructorReturn$3(_this, _ret);
    }
