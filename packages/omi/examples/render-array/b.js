(function () {
  ...
  var lazyLoad = (_dec = tag('omi-lazyload'), _dec(_class$1 = (_temp$1 = _class2 = function (_WeElement) {
    _inherits$2(lazyLoad, _WeElement);

    function lazyLoad() {
      _classCallCheck$2(this, lazyLoad);

      return _possibleConstructorReturn$2(this, _WeElement.apply(this, arguments));
    }

    lazyLoad.prototype.css = function css() {
      return '\n        img{\n            display:block;\n            width:200px;\n            height:200px;\n        }\n        ';
    };

    lazyLoad.prototype.install = function install() {
      this.data = {
        show: false
      };
    };

    lazyLoad.prototype.installed = function installed() {
      var _this2 = this;

      setTimeout(function () {
        _this2.data.show = true;
      }, 2000);
    };

    lazyLoad.prototype.render = function render$$1() {
    ...
    return lazyLoad;
  }(WeElement), _class2.observe = true, _temp$1)) || _class$1);
