(function () {
	...
	class OmiTap extends WeElement$1 {
	...
	var MyApp = (_dec = tag("my-app"), _dec(_class = function (_WeElement) {
		...
		function MyApp() {
			...
			return _ret = (_temp = (_this = _possibleConstructorReturn$2(this, _WeElement.call.apply(_WeElement, [this].concat(args))), _this), _this.onTap = function () {
				console.log('tap');
