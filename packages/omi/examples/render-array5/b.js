(function () {
  ...
  define('my-app', function (_WeElement) {
  	...
  	function _class2() {
  		...
  		return _ret = (_temp = (_this2 = _possibleConstructorReturn$2(this, _WeElement.call.apply(_WeElement, [this].concat(args))), _this2), _this2.list = ['d', 'e'], _temp), _possibleConstructorReturn$2(_this2, _ret);
  	}
