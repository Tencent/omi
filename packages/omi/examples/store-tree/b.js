(function () {
  ...
  define('tree-node', function (_WeElement) {
    ...
    function _class2() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn$2(this, _WeElement.call.apply(_WeElement, [this].concat(args))), _this), _this.handleIncrementClick = function () {
        ...
        return Omi.h(
          'li',
          { key: childId },
          Omi.h('tree-node', { id: childId, parentId: id })
        );
    ...
    // todo supporting
    _class2.prototype.useSelf = function useSelf() {
    ...
    _class2.prototype.render = function render$$1(props) {
      ...
      return Omi.h(
        ...
        ' ',
        typeof parentId !== 'undefined' && Omi.h(
          'a',
          { href: '#', onClick: this.handleRemoveClick // eslint-disable-line jsx-a11y/anchor-is-valid
