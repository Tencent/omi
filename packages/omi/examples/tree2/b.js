(function () {
  ...
  define('my-tree', (_temp2 = _class$2 = function (_WeElement) {
    ...
    function _class() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn$3(this, _WeElement.call.apply(_WeElement, [this].concat(args))), _this), _this.open = function (path) {
        var node = _this.getNodeByPath(path);
        node.open = !node.open;
        _this.update();
      }, _this.addChild = function (path) {
        var node = _this.getNodeByPath(path);
    ...
    _class.prototype.getNodeByPath = function getNodeByPath(path) {
      if (path === '#') {
    ...
    _class.prototype.extend = function extend(path) {
    ...
    _class.prototype.createNode = function createNode(node, path) {
      var _this2 = this;
      ...
      return Omi.h(
        ...
        Omi.h(
          ...
          { ondblclick: function ondblclick(e) {
              return _this2.extend(path);
            } },
          node.name,
          canOpen && Omi.h(
            'span',
            { onclick: function onclick(e) {
                return _this2.open(path);
              } },
            '[',
            node.open ? '-' : '+',
            ']'
        ...
        canOpen && node.open && Omi.h(
          ...
          children.map(function (child, index) {
            return _this2.createNode(child, path + '-' + index);
          }),
          Omi.h(
            'li',
            { 'class': 'add', onclick: function onclick(e) {
                return _this2.addChild(path);
              } },
            '+'
          )
        )
  ...
  render(Omi.h('my-tree', { node: node }), 'body');
