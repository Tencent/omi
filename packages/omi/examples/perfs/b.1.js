(function () {
  ...
  function isSameNodeType(node, vnode, hydrating) {
    ...
    if (typeof vnode.nodeName === 'string') {
      return ( node.normalizedNodeName === vnode.nodeName || node.nodeName.toLowerCase() === vnode.nodeName.toLowerCase())
  ...
  function diffAttributes(dom, attrs, old, children) {
    ...
    for (name in attrs) {
       ...
       if ( (!(name in old) || attrs[name] !== old[name])) {
  ...
  define('my-app', function (_WeElement) {
    ...
    function _class2() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn$3(this, _WeElement.call.apply(_WeElement, [this].concat(args))), _this), _this.databases = [], _this.loadSamples = function () {
  ...
  render(Omi.h('my-app', null), '#dbmon');
