(function () {
  ...
  define('todo-app', (_temp2 = _class2 = function (_WeElement2) {
    ...
    function _class2() {
      ...
      return _ret = (_temp = (_this2 = _possibleConstructorReturn$3(this, _WeElement2.call.apply(_WeElement2, [this].concat(args))), _this2), _this2.handleChange = function (e) {
        _this2.store.data.text = e.target.value;
      }, _this2.handleSubmit = function (e) {
        e.preventDefault();
        _this2.store.add();
      }, _temp), _possibleConstructorReturn$3(_this2, _ret);
    }

    _class2.prototype.render = function render$$1(props, data, store) {
      return Omi.h(
        'div',
        null,
        Omi.h(
        ...
        store.data.showList && Omi.h('todo-list', { items: store.data.items }),
        Omi.h(
          'form',
    ...
    _class2.prototype.installed = function installed() {
      ...
      setTimeout(function () {
        _this3.store.data.items.push({ text: 'abc' });
      }, 4000);

      setTimeout(function () {
        _this3.store.data.items[2].text = 'changed';
      }, 6000);
    ...
    return _class2;
  }(WeElement), _class2.use = ['showList', 'items', 'text', 'firstName', 'lastName'], _temp2));
