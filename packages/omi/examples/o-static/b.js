(function () {
  ...
  define('my-element', (_temp$1 = _class$1 = function (_WeElement) {
  ...
  define('my-app', function (_WeElement) {
  	...
  	function _class2() {
  		...
  		return _ret = (_temp = (_this = _possibleConstructorReturn$3(this, _WeElement.call.apply(_WeElement, [this].concat(args))), _this), _this.myCSS = '\n  h1{\n    color: green;\n  }', _this.onClick = function () {
  			_this.myCSS = '\n    h1{\n      color: blue;\n    }';
  			_this.update();
