(function () {
  ...
  define('my-element', function (_WeElement) {
    ...
    function _class2() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn$3(this, _WeElement.call.apply(_WeElement, [this].concat(args))), _this), _this.onClick = function () {
        _this.fire('change');
  ...
  define('my-component', function (_WeElement2) {
    ...
    function _class4() {
      ...
      return _ret2 = (_temp2 = (_this2 = _possibleConstructorReturn$3(this, _WeElement2.call.apply(_WeElement2, [this].concat(args))), _this2), _this2.onClick = function () {
        _this2.update();
      }, _this2.list = [{
        id: 24,
        name: 'dnt',
      ...
      }, _temp2), _possibleConstructorReturn$3(_this2, _ret2);
    }

    _class4.prototype.render = function render$$1(props) {
      var _this3 = this;
      ...
      return Omi.h(
        ...
        this.list.map(function (item, index) {
          return Omi.h('my-element', { 'data-id': item.id, 'data-index': index, onChange: _this3.changeHandler });
        })
      );
    };
