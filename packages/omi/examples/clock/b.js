(function () {
  ...
  define('my-clock', (_temp2 = _class$2 = function (_WeElement) {
    ...
    _class.prototype.render = function render$$1() {
      ...
      return Omi.h(
        ...
        this.arr.map(function (i) {
          return Omi.h('line', { 'class': 'major', y1: '35', y2: '45', transform: 'rotate(' + 30 * i + ')' });
        }),
        this.arr.map(function (i) {
          return [1, 2, 3, 4].map(function (o$$1) {
            return Omi.h('line', { 'class': 'minor', y1: '42', y2: '45', transform: 'rotate(' + 6 * (i + o$$1) + ')' });
          });
        }),
        Omi.h('line', { 'class': 'hour', y1: '2', y2: '-20', transform: 'rotate(' + (30 * hours + minutes / 2) + ')' }),
        Omi.h('line', { 'class': 'minute', y1: '4', y2: '-30', transform: 'rotate(' + (6 * minutes + seconds / 10) + ')' }),
        Omi.h(
          'g',
  ...
  render(Omi.h('my-clock', null), 'body');
