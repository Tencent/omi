...
/**
 * 
 * @param this 调用的上下文，比如Component类
 * @param obj 需要代理的对象
 * @returns 代理后的对象
 */
export function createProxy<T extends object>(this: ProxyContext, obj: T): T {
  ...
  const proxy = new Proxy(obj, {
    set: (target, prop, value, receiver) => {
      ...
      if (value && typeof value === 'object') {
        value = this.proxyCache.get(value) || createProxy.call(this, value)
      }
    ...
    get: (target, prop, receiver) => {
      ...
      // 只对对象/数组进行代理，且避免重复创建
      if (value && typeof value === 'object' && !this.proxyCache.has(value)) {
        this.proxyCache.set(value, createProxy.call(this, value))
      }
      return value
    }
  })
