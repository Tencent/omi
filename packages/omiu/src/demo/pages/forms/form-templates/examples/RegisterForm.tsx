      ...
      <div className="block max-w-sm rounded-lg bg-white p-6 m-3 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
        <form>
          <div className="grid grid-cols-2 gap-4">
            {/* <!--First name input--> */}
            <Input.tagName type="email" label="First name" className="mb-6"></Input.tagName>

            {/* <!--Last name input--> */}
            <Input.tagName type="password" label="Last name" className="mb-6"></Input.tagName>
          </div>

          {/* <!--Email input--> */}
          <Input.tagName type="email" label="Email address" className="mb-6"></Input.tagName>

          {/* <!--Password input--> */}
          <Input.tagName type="password" label="Password" className="mb-6"></Input.tagName>
          ...
          <div className="mb-6 flex min-h-[1.5rem] items-center justify-center pl-[1.5rem]">
            <input
              ...
              id="exampleCheck25"
            />
            <label className="inline-block pl-[0.15rem] hover:cursor-pointer" htmlFor="exampleCheck25">
