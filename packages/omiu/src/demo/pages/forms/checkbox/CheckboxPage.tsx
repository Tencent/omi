import { tag, Component, bind, createRef } from 'omi'
...
export default class CheckboxPage extends Component {
  ...
  <div className="mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem]">
    ...
    <label
      ...
      Checked checkbox
        ...
        <h2 className="mb-5 mt-0 text-3xl font-semibold leading-normal">Indeterminate</h2>

        <code-showcase
          code={`<div className="mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem]">
  <input
  ...
  <label
    ...
    Indeterminate checkbox
        ...
        >
          <div className="mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem]">
            <input
              ...
              id="flexCheckIndeterminate"
            />
            <label className="inline-block pl-[0.15rem] hover:cursor-pointer" htmlFor="flexCheckIndeterminate">
              Indeterminate checkbox
            </label>
          </div>
        </code-showcase>
        ...
        <h2 className="mb-5 mt-0 text-3xl font-semibold leading-normal">Disabled</h2>
  ...
  <div className="mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem]">
    ...
    <label
      ...
      Disabled checked checkbox
        ...
        <h2 className="mb-5 mt-0 text-3xl font-semibold leading-normal">Inline</h2>
  ...
  <div className="mb-[0.125rem] inline-block min-h-[1.5rem] pl-[1.5rem]">
    ...
    >3 (disabled)</label>
          ...
          <div className="flex justify-center">
            <div className="mb-[0.125rem] mr-4 inline-block min-h-[1.5rem] pl-[1.5rem]">
              <input
                ...
                value="option1"
              />
              <label className="inline-block pl-[0.15rem] hover:cursor-pointer" htmlFor="inlineCheckbox1">
                1
              </label>
            </div>
            ...
            <div className="mb-[0.125rem] mr-4 inline-block min-h-[1.5rem] pl-[1.5rem]">
              <input
                ...
                value="option2"
              />
              <label className="inline-block pl-[0.15rem] hover:cursor-pointer" htmlFor="inlineCheckbox2">
                2
              </label>
            </div>
        ...
        <h2 className="mb-5 mt-0 text-3xl font-semibold leading-normal">Without labels</h2>
