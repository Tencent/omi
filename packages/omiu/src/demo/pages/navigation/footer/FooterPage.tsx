  ...
  render() {
    return (
      <div className="container my-12 !max-w-full">
        ...
        <code-showcase
          code={`<footer className="bg-neutral-100 text-center text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
  ...
  <div className="bg-neutral-200 p-6 text-center dark:bg-neutral-700">
    ...
    <a className="font-semibold text-neutral-600 dark:text-neutral-400" href="https://tailwind-elements.com/">
      Tailwind Elements
        ...
        <code-showcase code={FooterAdvancedExampleCode}>
          <FooterAdvancedExample.tagName />
        </code-showcase>
        ...
        <code-showcase
          code={`<footer className="bg-neutral-200 text-center dark:bg-neutral-700 lg:text-left">
  <div className="p-4 text-center text-neutral-700 dark:text-neutral-200">
    ...
    <a className="text-neutral-800 dark:text-neutral-400" href="https://tailwind-elements.com/">
      Tailwind Elements
        ...
        <code-showcase
          code={`<footer className="bg-neutral-100 text-center dark:bg-neutral-600 lg:text-left">
  ...
  <div className="bg-neutral-200 p-4 text-center text-neutral-700 dark:bg-neutral-700 dark:text-neutral-200">
    ...
    <a className="text-neutral-800 dark:text-neutral-400" href="https://tailwind-elements.com/">
      Tailwind Elements
        ...
        <code-showcase
          code={`<footer className="bg-neutral-200 text-center text-white dark:bg-neutral-600 dark:text-neutral-200">
  <div className="container p-6">
  ...
  <div className="bg-neutral-300 p-4 text-center text-neutral-700 dark:bg-neutral-700 dark:text-neutral-200">
    ...
    <a className="dark:text-neutral-400" href="https://tailwind-elements.com/">
      Tailwind Elements
        ...
        <code-showcase
          code={`<footer className="bg-neutral-200 text-center text-white dark:bg-neutral-600">
  ...
  <div className="bg-neutral-300 p-4 text-center text-neutral-700 dark:bg-neutral-700 dark:text-neutral-200">
    ...
    <a className="text-neutral-800 dark:text-neutral-400" href="https://tailwind-elements.com/">
      Tailwind Elements
        ...
        <code-showcase code={FooterButtonsDarkExampleCode}>
          <FooterButtonsDarkExample.tagName />
        </code-showcase>

        <hr className="my-5"></hr>

        <h2 className="mb-5 mt-0 text-3xl font-semibold leading-normal">Call to action</h2>
        <code-showcase code={FooterCtaExampleCode}>
          <FooterCtaExample.tagName />
        </code-showcase>

        <hr className="my-5"></hr>
        <h2 className="mb-5 mt-0 text-3xl font-semibold leading-normal">Form</h2>
        <code-showcase code={FooterFormExampleCode}>
          <FooterFormExample.tagName />
        </code-showcase>
      </div>
    )
  }
