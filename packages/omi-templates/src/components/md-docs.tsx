  ...
  highlight() {
    ...
    codes.forEach((code) => {
      ...
      if (code.className && pre) {
        ...
        if (temp && pl) {
          code.innerHTML = Prism.highlight(code.innerHTML, pl, lan).trim()
        }
      }
    })
