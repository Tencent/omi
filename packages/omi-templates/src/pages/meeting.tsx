...
export function Meeting() {
    return (
        <>
            <header class="shadow-xs dark:shadow-gray-700 mt-4">
            ...
            <main class="text-sm sm:text-base">
                    ...
                    <div class="flex lg:flex-row flex-col max-w-7xl mx-auto">
                        <div class="lg:w-1/2 w-full sm:flex font-semibold text-gray-600">
                            <div class="sm:w-1/2 flex flex-col justify-between items-center">
                                <div class="w-fit flex flex-col items-center rounded-lg lg:p-3 p-2 bg-linear-to-br from-blue-500/30 to-transparent backdrop-blur-xs sm:mb-0 mb-5">
                                    <i class="t-icon t-icon-chat-heart absolute lg:-top-5 -top-4 bg-linear-to-br from-blue-300 from-10% to-blue-600 lg:text-2xl text-lg text-white p-2 rounded-xl"></i>
                                    <div class="flex items-center bg-white lg:py-5 py-3 lg:px-7 px-4 rounded-lg shadow-sm w-full">
                            ...
                            <div class="sm:w-1/2 flex sm:flex-col flex-col-reverse justify-between items-center mt-3 sm:mt-0">
                                ...
                                <div class="w-fit flex flex-col items-center mt-10 rounded-lg lg:p-3 p-2 bg-linear-to-br from-blue-500/30 to-blue-200/20 backdrop-blur-xs mb-5 sm:mb-0">
                                    <i class="t-icon t-icon-mail absolute lg:-top-5 -top-4 bg-linear-to-br from-blue-300 from-10% to-blue-600 lg:text-2xl text-lg text-white p-2 rounded-xl"></i>
                                    <div class="flex items-center bg-white lg:py-5 py-3 lg:px-7 px-4 rounded-lg shadow-sm">
                                        <i class="t-icon t-icon-animation-1 text-blue-500 mr-2"></i>
                ...
                <div class="max-w-7xl mx-auto py-10">
                    ...
                    <ol class="flex flex-wrap justify-center pt-5 pb-4">
                        {
                            cases.map((item, key) => <li key={key} class=" w-[80%] sm:w-2/5 lg:w-1/5 flex flex-col sm:mx-3 mx-1 my-2 rounded-lg overflow-clip shadow-md group bg-linear-to-br dark:from-blue-200 dark:to-white">
                    ...
                    <a href="https://meeting.tencent.com/customers/" target="_blank" class="mx-auto block w-fit text-white transition-all bg-blue-500 px-4 py-2 rounded-sm hover:bg-blue-500/80 dark:bg-blue-500/20 dark:text-blue-500 dark:border-blue-500 dark:border dark:hover:bg-blue-500 dark:hover:text-white">更多案例</a>
                </div>

                <div class="bg-linear-to-bl from-indigo-100 to-blue-400 dark:from-indigo-900 dark:to-blue-800 pt-10">
                    <div class="sm:flex max-w-7xl mx-auto relative">
                        <div class="sm:w-1/2 sm:flex flex-col justify-center text-center sm:static absolute w-full z-10">
                            ...
                            <div class="flex justify-center mt-5">
                                <div class="px-5 py-1 rounded-sm text-white bg-blue-500 mr-5 cursor-pointer hover:bg-blue-500/80">联系我们</div>
                                <div class="px-5 py-1 rounded-sm text-blue-500 border-blue-500 border cursor-pointer hover:bg-blue-500/30">下载使用</div>
                            </div>
                        </div>
