...
function recommendationCard(config: BriefNewsList_t) {
  return (
    <div class="flex flex-col gap-4 border-solid border-zinc-200 dark:border-zinc-800 border-2 rounded-lg my-8 py-4 w-full max-w-xl justify-center shadow-md px-6">
...
function authorCard(config: AuthorCardConfig_t) {
  return (
    <div class="flex flex-col gap-4 border-solid border-zinc-200 dark:border-zinc-800 border-2 rounded-lg my-8 py-4 w-full max-w-xl justify-center items-center shadow-md px-6">
