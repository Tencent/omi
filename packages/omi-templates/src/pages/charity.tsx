      ...
      <>
        <div class="hero-section w-full h-screen relative">
          ...
          <div class="absolute bottom-6 left-6">
            <h1 class="text-white text-8xl font-bold mb-2">携手共筑爱的桥梁<br />关爱留守儿童行动</h1>
            <p class="text-white text-3xl">让我们共同为每一个孤独的心灵点亮希望的灯塔</p>
          </div>
        </div>
        <div class="w-full px-16 py-12 overflow-hidden flex justify-center">
          <div class="flex gap-20">
            {
              stories.value.map((story, index) => (
                <div class="w-[320px] flex flex-none flex-col items-center" 
                  key={index}>
        ...
        <div class={`about-section w-full flex justify-center bg-amber-100 dark:bg-amber-900 py-8`}>
          <div class="w-10/12 flex items-center justify-center gap-12">
            <div class="w-5/12 flex flex-col justify-center">
              <h2 class="text-5xl mb-4">关于我们 —— <br />我们的使命与愿景</h2>
            ...
            <div class="w-7/12">
              <img class="object-cover rounded-lg" src="https://s2.loli.net/2024/07/15/ljcfdbWUwNu2vns.jpg" />
            </div>
          </div>
        </div>

        <div class="impact-section w-full py-12 flex gap-20 justify-center">
          <div class="w-1/3 flex flex-col gap-6">
            {
              sortedStats.map(stat => (
                <div>
                  <span class="text-4xl font-bold mr-2">{stat.value}</span>
                  <span class="text-lg">{stat.name}</span>
                </div>
              )) 
            }
          </div>
          <div class="w-1/3 flex flex-col gap-6 justify-center">
            <h2 class="text-5xl text-center">改变正在发生</h2>
        ...
        <div class={`feature-section w-full flex flex-col items-center py-12 bg-amber-100 dark:bg-amber-900`}>
          <h2 class="text-5xl mb-16">我们所提供的</h2>
          <div class="grid grid-cols-3 gap-y-8">
            {
              features.map(feature => (
                <div class="flex items-center gap-4">
                  ...
                  <div>
                    <h3 class="text-2xl">{ feature.name }</h3>
        ...
        <div class="cta-section w-full py-12">
          <div class="relative w-10/12 mx-auto">
            ...
            <a href={signUpLink} class=""><h2 class="text-7xl text-white underline absolute bottom-8 left-8">加入我们,<br />一起创造更多可能</h2></a>
          </div>
        </div>
      </>
    )
