export function Product(props: { id: string }) {
  return (
    <>
      <div class="container mx-auto gap-12 flex flex-wrap justify-center p-6">
        ...
        <div class="md:w-[550px] w-full mt-4 md:mt-0">
          ...
          <p class="text-md text-black mt-2 flex items-center">
            ...
            <span class="text-2xl dark:text-background-foreground">$99.99</span>
          </p>
          <p class="text-md text-gray-500 mt-2 flex items-center">
            <span class="text-gray-500 w-32">运送至:</span>
            <span class="text-black dark:text-background-foreground">南山大道粤海街道103号1栋2单元9楼</span>
          </p>
          <p class="text-md text-gray-500 mt-2 flex items-center">
            <span class="text-gray-500 w-32">重量:</span>
            <span class="text-black dark:text-background-foreground">1kg</span>
          </p>
          <p class="text-md text-gray-500 mt-2 flex items-center">
            <span class="text-gray-500 w-32">描述:</span>
            <span class="text-black flex-1 dark:text-background-foreground">
              这是一个示例产品描述，提供有关产品的更多信息。
            </span>
          </p>

          <p class="text-md text-gray-500 mt-2 flex items-center">
            <span class="text-gray-500 w-32">材料:</span>
            <span class="text-black dark:text-background-foreground">优质原料，天然添加剂</span>
          </p>
          <p class="text-md text-gray-500 mt-2 flex items-center">
            <span class="text-gray-500 w-32">保质期:</span>
            <span class="text-black dark:text-background-foreground">12个月</span>
          </p>
          <p class="text-md text-gray-500 mt-2 flex items-center">
            <span class="text-gray-500 w-32">包装:</span>
            <span class="text-black dark:text-background-foreground">精美包装，适合送礼</span>
          </p>
          <p class="text-md text-gray-500 mt-2 flex items-center">
            <span class="text-gray-500 w-32">使用方法:</span>
            <span class="text-black dark:text-background-foreground">根据个人口味，适量食用</span>
          </p>
          <p class="text-md text-gray-500 mt-2 flex items-center">
            <span class="text-gray-500 w-32">特点:</span>
            <span class="text-black dark:text-background-foreground">口感丰富，营养丰富，适合各年龄层</span>
          </p>
          <p class="text-md text-gray-500 mt-2 flex items-center">
            <span class="text-gray-500 w-32">评价:</span>
            <span class="text-black dark:text-background-foreground">
              <span class="text-yellow-400">⭐⭐⭐⭐⭐</span>
              <span class="text-md text-black ml-2 dark:text-background-foreground">4.8 (120条评价)</span>
            </span>
          </p>
          <div class="mt-4 flex items-center">
            ...
            <select
              ...
              class="mt-1 max-w-32 block w-full px-2 py-1 rounded-md shadow-sm border focus:border-primary focus:ring-1 focus:ring-primary focus:ring-opacity-50 bg-no-repeat appearance-none dark:text-background-foreground dark:border-gray-600 dark:bg-gray-700 dark:focus:ring-primary dark:focus:border-primary dark:focus:ring-opacity-50"
            >
              <option>香草</option>
              <option>巧克力</option>
              <option>草莓</option>
          ...
          <div class="relative flex items-center w-96 mt-4 gap-4">
            ...
            <button class="bg-primary text-primary-foreground whitespace-nowrap text-white px-4 py-2 rounded-md transition ease-in-out duration-150 hover:bg-[#003f9a] focus:outline-none focus:ring-2 focus:ring-primary focus:ring-opacity-50">
              添加到购物车
            </button>
          </div>
        </div>
      ...
      <div class="bg-background text-background-foreground dark:bg-zinc-700">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-20 mb-10 w-full mx-auto px-4 py-10 md:w-[1080px]">
          <div>
            <div class="flex items-center">
              <div class="w-16 h-16 text-gray-700 rounded-md overflow-hidden mr-4 dark:text-background-foreground">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="100%"
                  height="100%"
              ...
              <div class="flex-1">
                ...
                <p class="text-gray-600 dark:text-background-foreground">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10 mt-32">
          <div class="mt-16 md:mt-0 bg-card text-card-foreground p-6 rounded shadow text-center">
            <div class="relative">
              ...
              <p class="text-gray-600 dark:text-background-foreground">描述 3</p>
            </div>
          </div>
