    ...
    return <div class={tw`px-4`}>
      ...
      <div ref={_ => this.grid = _}>
        <div class={tw`${gridItem}`}>
          <code-demo title="简单卡片" describe={"只包含内容区域"} code={this.mdA}>
        ...
        <div class={tw`${gridItem}`}>
          <code-demo title="典型卡片" describe="包含标题、内容、操作区域(extra)" code={this.mdB}>
            <div slot="demo" class={tw`px-5 py-5`}>
              <o-card title="Default size card" hoverable="always">
        ...
        <div class={tw`${gridItem}`}>
          <code-demo title="功能卡片" describe="支持底部栏添加触发事件(o-icon)" code={this.mdC}>
            <div slot="demo" class={tw`px-5 py-5`}>
        ...
        <div class={tw`${gridItem}`}>
          <code-demo title="相册卡片" describe="支持封面、头像、标题和描述信息的卡片" code={this.mdD}>
            <div slot="demo" class={tw`px-5 py-5`}>
