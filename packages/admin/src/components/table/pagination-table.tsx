...
export default class extends WeElement<Props> {
    ...
    renderTable() {
        if (this.data.totalSize > this.data.currPageSize) {
            ...
            this.data.end = this.data.totalSize < endIndex ? this.data.totalSize : endIndex;
        ...
        return <div>
            ...
            <div class={tw`px-2`}>
                ...
                <o-table
                    ...
                    border={false}
                    compact={false}
                    columns={this.columns} dataSource={this.data.filterData}></o-table>

                <div class={tw`mt-3`}>
                    <div class={tw`mb-2`}>
                        <span v-if="totalSize > 1">显示第 {this.data.start} 条到第 {this.data.end} 条的数据，</span>
                        共{this.data.totalSize} 条数据
                    </div>
                    <o-pagination total={this.data.totalSize} current-page={this.currentPage} page-size={this.pageSize} onChange={this.change} ></o-pagination>
                </div>
            </div>
