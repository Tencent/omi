import{h as a,a as h,e as y,W as _,j as O}from"./index.1cb61231.js";/*! *****************************************************************************
...
.o-input.is-block {
  display: block;
  width: 100%; }
`;(function(r){Q(e,r);function e(){var o=r!==null&&r.apply(this,arguments)||this;return o._onGetValue=function(){return o.__$value},o._onSetValue=function(n){o.__$value=n,o.props.value=n,o.setAttribute("value",n)},o.valueLength=0,o.handleBlur=function(n){o.props.onBlur?o.props.onBlur(n):o.fire("blur",o.props.value)},o.handleFocus=function(n){o.props.onFocus?o.props.onFocus(n):o.fire("focus",o.props.value)},o.handleChange=function(n){o.__$value=n.target.value,o.props.value=n.target.value,o.props.onChange?o.props.onChange(n):o.fire("change",o.props.value)},o.handleInput=function(n){n.stopPropagation(),o.__$value=n.target.value,o.props.value=n.target.value,o.props.onInput?o.props.onInput(n):o.fire("input",o.props.value),o.props.maxLength&&(o.valueLength=n.target.value.length,o.update())},o.clearInput=function(){o.updateProps({value:""}),o.__$value=""},o}return e.prototype.install=function(){this.__$value=this.props.value,Object.defineProperty(this,"value",{get:this._onGetValue,set:this._onSetValue})},e.prototype.focus=function(){this.shadowRoot.querySelector("input").focus()},e.prototype.blur=function(){this.shadowRoot.querySelector("input").blur()},e.prototype.render=function(o){var n,i=o.type,t=o.size,c=o.suffixIcon,s=o.prefixIcon,d=o.autoComplete;o.validating;var l=o.onMouseEnter,u=o.onMouseLeave;o.trim;var f=U(o,["type","size","suffixIcon","prefixIcon","autoComplete","validating","onMouseEnter","onMouseLeave","trim"]);return this._tempTagName="o-icon-"+(c||s),this._tempInputTagName=i==="textarea"?"textarea":"input",a("div",g({},y(o,"o-input",(n={},n["o-input--"+t]=o.size,n["is-disabled"]=this.props.disabled,n["o-input-suffix"]=c,n["o-input-prefix"]=s,n["is-block"]=o.block,n)),{onMouseEnter:l,onMouseLeave:u}),(s||c)&&a(this._tempTagName,g({css:`svg{
            width: 1em;
          }`},y(o,"o-input__icon",{"is-prefix":s,"is-suffix":c}))),a(this._tempInputTagName,g({},f,{type:i,class:"o-"+this._tempInputTagName+"__inner",autocomplete:d,maxLength:o.maxLength,onChange:this.handleChange,onFocus:this.handleFocus,onBlur:this.handleBlur,onInput:this.handleInput})),o.clearable&&a("svg",{onClick:this.clearInput,class:"o-icon-clear",fill:"currentColor",width:"1em",height:"1em",focusable:"false",viewBox:"0 0 24 24","aria-hidden":"true"},a("path",{d:"M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"})),o.maxLength&&a("span",{class:"o-input__count"},a("span",{class:"o-input__count-inner"},this.valueLength,"/",o.maxLength)))},e.css=Y,e.defaultProps={value:"",type:"text",autosize:!1,rows:2,trim:!1,autoComplete:"off",block:!1},e.propTypes={disabled:Boolean,type:String,placeholder:String,clearable:Boolean,suffixIcon:String,size:String,prefixIcon:String,maxLength:Number,autoComplete:String,block:Boolean,value:String},e=X([h("o-input")],e),e})(_);var F=`.o-dialog__body {
