import{W as d,h as t,t as p,s as u,a as m}from"./index.bf6785d8.js";import"./admin-docs.35672bd1.js";import"./index.f7b137ab.js";import"./container.f851b825.js";import"./index.esm.8837d165.js";import"./encode.47cdd865.js";import"./___vite-browser-external_commonjs-proxy.9dfe6bbb.js";var h=Object.defineProperty,c=Object.getOwnPropertyDescriptor,g=(n,a,s,r)=>{for(var e=r>1?void 0:r?c(a,s):a,l=n.length-1,o;l>=0;l--)(o=n[l])&&(e=(r?o(a,s,e):o(e))||e);return r&&e&&h(a,s,e),e};const f="radar-chart";let i=class extends d{constructor(){super(...arguments),this.options={maintainAspectRatio:!0,spanGaps:!1,elements:{line:{tension:1e-6}},plugins:{filler:{propagate:!1},"samples-filler-analyser":{target:"chart-analyser"}}},this.data={labels:["Red","Blue","Yellow","Green","Purple","Orange"],datasets:[{label:"# of Votes",data:[12,19,3,5,2,3],backgroundColor:"rgba(255, 99, 132, .2)",borderColor:"rgb(255, 99, 132)",borderWidth:1}]},this.mdA=`
  \`\`\`html
