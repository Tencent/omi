...
<o-bar id="myBar" width="600" height="300"
  ...
  \`\`\`
  `}installed(){}render(){return t("code-demo-container",null,t("code-demo",{title:"\u5408\u6210\u56FE",describe:"\u5408\u6210\u56FE\u663E\u793A",code:this.mdA},t("div",{slot:"demo",class:i`px-3 py-5`},t("o-bar",{id:"myBar",width:"600",height:"300",data:this.data,options:this.options}))))}};s.css=[n.target];s=h([u(m)],s);export{s as default};
