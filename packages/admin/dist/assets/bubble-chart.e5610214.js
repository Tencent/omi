...
<o-bubble id="myChart" width="300" height="350"
  ...
  \`\`\`
  `}installed(){}render(){return o("code-demo-container",null,o("code-demo",{title:"\u6C14\u6CE1\u56FE",describe:"\u6C14\u6CE1\u56FE\u663E\u793A",code:this.mdA},o("div",{slot:"demo",class:i`px-3 py-5`},o("o-bubble",{id:"myChart",width:"300",height:"350",data:this.data,options:this.options}))))}};l.css=[b.target];l=p([y(x)],l);export{l as default};
