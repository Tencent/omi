...
.o-circleDisableShrink {
  animation: none; }
`;(function(l){__extends$3(g,l);function g(){return l!==null&&l.apply(this,arguments)||this}return g.prototype.render=function(m){return h$1("div",{class:"o-root o-colorPrimary o-indeterminate",role:"progressbar",style:"width: "+m.size+"px; height: "+m.size+"px;"+(m.color?"color:"+m.color+";":"")},h$1("svg",{class:"o-svg",viewBox:"22 22 44 44"},h$1("circle",{class:"o-circle o-circleIndeterminate",cx:"44",cy:"44",r:"20.2",fill:"none","stroke-width":"3.6"})))},g.css=css$8,g.defaultProps={size:40},g.propTypes={size:Number,color:String},g=__decorate$3([tag("o-loading")],g),g})(WeElement);const readyCallbacks$3=[];document.addEventListener("DOMContentLoaded",()=>{domReady$3.done=!0,readyCallbacks$3.forEach(l=>{l()})});function domReady$3(l){if(domReady$3.done){l();return}readyCallbacks$3.push(l)}domReady$3.done=!1;var __defProp$1$3=Object.defineProperty,__getOwnPropDesc$1$3=Object.getOwnPropertyDescriptor,__decorateClass$1$3=(l,g,m,b)=>{for(var v=b>1?void 0:b?__getOwnPropDesc$1$3(g,m):g,y=l.length-1,w;y>=0;y--)(w=l[y])&&(v=(b?w(g,m,v):w(v))||v);return b&&v&&__defProp$1$3(g,m,v),v};let Transition$2=class extends WeElement{constructor(){super(...arguments),this._show=!0}installed(){domReady$3(()=>{this.props.appear&&this.enter(),this.props.leavingTime&&setTimeout(()=>{this.leave()},this.props.leavingTime)})}receiveProps(){this.props.appear&&this.enter(),this.props.disappear&&this.leave()}async toggle(){return this._show=!this._show,this._show?await this.enter():await this.leave()}async enter(){return new Promise(l=>{const g=this.children[0];g&&(this.fire("before-enter"),g.classList.remove(this.props.name+"-leave-active"),g.classList.remove(this.props.name+"-leave-to"),g.classList.add(this.props.name+"-enter-from"),g.classList.add(this.props.name+"-enter-active"),this.callback=function(){g.classList.remove(this.props.name+"-enter-active"),this.fire("after-enter"),this._show=!0,l()}.bind(this),this.once("transitionend",this.callback),this.once("animationend",this.callback),window.setTimeout(function(){g.classList.remove(this.props.name+"-enter-from"),g.classList.add(this.props.name+"-enter-to"),this.fire("enter")}.bind(this),this.props.delay))})}async leave(){return new Promise(l=>{const g=this.children[0];g&&(this.fire("before-leave"),g.classList.remove(this.props.name+"-enter-active"),g.classList.remove(this.props.name+"-enter-to"),g.classList.add(this.props.name+"-leave-from"),g.classList.add(this.props.name+"-leave-active"),this.callback=function(m){g.classList.remove(this.props.name+"-leave-active"),this.fire("after-leave"),this._show=!1,this.props.autoRemove&&this.parentNode&&this.parentNode.removeChild(this),l()}.bind(this),this.once("transitionend",this.callback),this.once("animationend",this.callback),window.setTimeout(function(){g.classList.remove(this.props.name+"-leave-from"),g.classList.add(this.props.name+"-leave-to"),this.fire("leave")}.bind(this),this.props.delay))})}once(l,g){const m=function(){this.removeEventListener(l,m),g()}.bind(this);this.addEventListener(l,m)}render(){}};Transition$2.propTypes={name:String,leavingTime:Number,autoRemove:Boolean,appear:Boolean,disappear:Boolean,delay:Number};Transition$2.isLightDom=!0;Transition$2.defaultProps={name:"o",delay:0};Transition$2=__decorateClass$1$3([tag("o-transition")],Transition$2);var __defProp$a=Object.defineProperty,__getOwnPropDesc$a=Object.getOwnPropertyDescriptor,__decorateClass$a=(l,g,m,b)=>{for(var v=b>1?void 0:b?__getOwnPropDesc$a(g,m):g,y=l.length-1,w;y>=0;y--)(w=l[y])&&(v=(b?w(g,m,v):w(v))||v);return b&&v&&__defProp$a(g,m,v),v};let Toast=class extends WeElement{installed(){this.props.autoHide&&(setTimeout(()=>{this.hide()},this.props.duration+200),setTimeout(()=>{this.parentNode.removeChild(this)},this.props.duration+200*2))}hide(){this.setAttribute("show",!1),setTimeout(()=>{this.parentNode.removeChild(this)},200)}render(l){return h$1("o-transition",{appear:l.show,name:"fade"},h$1("div",null,h$1("div",{class:"o-mask-transparent"}),h$1("div",{...extractClass(l,"o-toast")},h$1("slot",null),l.loading&&h$1("o-loading",{size:40,color:"white"}),l.success&&h$1("i",{class:"o-success"}),l.warning&&h$1("i",{class:"o-warning"}),h$1("p",{class:"o-toast-content"},l.content||(l.loading?"\u52A0\u8F7D\u4E2D":"")))))}};Toast.css=css$1$1;Toast.defaultProps={duration:2e3,autoHide:!1,show:!0,content:""};Toast.propTypes={content:String,loading:Boolean,success:Boolean,warning:Boolean,duration:Number,autoHide:Boolean,show:Boolean};Toast=__decorateClass$a([tag("o-toast")],Toast);Toast.showLoading=showLoading;Toast.hideLoading=hideLoading;let el;function showLoading(l){return remove$1(),el=document.createElement("o-toast"),el.setAttribute("show","1"),el.setAttribute("loading","1"),typeof l=="string"&&el.setAttribute("content",l),document.body.appendChild(el),el}function hideLoading(){hide$4()}function showSuccess(l){return remove$1(),el=document.createElement("o-toast"),el.setAttribute("show","1"),el.setAttribute("success","1"),typeof l=="string"&&el.setAttribute("content",l),document.body.appendChild(el),el}function hideSuccess(){hide$4()}function showWarning(l){return remove$1(),el=document.createElement("o-toast"),el.setAttribute("show","1"),el.setAttribute("warning","1"),typeof l=="string"&&el.setAttribute("content",l),document.body.appendChild(el),el}function hideWarning(){hide$4()}function hide$4(){el&&(el.hide(),el=null)}function remove$1(){el&&el.parentNode.removeChild(el)}function __variableDynamicImportRuntime14__(l){switch(l){case"./components/charts/bar-chart.tsx":return __vitePreload(()=>import("./bar-chart.5f0ac923.js"),["assets/bar-chart.5f0ac923.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js","assets/index.esm.d4c78e0e.js"]);case"./components/charts/barline-chart.tsx":return __vitePreload(()=>import("./barline-chart.7e4567c0.js"),["assets/barline-chart.7e4567c0.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js","assets/index.esm.d4c78e0e.js"]);case"./components/charts/bubble-chart.tsx":return __vitePreload(()=>import("./bubble-chart.bf20246e.js"),["assets/bubble-chart.bf20246e.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js","assets/index.esm.d4c78e0e.js"]);case"./components/charts/doughnut-chart.tsx":return __vitePreload(()=>import("./doughnut-chart.9b53c395.js"),["assets/doughnut-chart.9b53c395.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js","assets/index.esm.d4c78e0e.js"]);case"./components/charts/line-chart.tsx":return __vitePreload(()=>import("./line-chart.17b47c6b.js"),["assets/line-chart.17b47c6b.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js","assets/index.esm.d4c78e0e.js"]);case"./components/charts/pie-chart.tsx":return __vitePreload(()=>import("./pie-chart.fa1f236d.js"),["assets/pie-chart.fa1f236d.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js","assets/index.esm.d4c78e0e.js"]);case"./components/charts/polar-area-chart.tsx":return __vitePreload(()=>import("./polar-area-chart.c4fda195.js"),["assets/polar-area-chart.c4fda195.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js","assets/index.esm.d4c78e0e.js"]);case"./components/charts/radar-chart.tsx":return __vitePreload(()=>import("./radar-chart.0fd946fa.js"),["assets/radar-chart.0fd946fa.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js","assets/index.esm.d4c78e0e.js"]);case"./components/charts/scatter-chart.tsx":return __vitePreload(()=>import("./scatter-chart.d8076ed0.js"),["assets/scatter-chart.d8076ed0.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js","assets/index.esm.d4c78e0e.js"]);default:return new Promise(function(g,m){(typeof queueMicrotask=="function"?queueMicrotask:setTimeout)(m.bind(null,new Error("Unknown variable dynamic import: "+l)))})}}function __variableDynamicImportRuntime13__(l){switch(l){case"./components/components/action-sheet-component.tsx":return __vitePreload(()=>import("./action-sheet-component.56d40196.js"),["assets/action-sheet-component.56d40196.js","assets/index.esm.737b4650.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js"]);case"./components/components/avatar-component.tsx":return __vitePreload(()=>import("./avatar-component.14d534e8.js"),["assets/avatar-component.14d534e8.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js"]);case"./components/components/badge-component.tsx":return __vitePreload(()=>import("./badge-component.bd968b50.js"),["assets/badge-component.bd968b50.js","assets/favorite.93734a2e.js","assets/index.esm.61ac573b.js","assets/index.esm.f88e6c93.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js"]);case"./components/components/bottom-nav-component.tsx":return __vitePreload(()=>import("./bottom-nav-component.6bc9d1bb.js"),["assets/bottom-nav-component.6bc9d1bb.js","assets/favorite.93734a2e.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js"]);case"./components/components/breadcrumb-component.tsx":return __vitePreload(()=>import("./breadcrumb-component.a1434cff.js"),["assets/breadcrumb-component.a1434cff.js","assets/people.aa9b495d.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js"]);case"./components/components/button-component.tsx":return __vitePreload(()=>import("./button-component.e7d28875.js"),["assets/button-component.e7d28875.js","assets/ac-unit-outlined.1203ee06.js","assets/accessible-rounded.bf1c418e.js","assets/add-ic-call-rounded.a3751eb3.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js"]);case"./components/components/card-component.tsx":return __vitePreload(()=>import("./card-component.2f869a9e.js"),["assets/card-component.2f869a9e.js","assets/index.esm.63611bfb.js","assets/add-ic-call-rounded.a3751eb3.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js"]);case"./components/components/cascader-component.tsx":return __vitePreload(()=>import("./cascader-component.06b4d50e.js"),["assets/cascader-component.06b4d50e.js","assets/index.es.fd589aa5.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js"]);case"./components/components/checkbox-component.tsx":return __vitePreload(()=>import("./checkbox-component.9b62ad9b.js"),["assets/checkbox-component.9b62ad9b.js","assets/index.5c4c22c8.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js"]);case"./components/components/collapse-component.tsx":return __vitePreload(()=>import("./collapse-component.1dffb082.js"),["assets/collapse-component.1dffb082.js","assets/index.6fe68bd4.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/container.7e74ab46.js"]);case"./components/components/color-picker-component.tsx":return __vitePreload(()=>import("./color-picker-component.8b73285e.js"),["assets/color-picker-component.8b73285e.js","assets/index.es.b1af434a.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js"]);case"./components/components/dialog-component.tsx":return __vitePreload(()=>import("./dialog-component.3bbcf16a.js"),["assets/dialog-component.3bbcf16a.js","assets/index.esm.737b4650.js","assets/index.esm.b1bdf950.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js"]);case"./components/components/example-component.tsx":return __vitePreload(()=>import("./example-component.e559e071.js"),["assets/example-component.e559e071.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js"]);case"./components/components/hamburger-menu-component.tsx":return __vitePreload(()=>import("./hamburger-menu-component.432260c3.js"),["assets/hamburger-menu-component.432260c3.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js"]);case"./components/components/input-component.tsx":return __vitePreload(()=>import("./input-component.c5141b7a.js"),["assets/input-component.c5141b7a.js","assets/index.esm.c8792347.js","assets/ac-unit-outlined.1203ee06.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js"]);case"./components/components/link-component.tsx":return __vitePreload(()=>import("./link-component.43d60cf3.js"),["assets/link-component.43d60cf3.js","assets/index.esm.63611bfb.js","assets/ac-unit-outlined.1203ee06.js","assets/accessible-rounded.bf1c418e.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js"]);case"./components/components/loading-component.tsx":return __vitePreload(()=>import("./loading-component.3ecb9853.js"),["assets/loading-component.3ecb9853.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js"]);case"./components/components/pagination-component.tsx":return __vitePreload(()=>import("./pagination-component.cbc5c457.js"),["assets/pagination-component.cbc5c457.js","assets/index.esm.306c648d.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js"]);case"./components/components/progress-component.tsx":return __vitePreload(()=>import("./progress-component.7cb8a293.js"),["assets/progress-component.7cb8a293.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js"]);case"./components/components/radio-component.tsx":return __vitePreload(()=>import("./radio-component.f49fd0c1.js"),["assets/radio-component.f49fd0c1.js","assets/index.esm.62232d76.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js"]);case"./components/components/rate-component.tsx":return __vitePreload(()=>import("./rate-component.aaf1dcd0.js"),["assets/rate-component.aaf1dcd0.js","assets/index.esm.61ac573b.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js"]);case"./components/components/slider-component.tsx":return __vitePreload(()=>import("./slider-component.8a8f40a5.js"),["assets/slider-component.8a8f40a5.js","assets/index.esm.c8792347.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js"]);case"./components/components/switch-component.tsx":return __vitePreload(()=>import("./switch-component.71510b18.js"),["assets/switch-component.71510b18.js","assets/index.esm.f88e6c93.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js"]);case"./components/components/tabs-component.tsx":return __vitePreload(()=>import("./tabs-component.97889489.js"),["assets/tabs-component.97889489.js","assets/ac-unit-outlined.1203ee06.js","assets/accessible-rounded.bf1c418e.js","assets/add-ic-call-rounded.a3751eb3.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js"]);case"./components/components/tag-component.tsx":return __vitePreload(()=>import("./tag-component.f72c7acf.js"),["assets/tag-component.f72c7acf.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js"]);case"./components/components/time-picker-component.tsx":return __vitePreload(()=>import("./time-picker-component.51df71ac.js"),["assets/time-picker-component.51df71ac.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js"]);case"./components/components/toast-component.tsx":return __vitePreload(()=>import("./toast-component.63fabd6b.js"),["assets/toast-component.63fabd6b.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js"]);case"./components/components/toggle-icon-component.tsx":return __vitePreload(()=>import("./toggle-icon-component.35b68569.js"),["assets/toggle-icon-component.35b68569.js","assets/index.6fe68bd4.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/favorite.93734a2e.js","assets/container.7e74ab46.js"]);case"./components/components/tree-component.tsx":return __vitePreload(()=>import("./tree-component.5d9a6983.js"),["assets/tree-component.5d9a6983.js","assets/ac-unit-outlined.1203ee06.js","assets/accessible-rounded.bf1c418e.js","assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js","assets/index.6fe68bd4.js","assets/container.7e74ab46.js"]);default:return new Promise(function(g,m){(typeof queueMicrotask=="function"?queueMicrotask:setTimeout)(m.bind(null,new Error("Unknown variable dynamic import: "+l)))})}}const components=["breadcrumb","bottom-nav","button","badge","cascader","color-picker","checkbox","hamburger-menu","tabs","slider","input","loading","link","toast","toggle-icon","card","radio","progress","pagination","time-picker","tag","tree","rate","dialog","avatar","action-sheet","switch","collapse"],charts=["bar","line","scatter","pie","doughnut","radar","polar-area","bubble","barline"];function registerRouting(l){route$1("/",()=>{l.update()}),route$1("/welcome",()=>{l.transitionTo("admin-main-welcome")}),route$1("/mobile",()=>{showLoading(),__vitePreload(()=>import("./mobile-show.a557cdb7.js"),["assets/mobile-show.a557cdb7.js","assets/mobile-show.6bce6f64.css"]).then(()=>l.transitionTo("mobile-show"))}),route$1("/table/basic",()=>{showLoading(),__vitePreload(()=>import("./basic-table.3fa31cb6.js"),["assets/basic-table.3fa31cb6.js","assets/index.es.c180cc40.js","assets/index.5c4c22c8.js","assets/index.esm.c8792347.js"]).then(()=>l.transitionTo("basic-table"))}),route$1("/basic-list",()=>{showLoading(),__vitePreload(()=>import("./basic-list.7255d4be.js"),["assets/basic-list.7255d4be.js","assets/index.es.c180cc40.js","assets/index.5c4c22c8.js","assets/index.esm.c8792347.js","assets/index.esm.306c648d.js","assets/index.esm.63611bfb.js","assets/index.esm.b1bdf950.js"]).then(()=>l.transitionTo("basic-list"))}),route$1("/dashboard",()=>{showLoading(),__vitePreload(()=>import("./admin-dashboard.88f87cb9.js"),["assets/admin-dashboard.88f87cb9.js","assets/people.aa9b495d.js","assets/index.es.c180cc40.js","assets/index.5c4c22c8.js","assets/index.esm.c8792347.js","assets/index.esm.306c648d.js"]).then(()=>l.transitionTo("admin-dashboard"))}),route$1("/md-editor",()=>{showLoading(),__vitePreload(()=>import("./md-editor.ded613ef.js"),["assets/md-editor.ded613ef.js","assets/md-editor.f29e0c00.css","assets/encode.fafe6b99.js"]).then(()=>l.transitionTo("md-editor"))}),route$1("/table/edit",()=>{showLoading(),__vitePreload(()=>import("./inline-editing.3f1e8efc.js"),["assets/inline-editing.3f1e8efc.js","assets/index.es.c180cc40.js","assets/index.5c4c22c8.js","assets/index.esm.c8792347.js","assets/index.esm.306c648d.js"]).then(()=>l.transitionTo("inline-editing"))}),route$1("/docs/:name",m=>{const b=l.getMdByName(m.params.name,l.store.treeData);b&&b.then(v=>{l.payload={mdContent:v.default,padding:20},showLoading(),__vitePreload(()=>import("./admin-docs.7ab264db.js"),["assets/admin-docs.7ab264db.js","assets/admin-docs.bc8ad975.css","assets/encode.fafe6b99.js","assets/___vite-browser-external_commonjs-proxy.2a29e4a8.js"]).then(()=>l.transitionTo("admin-docs"))})}),route$1("/table/pagination",()=>{showLoading(),__vitePreload(()=>import("./pagination-table.5f1525de.js"),["assets/pagination-table.5f1525de.js","assets/index.es.c180cc40.js","assets/index.5c4c22c8.js","assets/index.esm.c8792347.js","assets/index.esm.306c648d.js"]).then(()=>l.transitionTo("pagination-table"))}),route$1("/form",()=>{showLoading(),__vitePreload(()=>import("./admin-form.5be94a02.js"),["assets/admin-form.5be94a02.js","assets/index.esm.c8792347.js","assets/index.esm.f88e6c93.js","assets/index.esm.62232d76.js","assets/index.5c4c22c8.js","assets/index.es.a54f0dd8.js","assets/index.es.fd589aa5.js","assets/index.es.b1af434a.js"]).then(()=>l.transitionTo("admin-form"))}),route$1("/steps-form",()=>{showLoading(),__vitePreload(()=>import("./steps-form.cbf67bad.js"),["assets/steps-form.cbf67bad.js","assets/index.esm.c8792347.js","assets/index.esm.f88e6c93.js","assets/index.esm.62232d76.js","assets/index.5c4c22c8.js","assets/index.es.a54f0dd8.js","assets/index.es.fd589aa5.js"]).then(()=>l.transitionTo("steps-form"))}),route$1("/comment",()=>{showLoading(),__vitePreload(()=>import("./admin-comment.d2b3cd4f.js"),["assets/admin-comment.d2b3cd4f.js","assets/admin-comment.38a7e410.css","assets/index.esm.c8792347.js"]).then(()=>l.transitionTo("admin-comment"))}),route$1("/icon",()=>{showLoading(),__vitePreload(()=>import("./admin-icon.59ec0c08.js"),[]).then(()=>l.transitionTo("admin-icon"))}),route$1("/error",()=>{showLoading(),__vitePreload(()=>import("./status-error.de9cff80.js"),[]).then(()=>l.transitionTo("status-error"))}),components.map(m=>route$1(`/${m}-component`,()=>{showLoading(),__variableDynamicImportRuntime13__(`./components/components/${m}-component.tsx`).then(()=>l.transitionTo(`${m}-component`))})),charts.map(m=>route$1(`/${m}-chart`,()=>{showLoading(),__variableDynamicImportRuntime14__(`./components/charts/${m}-chart.tsx`).then(()=>l.transitionTo(`${m}-chart`))})),route$1("/mind-map",()=>{showLoading(),__vitePreload(()=>import("./mind-map.485151e8.js"),[]).then(()=>l.transitionTo("mind-map"))}),route$1("/warning",()=>{showLoading(),__vitePreload(()=>import("./status-warning.062b4dca.js"),[]).then(()=>l.transitionTo("status-warning"))}),route$1("/results/browser-incompatible",()=>{showLoading(),__vitePreload(()=>import("./browser-incompatible.0bf8cdd9.js"),[]).then(()=>l.transitionTo("browser-incompatible"))}),route$1("/success",()=>{showLoading(),__vitePreload(()=>import("./admin-success.124b4cb3.js"),[]).then(()=>l.transitionTo("admin-success"))}),route$1("/failure",()=>{showLoading(),__vitePreload(()=>import("./admin-failure.8171cd3e.js"),[]).then(()=>l.transitionTo("admin-failure"))}),[{path:"/results/network-error",component:"./components/results/network-error",name:"network-error"},{path:"/results/not-found",component:"./components/results/not-found",name:"not-found"},{path:"/results/permission-denied",component:"./components/results/permission-denied",name:"permission-denied"},{path:"/results/server-error",component:"./components/results/server-error",name:"server-error"},{path:"/masonry-list",component:"./components/masonry-list",name:"masonry-list"},{path:"/notification-list",component:"./components/notification/notification-list",name:"notification-list"},{path:"/personal-center",component:"./components/account/personal-center",name:"personal-center"}].forEach(m=>{route$1(m.path,()=>{showLoading(),__vitePreload(()=>import(m.component),[]).then(()=>l.transitionTo(m.name))})}),route$1("*",function(){console.log("not found")})}var index$5=`html,body{padding:0;margin:0;overflow:hidden}::-webkit-scrollbar{width:6px}::-webkit-scrollbar:horizontal{height:6px}::-webkit-scrollbar-track{background:transparent;border-radius:6px}::-webkit-scrollbar-thumb{background:#ccc;border-radius:6px}::-webkit-scrollbar-thumb:hover{background:#999}
`,top$2="top",bottom$2="bottom",right$2="right",left$2="left",auto$2="auto",basePlacements$2=[top$2,bottom$2,right$2,left$2],start$2="start",end$2="end",clippingParents$2="clippingParents",viewport$2="viewport",popper$2="popper",reference$2="reference",variationPlacements$2=basePlacements$2.reduce(function(l,g){return l.concat([g+"-"+start$2,g+"-"+end$2])},[]),placements$2=[].concat(basePlacements$2,[auto$2]).reduce(function(l,g){return l.concat([g,g+"-"+start$2,g+"-"+end$2])},[]),beforeRead$2="beforeRead",read$2="read",afterRead$2="afterRead",beforeMain$2="beforeMain",main$2="main",afterMain$2="afterMain",beforeWrite$2="beforeWrite",write$2="write",afterWrite$2="afterWrite",modifierPhases$2=[beforeRead$2,read$2,afterRead$2,beforeMain$2,main$2,afterMain$2,beforeWrite$2,write$2,afterWrite$2];function getNodeName$2(l){return l?(l.nodeName||"").toLowerCase():null}function getWindow$2(l){if(l==null)return window;if(l.toString()!=="[object Window]"){var g=l.ownerDocument;return g&&g.defaultView||window}return l}function isElement$2(l){var g=getWindow$2(l).Element;return l instanceof g||l instanceof Element}function isHTMLElement$2(l){var g=getWindow$2(l).HTMLElement;return l instanceof g||l instanceof HTMLElement}function isShadowRoot$2(l){if(typeof ShadowRoot=="undefined")return!1;var g=getWindow$2(l).ShadowRoot;return l instanceof g||l instanceof ShadowRoot}function applyStyles$3(l){var g=l.state;Object.keys(g.elements).forEach(function(m){var b=g.styles[m]||{},v=g.attributes[m]||{},y=g.elements[m];!isHTMLElement$2(y)||!getNodeName$2(y)||(Object.assign(y.style,b),Object.keys(v).forEach(function(w){var E=v[w];E===!1?y.removeAttribute(w):y.setAttribute(w,E===!0?"":E)}))})}function effect$2$2(l){var g=l.state,m={popper:{position:g.options.strategy,left:"0",top:"0",margin:"0"},arrow:{position:"absolute"},reference:{}};return Object.assign(g.elements.popper.style,m.popper),g.styles=m,g.elements.arrow&&Object.assign(g.elements.arrow.style,m.arrow),function(){Object.keys(g.elements).forEach(function(b){var v=g.elements[b],y=g.attributes[b]||{},w=Object.keys(g.styles.hasOwnProperty(b)?g.styles[b]:m[b]),E=w.reduce(function(O,k){return O[k]="",O},{});!isHTMLElement$2(v)||!getNodeName$2(v)||(Object.assign(v.style,E),Object.keys(y).forEach(function(O){v.removeAttribute(O)}))})}}var applyStyles$1$2={name:"applyStyles",enabled:!0,phase:"write",fn:applyStyles$3,effect:effect$2$2,requires:["computeStyles"]};function getBasePlacement$2(l){return l.split("-")[0]}var max$2=Math.max,min$2=Math.min,round$2=Math.round;function getBoundingClientRect$2(l,g){g===void 0&&(g=!1);var m=l.getBoundingClientRect(),b=1,v=1;if(isHTMLElement$2(l)&&g){var y=l.offsetHeight,w=l.offsetWidth;w>0&&(b=round$2(m.width)/w||1),y>0&&(v=round$2(m.height)/y||1)}return{width:m.width/b,height:m.height/v,top:m.top/v,right:m.right/b,bottom:m.bottom/v,left:m.left/b,x:m.left/b,y:m.top/v}}function getLayoutRect$2(l){var g=getBoundingClientRect$2(l),m=l.offsetWidth,b=l.offsetHeight;return Math.abs(g.width-m)<=1&&(m=g.width),Math.abs(g.height-b)<=1&&(b=g.height),{x:l.offsetLeft,y:l.offsetTop,width:m,height:b}}function contains$2(l,g){var m=g.getRootNode&&g.getRootNode();if(l.contains(g))return!0;if(m&&isShadowRoot$2(m)){var b=g;do{if(b&&l.isSameNode(b))return!0;b=b.parentNode||b.host}while(b)}return!1}function getComputedStyle$2(l){return getWindow$2(l).getComputedStyle(l)}function isTableElement$2(l){return["table","td","th"].indexOf(getNodeName$2(l))>=0}function getDocumentElement$2(l){return((isElement$2(l)?l.ownerDocument:l.document)||window.document).documentElement}function getParentNode$2(l){return getNodeName$2(l)==="html"?l:l.assignedSlot||l.parentNode||(isShadowRoot$2(l)?l.host:null)||getDocumentElement$2(l)}function getTrueOffsetParent$2(l){return!isHTMLElement$2(l)||getComputedStyle$2(l).position==="fixed"?null:l.offsetParent}function getContainingBlock$2(l){var g=navigator.userAgent.toLowerCase().indexOf("firefox")!==-1,m=navigator.userAgent.indexOf("Trident")!==-1;if(m&&isHTMLElement$2(l)){var b=getComputedStyle$2(l);if(b.position==="fixed")return null}var v=getParentNode$2(l);for(isShadowRoot$2(v)&&(v=v.host);isHTMLElement$2(v)&&["html","body"].indexOf(getNodeName$2(v))<0;){var y=getComputedStyle$2(v);if(y.transform!=="none"||y.perspective!=="none"||y.contain==="paint"||["transform","perspective"].indexOf(y.willChange)!==-1||g&&y.willChange==="filter"||g&&y.filter&&y.filter!=="none")return v;v=v.parentNode}return null}function getOffsetParent$2(l){for(var g=getWindow$2(l),m=getTrueOffsetParent$2(l);m&&isTableElement$2(m)&&getComputedStyle$2(m).position==="static";)m=getTrueOffsetParent$2(m);return m&&(getNodeName$2(m)==="html"||getNodeName$2(m)==="body"&&getComputedStyle$2(m).position==="static")?g:m||getContainingBlock$2(l)||g}function getMainAxisFromPlacement$2(l){return["top","bottom"].indexOf(l)>=0?"x":"y"}function within$2(l,g,m){return max$2(l,min$2(g,m))}function withinMaxClamp$1(l,g,m){var b=within$2(l,g,m);return b>m?m:b}function getFreshSideObject$2(){return{top:0,right:0,bottom:0,left:0}}function mergePaddingObject$2(l){return Object.assign({},getFreshSideObject$2(),l)}function expandToHashMap$2(l,g){return g.reduce(function(m,b){return m[b]=l,m},{})}var toPaddingObject$2=function(g,m){return g=typeof g=="function"?g(Object.assign({},m.rects,{placement:m.placement})):g,mergePaddingObject$2(typeof g!="number"?g:expandToHashMap$2(g,basePlacements$2))};function arrow$3(l){var g,m=l.state,b=l.name,v=l.options,y=m.elements.arrow,w=m.modifiersData.popperOffsets,E=getBasePlacement$2(m.placement),O=getMainAxisFromPlacement$2(E),k=[left$2,right$2].indexOf(E)>=0,S=k?"height":"width";if(!(!y||!w)){var P=toPaddingObject$2(v.padding,m),j=getLayoutRect$2(y),C=O==="y"?top$2:left$2,L=O==="y"?bottom$2:right$2,R=m.rects.reference[S]+m.rects.reference[O]-w[O]-m.rects.popper[S],A=w[O]-m.rects.reference[O],D=getOffsetParent$2(y),N=D?O==="y"?D.clientHeight||0:D.clientWidth||0:0,F=R/2-A/2,T=P[C],B=N-j[S]-P[L],z=N/2-j[S]/2+F,M=within$2(T,z,B),I=O;m.modifiersData[b]=(g={},g[I]=M,g.centerOffset=M-z,g)}}function effect$1$2(l){var g=l.state,m=l.options,b=m.element,v=b===void 0?"[data-popper-arrow]":b;v!=null&&(typeof v=="string"&&(v=g.elements.popper.querySelector(v),!v)||!contains$2(g.elements.popper,v)||(g.elements.arrow=v))}var arrow$1$2={name:"arrow",enabled:!0,phase:"main",fn:arrow$3,effect:effect$1$2,requires:["popperOffsets"],requiresIfExists:["preventOverflow"]};function getVariation$2(l){return l.split("-")[1]}var unsetSides$2={top:"auto",right:"auto",bottom:"auto",left:"auto"};function roundOffsetsByDPR$2(l){var g=l.x,m=l.y,b=window,v=b.devicePixelRatio||1;return{x:round$2(g*v)/v||0,y:round$2(m*v)/v||0}}function mapToStyles$2(l){var g,m=l.popper,b=l.popperRect,v=l.placement,y=l.variation,w=l.offsets,E=l.position,O=l.gpuAcceleration,k=l.adaptive,S=l.roundOffsets,P=l.isFixed,j=w.x,C=j===void 0?0:j,L=w.y,R=L===void 0?0:L,A=typeof S=="function"?S({x:C,y:R}):{x:C,y:R};C=A.x,R=A.y;var D=w.hasOwnProperty("x"),N=w.hasOwnProperty("y"),F=left$2,T=top$2,B=window;if(k){var z=getOffsetParent$2(m),M="clientHeight",I="clientWidth";if(z===getWindow$2(m)&&(z=getDocumentElement$2(m),getComputedStyle$2(z).position!=="static"&&E==="absolute"&&(M="scrollHeight",I="scrollWidth")),z=z,v===top$2||(v===left$2||v===right$2)&&y===end$2){T=bottom$2;var U=P&&z===B&&B.visualViewport?B.visualViewport.height:z[M];R-=U-b.height,R*=O?1:-1}if(v===left$2||(v===top$2||v===bottom$2)&&y===end$2){F=right$2;var q=P&&z===B&&B.visualViewport?B.visualViewport.width:z[I];C-=q-b.width,C*=O?1:-1}}var H=Object.assign({position:E},k&&unsetSides$2),Y=S===!0?roundOffsetsByDPR$2({x:C,y:R}):{x:C,y:R};if(C=Y.x,R=Y.y,O){var X;return Object.assign({},H,(X={},X[T]=N?"0":"",X[F]=D?"0":"",X.transform=(B.devicePixelRatio||1)<=1?"translate("+C+"px, "+R+"px)":"translate3d("+C+"px, "+R+"px, 0)",X))}return Object.assign({},H,(g={},g[T]=N?R+"px":"",g[F]=D?C+"px":"",g.transform="",g))}function computeStyles$3(l){var g=l.state,m=l.options,b=m.gpuAcceleration,v=b===void 0?!0:b,y=m.adaptive,w=y===void 0?!0:y,E=m.roundOffsets,O=E===void 0?!0:E,k={placement:getBasePlacement$2(g.placement),variation:getVariation$2(g.placement),popper:g.elements.popper,popperRect:g.rects.popper,gpuAcceleration:v,isFixed:g.options.strategy==="fixed"};g.modifiersData.popperOffsets!=null&&(g.styles.popper=Object.assign({},g.styles.popper,mapToStyles$2(Object.assign({},k,{offsets:g.modifiersData.popperOffsets,position:g.options.strategy,adaptive:w,roundOffsets:O})))),g.modifiersData.arrow!=null&&(g.styles.arrow=Object.assign({},g.styles.arrow,mapToStyles$2(Object.assign({},k,{offsets:g.modifiersData.arrow,position:"absolute",adaptive:!1,roundOffsets:O})))),g.attributes.popper=Object.assign({},g.attributes.popper,{"data-popper-placement":g.placement})}var computeStyles$1$2={name:"computeStyles",enabled:!0,phase:"beforeWrite",fn:computeStyles$3,data:{}},passive$2={passive:!0};function effect$4(l){var g=l.state,m=l.instance,b=l.options,v=b.scroll,y=v===void 0?!0:v,w=b.resize,E=w===void 0?!0:w,O=getWindow$2(g.elements.popper),k=[].concat(g.scrollParents.reference,g.scrollParents.popper);return y&&k.forEach(function(S){S.addEventListener("scroll",m.update,passive$2)}),E&&O.addEventListener("resize",m.update,passive$2),function(){y&&k.forEach(function(S){S.removeEventListener("scroll",m.update,passive$2)}),E&&O.removeEventListener("resize",m.update,passive$2)}}var eventListeners$2={name:"eventListeners",enabled:!0,phase:"write",fn:function(){},effect:effect$4,data:{}},hash$1$2={left:"right",right:"left",bottom:"top",top:"bottom"};function getOppositePlacement$2(l){return l.replace(/left|right|bottom|top/g,function(g){return hash$1$2[g]})}var hash$3={start:"end",end:"start"};function getOppositeVariationPlacement$2(l){return l.replace(/start|end/g,function(g){return hash$3[g]})}function getWindowScroll$2(l){var g=getWindow$2(l),m=g.pageXOffset,b=g.pageYOffset;return{scrollLeft:m,scrollTop:b}}function getWindowScrollBarX$2(l){return getBoundingClientRect$2(getDocumentElement$2(l)).left+getWindowScroll$2(l).scrollLeft}function getViewportRect$2(l){var g=getWindow$2(l),m=getDocumentElement$2(l),b=g.visualViewport,v=m.clientWidth,y=m.clientHeight,w=0,E=0;return b&&(v=b.width,y=b.height,/^((?!chrome|android).)*safari/i.test(navigator.userAgent)||(w=b.offsetLeft,E=b.offsetTop)),{width:v,height:y,x:w+getWindowScrollBarX$2(l),y:E}}function getDocumentRect$2(l){var g,m=getDocumentElement$2(l),b=getWindowScroll$2(l),v=(g=l.ownerDocument)==null?void 0:g.body,y=max$2(m.scrollWidth,m.clientWidth,v?v.scrollWidth:0,v?v.clientWidth:0),w=max$2(m.scrollHeight,m.clientHeight,v?v.scrollHeight:0,v?v.clientHeight:0),E=-b.scrollLeft+getWindowScrollBarX$2(l),O=-b.scrollTop;return getComputedStyle$2(v||m).direction==="rtl"&&(E+=max$2(m.clientWidth,v?v.clientWidth:0)-y),{width:y,height:w,x:E,y:O}}function isScrollParent$2(l){var g=getComputedStyle$2(l),m=g.overflow,b=g.overflowX,v=g.overflowY;return/auto|scroll|overlay|hidden/.test(m+v+b)}function getScrollParent$2(l){return["html","body","#document"].indexOf(getNodeName$2(l))>=0?l.ownerDocument.body:isHTMLElement$2(l)&&isScrollParent$2(l)?l:getScrollParent$2(getParentNode$2(l))}function listScrollParents$2(l,g){var m;g===void 0&&(g=[]);var b=getScrollParent$2(l),v=b===((m=l.ownerDocument)==null?void 0:m.body),y=getWindow$2(b),w=v?[y].concat(y.visualViewport||[],isScrollParent$2(b)?b:[]):b,E=g.concat(w);return v?E:E.concat(listScrollParents$2(getParentNode$2(w)))}function rectToClientRect$2(l){return Object.assign({},l,{left:l.x,top:l.y,right:l.x+l.width,bottom:l.y+l.height})}function getInnerBoundingClientRect$2(l){var g=getBoundingClientRect$2(l);return g.top=g.top+l.clientTop,g.left=g.left+l.clientLeft,g.bottom=g.top+l.clientHeight,g.right=g.left+l.clientWidth,g.width=l.clientWidth,g.height=l.clientHeight,g.x=g.left,g.y=g.top,g}function getClientRectFromMixedType$2(l,g){return g===viewport$2?rectToClientRect$2(getViewportRect$2(l)):isElement$2(g)?getInnerBoundingClientRect$2(g):rectToClientRect$2(getDocumentRect$2(getDocumentElement$2(l)))}function getClippingParents$2(l){var g=listScrollParents$2(getParentNode$2(l)),m=["absolute","fixed"].indexOf(getComputedStyle$2(l).position)>=0,b=m&&isHTMLElement$2(l)?getOffsetParent$2(l):l;return isElement$2(b)?g.filter(function(v){return isElement$2(v)&&contains$2(v,b)&&getNodeName$2(v)!=="body"}):[]}function getClippingRect$2(l,g,m){var b=g==="clippingParents"?getClippingParents$2(l):[].concat(g),v=[].concat(b,[m]),y=v[0],w=v.reduce(function(E,O){var k=getClientRectFromMixedType$2(l,O);return E.top=max$2(k.top,E.top),E.right=min$2(k.right,E.right),E.bottom=min$2(k.bottom,E.bottom),E.left=max$2(k.left,E.left),E},getClientRectFromMixedType$2(l,y));return w.width=w.right-w.left,w.height=w.bottom-w.top,w.x=w.left,w.y=w.top,w}function computeOffsets$2(l){var g=l.reference,m=l.element,b=l.placement,v=b?getBasePlacement$2(b):null,y=b?getVariation$2(b):null,w=g.x+g.width/2-m.width/2,E=g.y+g.height/2-m.height/2,O;switch(v){case top$2:O={x:w,y:g.y-m.height};break;case bottom$2:O={x:w,y:g.y+g.height};break;case right$2:O={x:g.x+g.width,y:E};break;case left$2:O={x:g.x-m.width,y:E};break;default:O={x:g.x,y:g.y}}var k=v?getMainAxisFromPlacement$2(v):null;if(k!=null){var S=k==="y"?"height":"width";switch(y){case start$2:O[k]=O[k]-(g[S]/2-m[S]/2);break;case end$2:O[k]=O[k]+(g[S]/2-m[S]/2);break}}return O}function detectOverflow$2(l,g){g===void 0&&(g={});var m=g,b=m.placement,v=b===void 0?l.placement:b,y=m.boundary,w=y===void 0?clippingParents$2:y,E=m.rootBoundary,O=E===void 0?viewport$2:E,k=m.elementContext,S=k===void 0?popper$2:k,P=m.altBoundary,j=P===void 0?!1:P,C=m.padding,L=C===void 0?0:C,R=mergePaddingObject$2(typeof L!="number"?L:expandToHashMap$2(L,basePlacements$2)),A=S===popper$2?reference$2:popper$2,D=l.rects.popper,N=l.elements[j?A:S],F=getClippingRect$2(isElement$2(N)?N:N.contextElement||getDocumentElement$2(l.elements.popper),w,O),T=getBoundingClientRect$2(l.elements.reference),B=computeOffsets$2({reference:T,element:D,strategy:"absolute",placement:v}),z=rectToClientRect$2(Object.assign({},D,B)),M=S===popper$2?z:T,I={top:F.top-M.top+R.top,bottom:M.bottom-F.bottom+R.bottom,left:F.left-M.left+R.left,right:M.right-F.right+R.right},U=l.modifiersData.offset;if(S===popper$2&&U){var q=U[v];Object.keys(I).forEach(function(H){var Y=[right$2,bottom$2].indexOf(H)>=0?1:-1,X=[top$2,bottom$2].indexOf(H)>=0?"y":"x";I[H]+=q[X]*Y})}return I}function computeAutoPlacement$2(l,g){g===void 0&&(g={});var m=g,b=m.placement,v=m.boundary,y=m.rootBoundary,w=m.padding,E=m.flipVariations,O=m.allowedAutoPlacements,k=O===void 0?placements$2:O,S=getVariation$2(b),P=S?E?variationPlacements$2:variationPlacements$2.filter(function(L){return getVariation$2(L)===S}):basePlacements$2,j=P.filter(function(L){return k.indexOf(L)>=0});j.length===0&&(j=P);var C=j.reduce(function(L,R){return L[R]=detectOverflow$2(l,{placement:R,boundary:v,rootBoundary:y,padding:w})[getBasePlacement$2(R)],L},{});return Object.keys(C).sort(function(L,R){return C[L]-C[R]})}function getExpandedFallbackPlacements$2(l){if(getBasePlacement$2(l)===auto$2)return[];var g=getOppositePlacement$2(l);return[getOppositeVariationPlacement$2(l),g,getOppositeVariationPlacement$2(g)]}function flip$3(l){var g=l.state,m=l.options,b=l.name;if(!g.modifiersData[b]._skip){for(var v=m.mainAxis,y=v===void 0?!0:v,w=m.altAxis,E=w===void 0?!0:w,O=m.fallbackPlacements,k=m.padding,S=m.boundary,P=m.rootBoundary,j=m.altBoundary,C=m.flipVariations,L=C===void 0?!0:C,R=m.allowedAutoPlacements,A=g.options.placement,D=getBasePlacement$2(A),N=D===A,F=O||(N||!L?[getOppositePlacement$2(A)]:getExpandedFallbackPlacements$2(A)),T=[A].concat(F).reduce(function(te,Z){return te.concat(getBasePlacement$2(Z)===auto$2?computeAutoPlacement$2(g,{placement:Z,boundary:S,rootBoundary:P,padding:k,flipVariations:L,allowedAutoPlacements:R}):Z)},[]),B=g.rects.reference,z=g.rects.popper,M=new Map,I=!0,U=T[0],q=0;q<T.length;q++){var H=T[q],Y=getBasePlacement$2(H),X=getVariation$2(H)===start$2,ee=[top$2,bottom$2].indexOf(Y)>=0,oe=ee?"width":"height",K=detectOverflow$2(g,{placement:H,boundary:S,rootBoundary:P,altBoundary:j,padding:k}),J=ee?X?right$2:left$2:X?bottom$2:top$2;B[oe]>z[oe]&&(J=getOppositePlacement$2(J));var le=getOppositePlacement$2(J),re=[];if(y&&re.push(K[Y]<=0),E&&re.push(K[J]<=0,K[le]<=0),re.every(function(te){return te})){U=H,I=!1;break}M.set(H,re)}if(I)for(var ie=L?3:1,ae=function(Z){var se=T.find(function(fe){var Q=M.get(fe);if(Q)return Q.slice(0,Z).every(function(de){return de})});if(se)return U=se,"break"},ue=ie;ue>0;ue--){var pe=ae(ue);if(pe==="break")break}g.placement!==U&&(g.modifiersData[b]._skip=!0,g.placement=U,g.reset=!0)}}var flip$1$2={name:"flip",enabled:!0,phase:"main",fn:flip$3,requiresIfExists:["offset"],data:{_skip:!1}};function getSideOffsets$2(l,g,m){return m===void 0&&(m={x:0,y:0}),{top:l.top-g.height-m.y,right:l.right-g.width+m.x,bottom:l.bottom-g.height+m.y,left:l.left-g.width-m.x}}function isAnySideFullyClipped$2(l){return[top$2,right$2,bottom$2,left$2].some(function(g){return l[g]>=0})}function hide$3(l){var g=l.state,m=l.name,b=g.rects.reference,v=g.rects.popper,y=g.modifiersData.preventOverflow,w=detectOverflow$2(g,{elementContext:"reference"}),E=detectOverflow$2(g,{altBoundary:!0}),O=getSideOffsets$2(w,b),k=getSideOffsets$2(E,v,y),S=isAnySideFullyClipped$2(O),P=isAnySideFullyClipped$2(k);g.modifiersData[m]={referenceClippingOffsets:O,popperEscapeOffsets:k,isReferenceHidden:S,hasPopperEscaped:P},g.attributes.popper=Object.assign({},g.attributes.popper,{"data-popper-reference-hidden":S,"data-popper-escaped":P})}var hide$1$2={name:"hide",enabled:!0,phase:"main",requiresIfExists:["preventOverflow"],fn:hide$3};function distanceAndSkiddingToXY$2(l,g,m){var b=getBasePlacement$2(l),v=[left$2,top$2].indexOf(b)>=0?-1:1,y=typeof m=="function"?m(Object.assign({},g,{placement:l})):m,w=y[0],E=y[1];return w=w||0,E=(E||0)*v,[left$2,right$2].indexOf(b)>=0?{x:E,y:w}:{x:w,y:E}}function offset$3(l){var g=l.state,m=l.options,b=l.name,v=m.offset,y=v===void 0?[0,0]:v,w=placements$2.reduce(function(S,P){return S[P]=distanceAndSkiddingToXY$2(P,g.rects,y),S},{}),E=w[g.placement],O=E.x,k=E.y;g.modifiersData.popperOffsets!=null&&(g.modifiersData.popperOffsets.x+=O,g.modifiersData.popperOffsets.y+=k),g.modifiersData[b]=w}var offset$1$2={name:"offset",enabled:!0,phase:"main",requires:["popperOffsets"],fn:offset$3};function popperOffsets$3(l){var g=l.state,m=l.name;g.modifiersData[m]=computeOffsets$2({reference:g.rects.reference,element:g.rects.popper,strategy:"absolute",placement:g.placement})}var popperOffsets$1$2={name:"popperOffsets",enabled:!0,phase:"read",fn:popperOffsets$3,data:{}};function getAltAxis$2(l){return l==="x"?"y":"x"}function preventOverflow$3(l){var g=l.state,m=l.options,b=l.name,v=m.mainAxis,y=v===void 0?!0:v,w=m.altAxis,E=w===void 0?!1:w,O=m.boundary,k=m.rootBoundary,S=m.altBoundary,P=m.padding,j=m.tether,C=j===void 0?!0:j,L=m.tetherOffset,R=L===void 0?0:L,A=detectOverflow$2(g,{boundary:O,rootBoundary:k,padding:P,altBoundary:S}),D=getBasePlacement$2(g.placement),N=getVariation$2(g.placement),F=!N,T=getMainAxisFromPlacement$2(D),B=getAltAxis$2(T),z=g.modifiersData.popperOffsets,M=g.rects.reference,I=g.rects.popper,U=typeof R=="function"?R(Object.assign({},g.rects,{placement:g.placement})):R,q=typeof U=="number"?{mainAxis:U,altAxis:U}:Object.assign({mainAxis:0,altAxis:0},U),H=g.modifiersData.offset?g.modifiersData.offset[g.placement]:null,Y={x:0,y:0};if(!!z){if(y){var X,ee=T==="y"?top$2:left$2,oe=T==="y"?bottom$2:right$2,K=T==="y"?"height":"width",J=z[T],le=J+A[ee],re=J-A[oe],ie=C?-I[K]/2:0,ae=N===start$2?M[K]:I[K],ue=N===start$2?-I[K]:-M[K],pe=g.elements.arrow,te=C&&pe?getLayoutRect$2(pe):{width:0,height:0},Z=g.modifiersData["arrow#persistent"]?g.modifiersData["arrow#persistent"].padding:getFreshSideObject$2(),se=Z[ee],fe=Z[oe],Q=within$2(0,M[K],te[K]),de=F?M[K]/2-ie-Q-se-q.mainAxis:ae-Q-se-q.mainAxis,W=F?-M[K]/2+ie+Q+fe+q.mainAxis:ue+Q+fe+q.mainAxis,V=g.elements.arrow&&getOffsetParent$2(g.elements.arrow),G=V?T==="y"?V.clientTop||0:V.clientLeft||0:0,ne=(X=H==null?void 0:H[T])!=null?X:0,he=J+de-ne-G,ce=J+W-ne,ge=within$2(C?min$2(le,he):le,J,C?max$2(re,ce):re);z[T]=ge,Y[T]=ge-J}if(E){var be,ye=T==="x"?top$2:left$2,xe=T==="x"?bottom$2:right$2,me=z[B],ve=B==="y"?"height":"width",we=me+A[ye],$e=me-A[xe],_e=[top$2,left$2].indexOf(D)!==-1,Ee=(be=H==null?void 0:H[B])!=null?be:0,Oe=_e?we:me-M[ve]-I[ve]-Ee+q.altAxis,ke=_e?me+M[ve]+I[ve]-Ee-q.altAxis:$e,Se=C&&_e?withinMaxClamp$1(Oe,me,ke):within$2(C?Oe:we,me,C?ke:$e);z[B]=Se,Y[B]=Se-me}g.modifiersData[b]=Y}}var preventOverflow$1$2={name:"preventOverflow",enabled:!0,phase:"main",fn:preventOverflow$3,requiresIfExists:["offset"]};function getHTMLElementScroll$2(l){return{scrollLeft:l.scrollLeft,scrollTop:l.scrollTop}}function getNodeScroll$2(l){return l===getWindow$2(l)||!isHTMLElement$2(l)?getWindowScroll$2(l):getHTMLElementScroll$2(l)}function isElementScaled$1(l){var g=l.getBoundingClientRect(),m=round$2(g.width)/l.offsetWidth||1,b=round$2(g.height)/l.offsetHeight||1;return m!==1||b!==1}function getCompositeRect$2(l,g,m){m===void 0&&(m=!1);var b=isHTMLElement$2(g),v=isHTMLElement$2(g)&&isElementScaled$1(g),y=getDocumentElement$2(g),w=getBoundingClientRect$2(l,v),E={scrollLeft:0,scrollTop:0},O={x:0,y:0};return(b||!b&&!m)&&((getNodeName$2(g)!=="body"||isScrollParent$2(y))&&(E=getNodeScroll$2(g)),isHTMLElement$2(g)?(O=getBoundingClientRect$2(g,!0),O.x+=g.clientLeft,O.y+=g.clientTop):y&&(O.x=getWindowScrollBarX$2(y))),{x:w.left+E.scrollLeft-O.x,y:w.top+E.scrollTop-O.y,width:w.width,height:w.height}}function order$2(l){var g=new Map,m=new Set,b=[];l.forEach(function(y){g.set(y.name,y)});function v(y){m.add(y.name);var w=[].concat(y.requires||[],y.requiresIfExists||[]);w.forEach(function(E){if(!m.has(E)){var O=g.get(E);O&&v(O)}}),b.push(y)}return l.forEach(function(y){m.has(y.name)||v(y)}),b}function orderModifiers$2(l){var g=order$2(l);return modifierPhases$2.reduce(function(m,b){return m.concat(g.filter(function(v){return v.phase===b}))},[])}function debounce$2(l){var g;return function(){return g||(g=new Promise(function(m){Promise.resolve().then(function(){g=void 0,m(l())})})),g}}function mergeByName$2(l){var g=l.reduce(function(m,b){var v=m[b.name];return m[b.name]=v?Object.assign({},v,b,{options:Object.assign({},v.options,b.options),data:Object.assign({},v.data,b.data)}):b,m},{});return Object.keys(g).map(function(m){return g[m]})}var DEFAULT_OPTIONS$2={placement:"bottom",modifiers:[],strategy:"absolute"};function areValidElements$2(){for(var l=arguments.length,g=new Array(l),m=0;m<l;m++)g[m]=arguments[m];return!g.some(function(b){return!(b&&typeof b.getBoundingClientRect=="function")})}function popperGenerator$2(l){l===void 0&&(l={});var g=l,m=g.defaultModifiers,b=m===void 0?[]:m,v=g.defaultOptions,y=v===void 0?DEFAULT_OPTIONS$2:v;return function(E,O,k){k===void 0&&(k=y);var S={placement:"bottom",orderedModifiers:[],options:Object.assign({},DEFAULT_OPTIONS$2,y),modifiersData:{},elements:{reference:E,popper:O},attributes:{},styles:{}},P=[],j=!1,C={state:S,setOptions:function(D){var N=typeof D=="function"?D(S.options):D;R(),S.options=Object.assign({},y,S.options,N),S.scrollParents={reference:isElement$2(E)?listScrollParents$2(E):E.contextElement?listScrollParents$2(E.contextElement):[],popper:listScrollParents$2(O)};var F=orderModifiers$2(mergeByName$2([].concat(b,S.options.modifiers)));return S.orderedModifiers=F.filter(function(T){return T.enabled}),L(),C.update()},forceUpdate:function(){if(!j){var D=S.elements,N=D.reference,F=D.popper;if(!!areValidElements$2(N,F)){S.rects={reference:getCompositeRect$2(N,getOffsetParent$2(F),S.options.strategy==="fixed"),popper:getLayoutRect$2(F)},S.reset=!1,S.placement=S.options.placement,S.orderedModifiers.forEach(function(q){return S.modifiersData[q.name]=Object.assign({},q.data)});for(var T=0;T<S.orderedModifiers.length;T++){if(S.reset===!0){S.reset=!1,T=-1;continue}var B=S.orderedModifiers[T],z=B.fn,M=B.options,I=M===void 0?{}:M,U=B.name;typeof z=="function"&&(S=z({state:S,options:I,name:U,instance:C})||S)}}}},update:debounce$2(function(){return new Promise(function(A){C.forceUpdate(),A(S)})}),destroy:function(){R(),j=!0}};if(!areValidElements$2(E,O))return C;C.setOptions(k).then(function(A){!j&&k.onFirstUpdate&&k.onFirstUpdate(A)});function L(){S.orderedModifiers.forEach(function(A){var D=A.name,N=A.options,F=N===void 0?{}:N,T=A.effect;if(typeof T=="function"){var B=T({state:S,name:D,instance:C,options:F}),z=function(){};P.push(B||z)}})}function R(){P.forEach(function(A){return A()}),P=[]}return C}}var defaultModifiers$2=[eventListeners$2,popperOffsets$1$2,computeStyles$1$2,applyStyles$1$2,offset$1$2,flip$1$2,preventOverflow$1$2,arrow$1$2,hide$1$2],createPopper$2=popperGenerator$2({defaultModifiers:defaultModifiers$2});const readyCallbacks$2=[];document.addEventListener("DOMContentLoaded",()=>{domReady$2.done=!0,readyCallbacks$2.forEach(l=>{l()})});function domReady$2(l){if(domReady$2.done){l();return}readyCallbacks$2.push(l)}domReady$2.done=!1;var __defProp$1$2=Object.defineProperty,__getOwnPropDesc$1$2=Object.getOwnPropertyDescriptor,__decorateClass$1$2=(l,g,m,b)=>{for(var v=b>1?void 0:b?__getOwnPropDesc$1$2(g,m):g,y=l.length-1,w;y>=0;y--)(w=l[y])&&(v=(b?w(g,m,v):w(v))||v);return b&&v&&__defProp$1$2(g,m,v),v};let Transition$1=class extends WeElement{constructor(){super(...arguments),this._show=!0}installed(){domReady$2(()=>{this.props.appear&&this.enter(),this.props.leavingTime&&setTimeout(()=>{this.leave()},this.props.leavingTime)})}receiveProps(){this.props.appear&&this.enter(),this.props.disappear&&this.leave()}async toggle(){return this._show=!this._show,this._show?await this.enter():await this.leave()}async enter(){return new Promise(l=>{const g=this.children[0];g&&(this.fire("before-enter"),g.classList.remove(this.props.name+"-leave-active"),g.classList.remove(this.props.name+"-leave-to"),g.classList.add(this.props.name+"-enter-from"),g.classList.add(this.props.name+"-enter-active"),this.callback=function(){g.classList.remove(this.props.name+"-enter-active"),this.fire("after-enter"),this._show=!0,l()}.bind(this),this.once("transitionend",this.callback),this.once("animationend",this.callback),window.setTimeout(function(){g.classList.remove(this.props.name+"-enter-from"),g.classList.add(this.props.name+"-enter-to"),this.fire("enter")}.bind(this),this.props.delay))})}async leave(){return new Promise(l=>{const g=this.children[0];g&&(this.fire("before-leave"),g.classList.remove(this.props.name+"-enter-active"),g.classList.remove(this.props.name+"-enter-to"),g.classList.add(this.props.name+"-leave-from"),g.classList.add(this.props.name+"-leave-active"),this.callback=function(m){g.classList.remove(this.props.name+"-leave-active"),this.fire("after-leave"),this._show=!1,this.props.autoRemove&&this.parentNode&&this.parentNode.removeChild(this),l()}.bind(this),this.once("transitionend",this.callback),this.once("animationend",this.callback),window.setTimeout(function(){g.classList.remove(this.props.name+"-leave-from"),g.classList.add(this.props.name+"-leave-to"),this.fire("leave")}.bind(this),this.props.delay))})}once(l,g){const m=function(){this.removeEventListener(l,m),g()}.bind(this);this.addEventListener(l,m)}render(){}};Transition$1.propTypes={name:String,leavingTime:Number,autoRemove:Boolean,appear:Boolean,disappear:Boolean,delay:Number};Transition$1.isLightDom=!0;Transition$1.defaultProps={name:"o",delay:0};Transition$1=__decorateClass$1$2([tag("o-transition")],Transition$1);var index$4=`:host{display:inline-block}:host([block]){display:block}.tip{position:absolute;background:#fff;min-width:150px;border-radius:4px;border:1px solid #ebeef5;z-index:2000;color:#606266;line-height:1.4;text-align:justify;font-size:14px;word-break:break-all;box-shadow:0 2px 12px #0000001a;width:100%}.tip .tip-arrow,.tip .tip-arrow:after{position:absolute;display:block;width:0;height:0;border-color:transparent;border-style:solid}.tip .tip-arrow{border-width:6px}.tip .tip-arrow:after{content:" ";border-width:5px}.tip[data-popper-placement^=top]{margin-bottom:12px}.tip[data-popper-placement^=top] .tip-arrow{bottom:-6px;border-top-color:#ebeef5;border-bottom-width:0}.tip[data-popper-placement^=top] .tip-arrow:after{bottom:1px;margin-left:-5px;border-top-color:#ebeef5;border-bottom-width:0}.tip[data-popper-placement^=bottom]{margin-top:12px}.tip[data-popper-placement^=bottom] .tip-arrow{top:-6px;border-top-width:0;border-bottom-color:#ebeef5}.tip[data-popper-placement^=bottom] .tip-arrow:after{top:1px;margin-left:-5px;border-top-width:0;border-bottom-color:#ebeef5}.tip[data-popper-placement^=right]{margin-left:12px}.tip[data-popper-placement^=right] .tip-arrow{left:-6px;border-right-color:#ebeef5;border-left-width:0}.tip[data-popper-placement^=right] .tip-arrow:after{bottom:-5px;left:1px;border-right-color:#ebeef5;border-left-width:0}.tip[data-popper-placement^=left]{margin-right:12px}.tip[data-popper-placement^=left] .tip-arrow{right:-6px;border-right-width:0;border-left-color:#ebeef5}.tip[data-popper-placement^=left] .tip-arrow:after{right:1px;bottom:-5px;margin-left:-5px;border-right-width:0;border-left-color:#ebeef5}.tip.is-dark{background:#ebeef5;color:#fff}.tip.is-light{background:#FFF}.tip.is-light[data-popper-placement^=top] .tip-arrow{border-top-color:#ebeef5}.tip.is-light[data-popper-placement^=top] .tip-arrow:after{border-top-color:#fff}.tip.is-light[data-popper-placement^=bottom] .tip-arrow{border-bottom-color:#ebeef5}.tip.is-light[data-popper-placement^=bottom] .tip-arrow:after{border-bottom-color:#fff}.tip.is-light[data-popper-placement^=left] .tip-arrow{border-left-color:#ebeef5}.tip.is-light[data-popper-placement^=left] .tip-arrow:after{border-left-color:#fff}.tip.is-light[data-popper-placement^=right] .tip-arrow{border-right-color:#ebeef5}.tip.is-light[data-popper-placement^=right] .tip-arrow:after{border-right-color:#fff}.fade-enter-from,.fade-leave-to{opacity:0;padding-top:10px;pointer-events:none}.fade-enter-active,.fade-leave-active{-webkit-transition:opacity .3s cubic-bezier(.55,0,.1,1),padding-top .3s cubic-bezier(.55,0,.1,1);transition:opacity .3s cubic-bezier(.55,0,.1,1),padding-top .3s cubic-bezier(.55,0,.1,1)}
`,css$7=Object.freeze(Object.defineProperty({__proto__:null,default:index$4},Symbol.toStringTag,{value:"Module"})),__defProp$9=Object.defineProperty,__getOwnPropDesc$9=Object.getOwnPropertyDescriptor,__decorateClass$9=(l,g,m,b)=>{for(var v=b>1?void 0:b?__getOwnPropDesc$9(g,m):g,y=l.length-1,w;y>=0;y--)(w=l[y])&&(v=(b?w(g,m,v):w(v))||v);return b&&v&&__defProp$9(g,m,v),v};let Popover$1=class extends WeElement{constructor(){super(...arguments),this.onEnter=l=>{clearTimeout(this.timeout),this.isShow=!this.isShow,this.isShow?(this.appear=!0,this.disappear=!1):(this.appear=!1,this.disappear=!0),this.update();const g=this.shadowRoot.querySelector("slot").assignedNodes().find(m=>m.nodeType!==3);this.popper&&this.popper.destroy(),this.popper=createPopper$2(g,this.shadowRoot.querySelector(".tip"),{placement:this.props.position,modifiers:[{name:"offset",options:{offset:[0,8]}},{name:"computeStyles",options:{adaptive:!1}}]}),l.stopPropagation()},this.onLeave=()=>{this.timeout=setTimeout(()=>{this.leave(),this.update()},600)},this.onEnterPopover=l=>{clearTimeout(this.timeout),l.stopPropagation()},this.onLeavePopover=()=>{this.props.trigger==="hover"&&(this.timeout=setTimeout(()=>{this.leave(),this.update()},600))},this.isShow=!1}installed(){window.addEventListener("click",()=>{this.props.trigger!=="manual"&&this.isShow&&(this.leave(),this.update())}),this._onDocumentMouseDown=this.onDocumentMouseDown.bind(this),document.addEventListener("mousedown",this._onDocumentMouseDown)}onDocumentMouseDown(l){let g=!1;const m=l.path||event.composedPath&&event.composedPath();for(let b=0,v=m.length;b<v;b++)if(m[b]===this.rootNode){g=!0;break}g||(this.isShow=!1),this.update()}updatePosition(){this.popper.update()}leave(){this.appear=!1,this.disappear=!0,setTimeout(()=>{this.isShow=!1},600)}render(l){const g={onMouseEnter:null,onMouseLeave:null,onClick:null};return l.trigger==="click"?g.onClick=this.onEnter:l.trigger==="hover"&&(g.onMouseEnter=this.onEnter,g.onMouseLeave=this.onLeave),h$1("div",{style:"position:relative"},h$1("slot",{...g}),h$1("o-transition",{appear:this.appear,disappear:this.disappear,name:"fade"},h$1("div",{style:{display:this.isShow?"block":"none"},class:classNames({tip:!0,[`is-${l.effect}`]:l.effect})},h$1("slot",{onMouseEnter:this.onEnterPopover,onMouseLeave:this.onLeavePopover,name:"popover"}),h$1("i",{class:"tip-arrow","data-popper-arrow":!0}))))}};Popover$1.css=css$7;Popover$1.defaultProps={effect:"light",position:"bottom",trigger:"click",block:!1};Popover$1.propTypes={content:String,effect:String,position:String,trigger:String,block:Boolean};Popover$1=__decorateClass$9([tag("o-popover")],Popover$1);var commonjsGlobal=typeof globalThis!="undefined"?globalThis:typeof window!="undefined"?window:typeof global!="undefined"?global:typeof self!="undefined"?self:{};function getDefaultExportFromCjs(l){return l&&l.__esModule&&Object.prototype.hasOwnProperty.call(l,"default")?l.default:l}function getAugmentedNamespace(l){if(l.__esModule)return l;var g=Object.defineProperty({},"__esModule",{value:!0});return Object.keys(l).forEach(function(m){var b=Object.getOwnPropertyDescriptor(l,m);Object.defineProperty(g,m,b.get?b:{enumerable:!0,get:function(){return l[m]}})}),g}function commonjsRequire(l){throw new Error('Could not dynamically require "'+l+'". Please configure the dynamicRequireTargets or/and ignoreDynamicRequires option of @rollup/plugin-commonjs appropriately for this require call to work.')}var _delete={exports:{}},require$$0=getAugmentedNamespace(omi_esm);(function(module,exports){(function(g,m){module.exports=m(require$$0)})(commonjsGlobal,function(__WEBPACK_EXTERNAL_MODULE_omi__){return function(l){var g={};function m(b){if(g[b])return g[b].exports;var v=g[b]={i:b,l:!1,exports:{}};return l[b].call(v.exports,v,v.exports,m),v.l=!0,v.exports}return m.m=l,m.c=g,m.d=function(b,v,y){m.o(b,v)||Object.defineProperty(b,v,{enumerable:!0,get:y})},m.r=function(b){typeof Symbol!="undefined"&&Symbol.toStringTag&&Object.defineProperty(b,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(b,"__esModule",{value:!0})},m.t=function(b,v){if(v&1&&(b=m(b)),v&8||v&4&&typeof b=="object"&&b&&b.__esModule)return b;var y=Object.create(null);if(m.r(y),Object.defineProperty(y,"default",{enumerable:!0,value:b}),v&2&&typeof b!="string")for(var w in b)m.d(y,w,function(E){return b[E]}.bind(null,w));return y},m.n=function(b){var v=b&&b.__esModule?function(){return b.default}:function(){return b};return m.d(v,"a",v),v},m.o=function(b,v){return Object.prototype.hasOwnProperty.call(b,v)},m.p="",m(m.s="./esm/delete.js")}({"./esm/delete.js":function(module,exports,__webpack_require__){eval(`
...
***************************************************************************** */var extendStatics=function(l,g){return extendStatics=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(m,b){m.__proto__=b}||function(m,b){for(var v in b)Object.prototype.hasOwnProperty.call(b,v)&&(m[v]=b[v])},extendStatics(l,g)};function __extends(l,g){if(typeof g!="function"&&g!==null)throw new TypeError("Class extends value "+String(g)+" is not a constructor or null");extendStatics(l,g);function m(){this.constructor=l}l.prototype=g===null?Object.create(g):(m.prototype=g.prototype,new m)}function __decorate(l,g,m,b){var v=arguments.length,y=v<3?g:b===null?b=Object.getOwnPropertyDescriptor(g,m):b,w;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")y=Reflect.decorate(l,g,m,b);else for(var E=l.length-1;E>=0;E--)(w=l[E])&&(y=(v<3?w(y):v>3?w(g,m,y):w(g,m))||y);return v>3&&y&&Object.defineProperty(g,m,y),y}var top="top",bottom="bottom",right="right",left="left",auto="auto",basePlacements=[top,bottom,right,left],start="start",end="end",clippingParents="clippingParents",viewport="viewport",popper="popper",reference="reference",variationPlacements=basePlacements.reduce(function(l,g){return l.concat([g+"-"+start,g+"-"+end])},[]),placements=[].concat(basePlacements,[auto]).reduce(function(l,g){return l.concat([g,g+"-"+start,g+"-"+end])},[]),beforeRead="beforeRead",read="read",afterRead="afterRead",beforeMain="beforeMain",main="main",afterMain="afterMain",beforeWrite="beforeWrite",write="write",afterWrite="afterWrite",modifierPhases=[beforeRead,read,afterRead,beforeMain,main,afterMain,beforeWrite,write,afterWrite];function getNodeName(l){return l?(l.nodeName||"").toLowerCase():null}function getWindow(l){if(l==null)return window;if(l.toString()!=="[object Window]"){var g=l.ownerDocument;return g&&g.defaultView||window}return l}function isElement(l){var g=getWindow(l).Element;return l instanceof g||l instanceof Element}function isHTMLElement(l){var g=getWindow(l).HTMLElement;return l instanceof g||l instanceof HTMLElement}function isShadowRoot(l){if(typeof ShadowRoot=="undefined")return!1;var g=getWindow(l).ShadowRoot;return l instanceof g||l instanceof ShadowRoot}function applyStyles(l){var g=l.state;Object.keys(g.elements).forEach(function(m){var b=g.styles[m]||{},v=g.attributes[m]||{},y=g.elements[m];!isHTMLElement(y)||!getNodeName(y)||(Object.assign(y.style,b),Object.keys(v).forEach(function(w){var E=v[w];E===!1?y.removeAttribute(w):y.setAttribute(w,E===!0?"":E)}))})}function effect$2(l){var g=l.state,m={popper:{position:g.options.strategy,left:"0",top:"0",margin:"0"},arrow:{position:"absolute"},reference:{}};return Object.assign(g.elements.popper.style,m.popper),g.styles=m,g.elements.arrow&&Object.assign(g.elements.arrow.style,m.arrow),function(){Object.keys(g.elements).forEach(function(b){var v=g.elements[b],y=g.attributes[b]||{},w=Object.keys(g.styles.hasOwnProperty(b)?g.styles[b]:m[b]),E=w.reduce(function(O,k){return O[k]="",O},{});!isHTMLElement(v)||!getNodeName(v)||(Object.assign(v.style,E),Object.keys(y).forEach(function(O){v.removeAttribute(O)}))})}}var applyStyles$1={name:"applyStyles",enabled:!0,phase:"write",fn:applyStyles,effect:effect$2,requires:["computeStyles"]};function getBasePlacement(l){return l.split("-")[0]}function getBoundingClientRect(l){var g=l.getBoundingClientRect();return{width:g.width,height:g.height,top:g.top,right:g.right,bottom:g.bottom,left:g.left,x:g.left,y:g.top}}function getLayoutRect(l){var g=getBoundingClientRect(l),m=l.offsetWidth,b=l.offsetHeight;return Math.abs(g.width-m)<=1&&(m=g.width),Math.abs(g.height-b)<=1&&(b=g.height),{x:l.offsetLeft,y:l.offsetTop,width:m,height:b}}function contains(l,g){var m=g.getRootNode&&g.getRootNode();if(l.contains(g))return!0;if(m&&isShadowRoot(m)){var b=g;do{if(b&&l.isSameNode(b))return!0;b=b.parentNode||b.host}while(b)}return!1}function getComputedStyle(l){return getWindow(l).getComputedStyle(l)}function isTableElement(l){return["table","td","th"].indexOf(getNodeName(l))>=0}function getDocumentElement(l){return((isElement(l)?l.ownerDocument:l.document)||window.document).documentElement}function getParentNode(l){return getNodeName(l)==="html"?l:l.assignedSlot||l.parentNode||(isShadowRoot(l)?l.host:null)||getDocumentElement(l)}function getTrueOffsetParent(l){return!isHTMLElement(l)||getComputedStyle(l).position==="fixed"?null:l.offsetParent}function getContainingBlock(l){var g=navigator.userAgent.toLowerCase().indexOf("firefox")!==-1,m=navigator.userAgent.indexOf("Trident")!==-1;if(m&&isHTMLElement(l)){var b=getComputedStyle(l);if(b.position==="fixed")return null}for(var v=getParentNode(l);isHTMLElement(v)&&["html","body"].indexOf(getNodeName(v))<0;){var y=getComputedStyle(v);if(y.transform!=="none"||y.perspective!=="none"||y.contain==="paint"||["transform","perspective"].indexOf(y.willChange)!==-1||g&&y.willChange==="filter"||g&&y.filter&&y.filter!=="none")return v;v=v.parentNode}return null}function getOffsetParent(l){for(var g=getWindow(l),m=getTrueOffsetParent(l);m&&isTableElement(m)&&getComputedStyle(m).position==="static";)m=getTrueOffsetParent(m);return m&&(getNodeName(m)==="html"||getNodeName(m)==="body"&&getComputedStyle(m).position==="static")?g:m||getContainingBlock(l)||g}function getMainAxisFromPlacement(l){return["top","bottom"].indexOf(l)>=0?"x":"y"}var max=Math.max,min=Math.min,round=Math.round;function within(l,g,m){return max(l,min(g,m))}function getFreshSideObject(){return{top:0,right:0,bottom:0,left:0}}function mergePaddingObject(l){return Object.assign({},getFreshSideObject(),l)}function expandToHashMap(l,g){return g.reduce(function(m,b){return m[b]=l,m},{})}var toPaddingObject=function l(g,m){return g=typeof g=="function"?g(Object.assign({},m.rects,{placement:m.placement})):g,mergePaddingObject(typeof g!="number"?g:expandToHashMap(g,basePlacements))};function arrow(l){var g,m=l.state,b=l.name,v=l.options,y=m.elements.arrow,w=m.modifiersData.popperOffsets,E=getBasePlacement(m.placement),O=getMainAxisFromPlacement(E),k=[left,right].indexOf(E)>=0,S=k?"height":"width";if(!(!y||!w)){var P=toPaddingObject(v.padding,m),j=getLayoutRect(y),C=O==="y"?top:left,L=O==="y"?bottom:right,R=m.rects.reference[S]+m.rects.reference[O]-w[O]-m.rects.popper[S],A=w[O]-m.rects.reference[O],D=getOffsetParent(y),N=D?O==="y"?D.clientHeight||0:D.clientWidth||0:0,F=R/2-A/2,T=P[C],B=N-j[S]-P[L],z=N/2-j[S]/2+F,M=within(T,z,B),I=O;m.modifiersData[b]=(g={},g[I]=M,g.centerOffset=M-z,g)}}function effect$1(l){var g=l.state,m=l.options,b=m.element,v=b===void 0?"[data-popper-arrow]":b;v!=null&&(typeof v=="string"&&(v=g.elements.popper.querySelector(v),!v)||!contains(g.elements.popper,v)||(g.elements.arrow=v))}var arrow$1={name:"arrow",enabled:!0,phase:"main",fn:arrow,effect:effect$1,requires:["popperOffsets"],requiresIfExists:["preventOverflow"]},unsetSides={top:"auto",right:"auto",bottom:"auto",left:"auto"};function roundOffsetsByDPR(l){var g=l.x,m=l.y,b=window,v=b.devicePixelRatio||1;return{x:round(round(g*v)/v)||0,y:round(round(m*v)/v)||0}}function mapToStyles(l){var g,m=l.popper,b=l.popperRect,v=l.placement,y=l.offsets,w=l.position,E=l.gpuAcceleration,O=l.adaptive,k=l.roundOffsets,S=k===!0?roundOffsetsByDPR(y):typeof k=="function"?k(y):y,P=S.x,j=P===void 0?0:P,C=S.y,L=C===void 0?0:C,R=y.hasOwnProperty("x"),A=y.hasOwnProperty("y"),D=left,N=top,F=window;if(O){var T=getOffsetParent(m),B="clientHeight",z="clientWidth";T===getWindow(m)&&(T=getDocumentElement(m),getComputedStyle(T).position!=="static"&&(B="scrollHeight",z="scrollWidth")),T=T,v===top&&(N=bottom,L-=T[B]-b.height,L*=E?1:-1),v===left&&(D=right,j-=T[z]-b.width,j*=E?1:-1)}var M=Object.assign({position:w},O&&unsetSides);if(E){var I;return Object.assign({},M,(I={},I[N]=A?"0":"",I[D]=R?"0":"",I.transform=(F.devicePixelRatio||1)<2?"translate("+j+"px, "+L+"px)":"translate3d("+j+"px, "+L+"px, 0)",I))}return Object.assign({},M,(g={},g[N]=A?L+"px":"",g[D]=R?j+"px":"",g.transform="",g))}function computeStyles(l){var g=l.state,m=l.options,b=m.gpuAcceleration,v=b===void 0?!0:b,y=m.adaptive,w=y===void 0?!0:y,E=m.roundOffsets,O=E===void 0?!0:E,k={placement:getBasePlacement(g.placement),popper:g.elements.popper,popperRect:g.rects.popper,gpuAcceleration:v};g.modifiersData.popperOffsets!=null&&(g.styles.popper=Object.assign({},g.styles.popper,mapToStyles(Object.assign({},k,{offsets:g.modifiersData.popperOffsets,position:g.options.strategy,adaptive:w,roundOffsets:O})))),g.modifiersData.arrow!=null&&(g.styles.arrow=Object.assign({},g.styles.arrow,mapToStyles(Object.assign({},k,{offsets:g.modifiersData.arrow,position:"absolute",adaptive:!1,roundOffsets:O})))),g.attributes.popper=Object.assign({},g.attributes.popper,{"data-popper-placement":g.placement})}var computeStyles$1={name:"computeStyles",enabled:!0,phase:"beforeWrite",fn:computeStyles,data:{}},passive={passive:!0};function effect(l){var g=l.state,m=l.instance,b=l.options,v=b.scroll,y=v===void 0?!0:v,w=b.resize,E=w===void 0?!0:w,O=getWindow(g.elements.popper),k=[].concat(g.scrollParents.reference,g.scrollParents.popper);return y&&k.forEach(function(S){S.addEventListener("scroll",m.update,passive)}),E&&O.addEventListener("resize",m.update,passive),function(){y&&k.forEach(function(S){S.removeEventListener("scroll",m.update,passive)}),E&&O.removeEventListener("resize",m.update,passive)}}var eventListeners={name:"eventListeners",enabled:!0,phase:"write",fn:function l(){},effect,data:{}},hash$1={left:"right",right:"left",bottom:"top",top:"bottom"};function getOppositePlacement(l){return l.replace(/left|right|bottom|top/g,function(g){return hash$1[g]})}var hash={start:"end",end:"start"};function getOppositeVariationPlacement(l){return l.replace(/start|end/g,function(g){return hash[g]})}function getWindowScroll(l){var g=getWindow(l),m=g.pageXOffset,b=g.pageYOffset;return{scrollLeft:m,scrollTop:b}}function getWindowScrollBarX(l){return getBoundingClientRect(getDocumentElement(l)).left+getWindowScroll(l).scrollLeft}function getViewportRect(l){var g=getWindow(l),m=getDocumentElement(l),b=g.visualViewport,v=m.clientWidth,y=m.clientHeight,w=0,E=0;return b&&(v=b.width,y=b.height,/^((?!chrome|android).)*safari/i.test(navigator.userAgent)||(w=b.offsetLeft,E=b.offsetTop)),{width:v,height:y,x:w+getWindowScrollBarX(l),y:E}}function getDocumentRect(l){var g,m=getDocumentElement(l),b=getWindowScroll(l),v=(g=l.ownerDocument)==null?void 0:g.body,y=max(m.scrollWidth,m.clientWidth,v?v.scrollWidth:0,v?v.clientWidth:0),w=max(m.scrollHeight,m.clientHeight,v?v.scrollHeight:0,v?v.clientHeight:0),E=-b.scrollLeft+getWindowScrollBarX(l),O=-b.scrollTop;return getComputedStyle(v||m).direction==="rtl"&&(E+=max(m.clientWidth,v?v.clientWidth:0)-y),{width:y,height:w,x:E,y:O}}function isScrollParent(l){var g=getComputedStyle(l),m=g.overflow,b=g.overflowX,v=g.overflowY;return/auto|scroll|overlay|hidden/.test(m+v+b)}function getScrollParent(l){return["html","body","#document"].indexOf(getNodeName(l))>=0?l.ownerDocument.body:isHTMLElement(l)&&isScrollParent(l)?l:getScrollParent(getParentNode(l))}function listScrollParents(l,g){var m;g===void 0&&(g=[]);var b=getScrollParent(l),v=b===((m=l.ownerDocument)==null?void 0:m.body),y=getWindow(b),w=v?[y].concat(y.visualViewport||[],isScrollParent(b)?b:[]):b,E=g.concat(w);return v?E:E.concat(listScrollParents(getParentNode(w)))}function rectToClientRect(l){return Object.assign({},l,{left:l.x,top:l.y,right:l.x+l.width,bottom:l.y+l.height})}function getInnerBoundingClientRect(l){var g=getBoundingClientRect(l);return g.top=g.top+l.clientTop,g.left=g.left+l.clientLeft,g.bottom=g.top+l.clientHeight,g.right=g.left+l.clientWidth,g.width=l.clientWidth,g.height=l.clientHeight,g.x=g.left,g.y=g.top,g}function getClientRectFromMixedType(l,g){return g===viewport?rectToClientRect(getViewportRect(l)):isHTMLElement(g)?getInnerBoundingClientRect(g):rectToClientRect(getDocumentRect(getDocumentElement(l)))}function getClippingParents(l){var g=listScrollParents(getParentNode(l)),m=["absolute","fixed"].indexOf(getComputedStyle(l).position)>=0,b=m&&isHTMLElement(l)?getOffsetParent(l):l;return isElement(b)?g.filter(function(v){return isElement(v)&&contains(v,b)&&getNodeName(v)!=="body"}):[]}function getClippingRect(l,g,m){var b=g==="clippingParents"?getClippingParents(l):[].concat(g),v=[].concat(b,[m]),y=v[0],w=v.reduce(function(E,O){var k=getClientRectFromMixedType(l,O);return E.top=max(k.top,E.top),E.right=min(k.right,E.right),E.bottom=min(k.bottom,E.bottom),E.left=max(k.left,E.left),E},getClientRectFromMixedType(l,y));return w.width=w.right-w.left,w.height=w.bottom-w.top,w.x=w.left,w.y=w.top,w}function getVariation(l){return l.split("-")[1]}function computeOffsets(l){var g=l.reference,m=l.element,b=l.placement,v=b?getBasePlacement(b):null,y=b?getVariation(b):null,w=g.x+g.width/2-m.width/2,E=g.y+g.height/2-m.height/2,O;switch(v){case top:O={x:w,y:g.y-m.height};break;case bottom:O={x:w,y:g.y+g.height};break;case right:O={x:g.x+g.width,y:E};break;case left:O={x:g.x-m.width,y:E};break;default:O={x:g.x,y:g.y}}var k=v?getMainAxisFromPlacement(v):null;if(k!=null){var S=k==="y"?"height":"width";switch(y){case start:O[k]=O[k]-(g[S]/2-m[S]/2);break;case end:O[k]=O[k]+(g[S]/2-m[S]/2);break}}return O}function detectOverflow(l,g){g===void 0&&(g={});var m=g,b=m.placement,v=b===void 0?l.placement:b,y=m.boundary,w=y===void 0?clippingParents:y,E=m.rootBoundary,O=E===void 0?viewport:E,k=m.elementContext,S=k===void 0?popper:k,P=m.altBoundary,j=P===void 0?!1:P,C=m.padding,L=C===void 0?0:C,R=mergePaddingObject(typeof L!="number"?L:expandToHashMap(L,basePlacements)),A=S===popper?reference:popper,D=l.elements.reference,N=l.rects.popper,F=l.elements[j?A:S],T=getClippingRect(isElement(F)?F:F.contextElement||getDocumentElement(l.elements.popper),w,O),B=getBoundingClientRect(D),z=computeOffsets({reference:B,element:N,strategy:"absolute",placement:v}),M=rectToClientRect(Object.assign({},N,z)),I=S===popper?M:B,U={top:T.top-I.top+R.top,bottom:I.bottom-T.bottom+R.bottom,left:T.left-I.left+R.left,right:I.right-T.right+R.right},q=l.modifiersData.offset;if(S===popper&&q){var H=q[v];Object.keys(U).forEach(function(Y){var X=[right,bottom].indexOf(Y)>=0?1:-1,ee=[top,bottom].indexOf(Y)>=0?"y":"x";U[Y]+=H[ee]*X})}return U}function computeAutoPlacement(l,g){g===void 0&&(g={});var m=g,b=m.placement,v=m.boundary,y=m.rootBoundary,w=m.padding,E=m.flipVariations,O=m.allowedAutoPlacements,k=O===void 0?placements:O,S=getVariation(b),P=S?E?variationPlacements:variationPlacements.filter(function(L){return getVariation(L)===S}):basePlacements,j=P.filter(function(L){return k.indexOf(L)>=0});j.length===0&&(j=P);var C=j.reduce(function(L,R){return L[R]=detectOverflow(l,{placement:R,boundary:v,rootBoundary:y,padding:w})[getBasePlacement(R)],L},{});return Object.keys(C).sort(function(L,R){return C[L]-C[R]})}function getExpandedFallbackPlacements(l){if(getBasePlacement(l)===auto)return[];var g=getOppositePlacement(l);return[getOppositeVariationPlacement(l),g,getOppositeVariationPlacement(g)]}function flip(l){var g=l.state,m=l.options,b=l.name;if(!g.modifiersData[b]._skip){for(var v=m.mainAxis,y=v===void 0?!0:v,w=m.altAxis,E=w===void 0?!0:w,O=m.fallbackPlacements,k=m.padding,S=m.boundary,P=m.rootBoundary,j=m.altBoundary,C=m.flipVariations,L=C===void 0?!0:C,R=m.allowedAutoPlacements,A=g.options.placement,D=getBasePlacement(A),N=D===A,F=O||(N||!L?[getOppositePlacement(A)]:getExpandedFallbackPlacements(A)),T=[A].concat(F).reduce(function(te,Z){return te.concat(getBasePlacement(Z)===auto?computeAutoPlacement(g,{placement:Z,boundary:S,rootBoundary:P,padding:k,flipVariations:L,allowedAutoPlacements:R}):Z)},[]),B=g.rects.reference,z=g.rects.popper,M=new Map,I=!0,U=T[0],q=0;q<T.length;q++){var H=T[q],Y=getBasePlacement(H),X=getVariation(H)===start,ee=[top,bottom].indexOf(Y)>=0,oe=ee?"width":"height",K=detectOverflow(g,{placement:H,boundary:S,rootBoundary:P,altBoundary:j,padding:k}),J=ee?X?right:left:X?bottom:top;B[oe]>z[oe]&&(J=getOppositePlacement(J));var le=getOppositePlacement(J),re=[];if(y&&re.push(K[Y]<=0),E&&re.push(K[J]<=0,K[le]<=0),re.every(function(te){return te})){U=H,I=!1;break}M.set(H,re)}if(I)for(var ie=L?3:1,ae=function(Z){var se=T.find(function(fe){var Q=M.get(fe);if(Q)return Q.slice(0,Z).every(function(de){return de})});if(se)return U=se,"break"},ue=ie;ue>0;ue--){var pe=ae(ue);if(pe==="break")break}g.placement!==U&&(g.modifiersData[b]._skip=!0,g.placement=U,g.reset=!0)}}var flip$1={name:"flip",enabled:!0,phase:"main",fn:flip,requiresIfExists:["offset"],data:{_skip:!1}};function getSideOffsets(l,g,m){return m===void 0&&(m={x:0,y:0}),{top:l.top-g.height-m.y,right:l.right-g.width+m.x,bottom:l.bottom-g.height+m.y,left:l.left-g.width-m.x}}function isAnySideFullyClipped(l){return[top,right,bottom,left].some(function(g){return l[g]>=0})}function hide(l){var g=l.state,m=l.name,b=g.rects.reference,v=g.rects.popper,y=g.modifiersData.preventOverflow,w=detectOverflow(g,{elementContext:"reference"}),E=detectOverflow(g,{altBoundary:!0}),O=getSideOffsets(w,b),k=getSideOffsets(E,v,y),S=isAnySideFullyClipped(O),P=isAnySideFullyClipped(k);g.modifiersData[m]={referenceClippingOffsets:O,popperEscapeOffsets:k,isReferenceHidden:S,hasPopperEscaped:P},g.attributes.popper=Object.assign({},g.attributes.popper,{"data-popper-reference-hidden":S,"data-popper-escaped":P})}var hide$1={name:"hide",enabled:!0,phase:"main",requiresIfExists:["preventOverflow"],fn:hide};function distanceAndSkiddingToXY(l,g,m){var b=getBasePlacement(l),v=[left,top].indexOf(b)>=0?-1:1,y=typeof m=="function"?m(Object.assign({},g,{placement:l})):m,w=y[0],E=y[1];return w=w||0,E=(E||0)*v,[left,right].indexOf(b)>=0?{x:E,y:w}:{x:w,y:E}}function offset(l){var g=l.state,m=l.options,b=l.name,v=m.offset,y=v===void 0?[0,0]:v,w=placements.reduce(function(S,P){return S[P]=distanceAndSkiddingToXY(P,g.rects,y),S},{}),E=w[g.placement],O=E.x,k=E.y;g.modifiersData.popperOffsets!=null&&(g.modifiersData.popperOffsets.x+=O,g.modifiersData.popperOffsets.y+=k),g.modifiersData[b]=w}var offset$1={name:"offset",enabled:!0,phase:"main",requires:["popperOffsets"],fn:offset};function popperOffsets(l){var g=l.state,m=l.name;g.modifiersData[m]=computeOffsets({reference:g.rects.reference,element:g.rects.popper,strategy:"absolute",placement:g.placement})}var popperOffsets$1={name:"popperOffsets",enabled:!0,phase:"read",fn:popperOffsets,data:{}};function getAltAxis(l){return l==="x"?"y":"x"}function preventOverflow(l){var g=l.state,m=l.options,b=l.name,v=m.mainAxis,y=v===void 0?!0:v,w=m.altAxis,E=w===void 0?!1:w,O=m.boundary,k=m.rootBoundary,S=m.altBoundary,P=m.padding,j=m.tether,C=j===void 0?!0:j,L=m.tetherOffset,R=L===void 0?0:L,A=detectOverflow(g,{boundary:O,rootBoundary:k,padding:P,altBoundary:S}),D=getBasePlacement(g.placement),N=getVariation(g.placement),F=!N,T=getMainAxisFromPlacement(D),B=getAltAxis(T),z=g.modifiersData.popperOffsets,M=g.rects.reference,I=g.rects.popper,U=typeof R=="function"?R(Object.assign({},g.rects,{placement:g.placement})):R,q={x:0,y:0};if(!!z){if(y||E){var H=T==="y"?top:left,Y=T==="y"?bottom:right,X=T==="y"?"height":"width",ee=z[T],oe=z[T]+A[H],K=z[T]-A[Y],J=C?-I[X]/2:0,le=N===start?M[X]:I[X],re=N===start?-I[X]:-M[X],ie=g.elements.arrow,ae=C&&ie?getLayoutRect(ie):{width:0,height:0},ue=g.modifiersData["arrow#persistent"]?g.modifiersData["arrow#persistent"].padding:getFreshSideObject(),pe=ue[H],te=ue[Y],Z=within(0,M[X],ae[X]),se=F?M[X]/2-J-Z-pe-U:le-Z-pe-U,fe=F?-M[X]/2+J+Z+te+U:re+Z+te+U,Q=g.elements.arrow&&getOffsetParent(g.elements.arrow),de=Q?T==="y"?Q.clientTop||0:Q.clientLeft||0:0,W=g.modifiersData.offset?g.modifiersData.offset[g.placement][T]:0,V=z[T]+se-W-de,G=z[T]+fe-W;if(y){var ne=within(C?min(oe,V):oe,ee,C?max(K,G):K);z[T]=ne,q[T]=ne-ee}if(E){var he=T==="x"?top:left,ce=T==="x"?bottom:right,ge=z[B],be=ge+A[he],ye=ge-A[ce],xe=within(C?min(be,V):be,ge,C?max(ye,G):ye);z[B]=xe,q[B]=xe-ge}}g.modifiersData[b]=q}}var preventOverflow$1={name:"preventOverflow",enabled:!0,phase:"main",fn:preventOverflow,requiresIfExists:["offset"]};function getHTMLElementScroll(l){return{scrollLeft:l.scrollLeft,scrollTop:l.scrollTop}}function getNodeScroll(l){return l===getWindow(l)||!isHTMLElement(l)?getWindowScroll(l):getHTMLElementScroll(l)}function getCompositeRect(l,g,m){m===void 0&&(m=!1);var b=getDocumentElement(g),v=getBoundingClientRect(l),y=isHTMLElement(g),w={scrollLeft:0,scrollTop:0},E={x:0,y:0};return(y||!y&&!m)&&((getNodeName(g)!=="body"||isScrollParent(b))&&(w=getNodeScroll(g)),isHTMLElement(g)?(E=getBoundingClientRect(g),E.x+=g.clientLeft,E.y+=g.clientTop):b&&(E.x=getWindowScrollBarX(b))),{x:v.left+w.scrollLeft-E.x,y:v.top+w.scrollTop-E.y,width:v.width,height:v.height}}function order(l){var g=new Map,m=new Set,b=[];l.forEach(function(y){g.set(y.name,y)});function v(y){m.add(y.name);var w=[].concat(y.requires||[],y.requiresIfExists||[]);w.forEach(function(E){if(!m.has(E)){var O=g.get(E);O&&v(O)}}),b.push(y)}return l.forEach(function(y){m.has(y.name)||v(y)}),b}function orderModifiers(l){var g=order(l);return modifierPhases.reduce(function(m,b){return m.concat(g.filter(function(v){return v.phase===b}))},[])}function debounce(l){var g;return function(){return g||(g=new Promise(function(m){Promise.resolve().then(function(){g=void 0,m(l())})})),g}}function mergeByName(l){var g=l.reduce(function(m,b){var v=m[b.name];return m[b.name]=v?Object.assign({},v,b,{options:Object.assign({},v.options,b.options),data:Object.assign({},v.data,b.data)}):b,m},{});return Object.keys(g).map(function(m){return g[m]})}var DEFAULT_OPTIONS={placement:"bottom",modifiers:[],strategy:"absolute"};function areValidElements(){for(var l=arguments.length,g=new Array(l),m=0;m<l;m++)g[m]=arguments[m];return!g.some(function(b){return!(b&&typeof b.getBoundingClientRect=="function")})}function popperGenerator(l){l===void 0&&(l={});var g=l,m=g.defaultModifiers,b=m===void 0?[]:m,v=g.defaultOptions,y=v===void 0?DEFAULT_OPTIONS:v;return function(E,O,k){k===void 0&&(k=y);var S={placement:"bottom",orderedModifiers:[],options:Object.assign({},DEFAULT_OPTIONS,y),modifiersData:{},elements:{reference:E,popper:O},attributes:{},styles:{}},P=[],j=!1,C={state:S,setOptions:function(D){R(),S.options=Object.assign({},y,S.options,D),S.scrollParents={reference:isElement(E)?listScrollParents(E):E.contextElement?listScrollParents(E.contextElement):[],popper:listScrollParents(O)};var N=orderModifiers(mergeByName([].concat(b,S.options.modifiers)));return S.orderedModifiers=N.filter(function(F){return F.enabled}),L(),C.update()},forceUpdate:function(){if(!j){var D=S.elements,N=D.reference,F=D.popper;if(!!areValidElements(N,F)){S.rects={reference:getCompositeRect(N,getOffsetParent(F),S.options.strategy==="fixed"),popper:getLayoutRect(F)},S.reset=!1,S.placement=S.options.placement,S.orderedModifiers.forEach(function(q){return S.modifiersData[q.name]=Object.assign({},q.data)});for(var T=0;T<S.orderedModifiers.length;T++){if(S.reset===!0){S.reset=!1,T=-1;continue}var B=S.orderedModifiers[T],z=B.fn,M=B.options,I=M===void 0?{}:M,U=B.name;typeof z=="function"&&(S=z({state:S,options:I,name:U,instance:C})||S)}}}},update:debounce(function(){return new Promise(function(A){C.forceUpdate(),A(S)})}),destroy:function(){R(),j=!0}};if(!areValidElements(E,O))return C;C.setOptions(k).then(function(A){!j&&k.onFirstUpdate&&k.onFirstUpdate(A)});function L(){S.orderedModifiers.forEach(function(A){var D=A.name,N=A.options,F=N===void 0?{}:N,T=A.effect;if(typeof T=="function"){var B=T({state:S,name:D,instance:C,options:F}),z=function(){};P.push(B||z)}})}function R(){P.forEach(function(A){return A()}),P=[]}return C}}var defaultModifiers=[eventListeners,popperOffsets$1,computeStyles$1,applyStyles$1,offset$1,flip$1,preventOverflow$1,arrow$1,hide$1],createPopper=popperGenerator({defaultModifiers}),css$1=`/**
