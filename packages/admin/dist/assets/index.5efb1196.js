 ...
 */(function(){if(!(window.Reflect===void 0||window.customElements===void 0||window.customElements.hasOwnProperty("polyfillWrapFlushCallback"))){var l=HTMLElement;window.HTMLElement=function(){return Reflect.construct(l,[],this.constructor)},HTMLElement.prototype=l.prototype,HTMLElement.prototype.constructor=HTMLElement,Object.setPrototypeOf(HTMLElement,l)}})();function cssToDom(l){var B=document.createElement("style");return B.textContent=l,B}function camelCase(l){return l.replace(/-(\w)/g,function(B,N){return N.toUpperCase()})}function Fragment(l){return l.children}function extend(l,B){for(var N in B)l[N]=B[N];return l}function applyRef(l,B){l!=null&&(typeof l=="function"?l(B):l.current=B)}typeof Promise=="function"&&Promise.resolve().then.bind(Promise.resolve());function isArray(l){return Object.prototype.toString.call(l)==="[object Array]"}function pathToArr(l){return typeof l!="string"||!l?[]:l.replace(/]/g,"").replace(/\[/g,".").split(".")}var hyphenateRE=/\B([A-Z])/g;function hyphenate$1(l){return l.replace(hyphenateRE,"-$1").toLowerCase()}function capitalize$2(l){return l.replace(/\-(\w)/g,function(B,N){return N.toUpperCase()}).replace(/^\S/,function(B){return B.toUpperCase()})}function getValByPath(l,B){var N=pathToArr(l);return N.forEach(function(W){B=B[W]}),B}var stack=[];function h$2(l,B){var N=[],W,U,V,q;for(q=arguments.length;q-- >2;)stack.push(arguments[q]);for(B&&B.children!=null&&(stack.length||stack.push(B.children),delete B.children);stack.length;)if((U=stack.pop())&&U.pop!==void 0)for(q=U.length;q--;)stack.push(U[q]);else typeof U=="boolean"&&(U=null),(V=typeof l!="function")&&(U==null?U="":typeof U=="number"?U=String(U):typeof U!="string"&&(V=!1)),V&&W?N[N.length-1]+=U:N.length===0?N=[U]:N.push(U),W=V;if(l===Fragment)return N;var H={nodeName:l,children:N,attributes:B==null?void 0:B,key:B==null?void 0:B.key};return options.vnode!==void 0&&options.vnode(H),H}var IS_NON_DIMENSIONAL=/acit|ex(?:s|g|n|p|$)|rph|ows|mnc|ntw|ine[ch]|zoo|^ord/i;function isSameNodeType(l,B,N){return typeof B=="string"||typeof B=="number"?l.splitText!==void 0:typeof B.nodeName=="string"?!l._componentConstructor&&isNamedNode(l,B.nodeName):typeof B.nodeName=="function"?options.mapping[l.nodeName.toLowerCase()]===B.nodeName:N||l._componentConstructor===B.nodeName}function isNamedNode(l,B){return l.normalizedNodeName===B||l.nodeName.toLowerCase()===B.toLowerCase()}var extension={};function extend$1(l,B){extension["o-"+l]=B}function set(l,B,N){for(var W=pathToArr(B),U=l,V=0,q=W.length;V<q;V++)V===q-1?U[W[V]]=N:U=U[W[V]]}function get$1(l,B){for(var N=pathToArr(B),W=l,U=0,V=N.length;U<V;U++)W=W[N[U]];return W}function eventProxy(l){return this._listeners[l.type](l)}function bind(l,B,N){l._listeners=l._listeners||{},l._listeners[B]=N,l.addEventListener(B,eventProxy)}function unbind(l,B){l.removeEventListener(B,eventProxy)}function createNode(l,B){var N=B?document.createElementNS("http://www.w3.org/2000/svg",l):document.createElement(l);return N.normalizedNodeName=l,N}function removeNode(l){var B=l.parentNode;B&&B.removeChild(l)}function setAccessor(l,B,N,W,U,V){if(B==="className"&&(B="class"),B[0]=="o"&&B[1]=="-")extension[B]&&extension[B](l,W,V);else if(B!=="key")if(B==="ref")applyRef(N,null),applyRef(W,l);else if(B==="class"&&!U)l.className=W||"";else if(B==="style"){if((!W||typeof W=="string"||typeof N=="string")&&(l.style.cssText=W||""),W&&typeof W=="object"){if(typeof N!="string")for(var q in N)q in W||(l.style[q]="");for(var q in W)l.style[q]=typeof W[q]=="number"&&IS_NON_DIMENSIONAL.test(q)===!1?W[q]+"px":W[q]}}else if(B==="dangerouslySetInnerHTML")W&&(l.innerHTML=W.__html||"");else if(B[0]=="o"&&B[1]=="n")bindEvent(l,B,W,N);else if(l.nodeName==="INPUT"&&B==="value")l[B]=W==null?"":W;else if(B!=="list"&&B!=="type"&&B!=="css"&&!U&&B in l&&W!==""){try{l[B]=W==null?"":W}catch{}(W==null||W===!1)&&B!="spellcheck"&&(l.pureRemoveAttribute?l.pureRemoveAttribute(B):l.removeAttribute(B))}else{var H=U&&B!==(B=B.replace(/^xlink:?/,""));W==null||W===!1?H?l.removeAttributeNS("http://www.w3.org/1999/xlink",B.toLowerCase()):l.pureRemoveAttribute?l.pureRemoveAttribute(B):l.removeAttribute(B):typeof W!="function"&&(H?l.setAttributeNS("http://www.w3.org/1999/xlink",B.toLowerCase(),W):l.pureSetAttribute?l.pureSetAttribute(B,W):l.setAttribute(B,W))}}function eventProxy$1(l){return this._listeners[l.type](options.event&&options.event(l)||l)}function bindEvent(l,B,N,W){var U=B!==(B=B.replace(/Capture$/,"")),V=B.toLowerCase();B=(V in l?V:B).slice(2),N?W||l.addEventListener(B,eventProxy$1,U):l.removeEventListener(B,eventProxy$1,U),(l._listeners||(l._listeners={}))[B]=N}var diffLevel=0,isSvgMode=!1,hydrating=!1;function diff(l,B,N,W,U){if(!(!l&&!B)){var V;return diffLevel++||(isSvgMode=N!=null&&N.ownerSVGElement!==void 0,hydrating=l!=null&&!("prevProps"in l)),B&&B.nodeName===Fragment&&(B=B.children),isArray(B)?N?innerDiffNode(N,B,hydrating,W,U):(V=[],B.forEach(function(q,H){var X=idiff(H===0?l:null,q,W,U);V.push(X)})):(isArray(l)?l.forEach(function(q,H){H===0?V=idiff(q,B,W,U):recollectNodeTree(q,!1)}):V=idiff(l,B,W,U),N&&V.parentNode!==N&&N.appendChild(V)),--diffLevel||(hydrating=!1),V}}function idiff(l,B,N,W){l&&B&&l.props&&(l.props.children=B.children);var U=l,V=isSvgMode;if((B==null||typeof B=="boolean")&&(B=""),typeof B=="string"||typeof B=="number")return l&&l.splitText!==void 0&&l.parentNode&&(!l._component||N)?l.nodeValue!=B&&(l.nodeValue=B):(U=document.createTextNode(B),l&&(l.parentNode&&l.parentNode.replaceChild(U,l),recollectNodeTree(l,!0))),U.prevProps=!0,U;var q=B.nodeName;if(typeof q=="function"){for(var H in options.mapping)if(options.mapping[H]===q){q=H,B.nodeName=H;break}}if(isSvgMode=q==="svg"?!0:q==="foreignObject"?!1:isSvgMode,q=String(q),(!l||!isNamedNode(l,q))&&(U=createNode(q,isSvgMode),l)){for(;l.firstChild;)U.appendChild(l.firstChild);l.parentNode&&l.parentNode.replaceChild(U,l),recollectNodeTree(l,!0)}var X=U.firstChild,G=U.prevProps,K=B.children;if(G==null){G=U.prevProps={};for(var Y=U.attributes,J=Y.length;J--;)G[Y[J].name]=Y[J].value}return!hydrating&&K&&K.length===1&&typeof K[0]=="string"&&X!=null&&X.splitText!==void 0&&X.nextSibling==null?X.nodeValue!=K[0]&&(X.nodeValue=K[0]):(K&&K.length||X!=null)&&(U.constructor.is=="WeElement"&&U.constructor.noSlot||innerDiffNode(U,K,hydrating||G.dangerouslySetInnerHTML!=null,N,W)),diffAttributes(U,B.attributes,G,N,W),U.props&&(U.props.children=B.children),isSvgMode=V,U}function innerDiffNode(l,B,N,W,U){var V=l.childNodes,q=[],H={},X=0,G=0,K=V.length,Y=0,J=B?B.length:0,Z,Q,te,ee,re;if(K!==0)for(var ae=0;ae<K;ae++){var ie=V[ae],ne=ie.prevProps,le=J&&ne?ie._component?ie._component.__key:ne.key:null;le!=null?(X++,H[le]=ie):(ne||(ie.splitText!==void 0?N?ie.nodeValue.trim():!0:N))&&(q[Y++]=ie)}if(J!==0)for(var ae=0;ae<J;ae++){if(ee=B[ae],re=null,ee){var le=ee.key;if(le!=null)X&&H[le]!==void 0&&(re=H[le],H[le]=void 0,X--);else if(!re&&G<Y){for(Z=G;Z<Y;Z++)if(q[Z]!==void 0&&isSameNodeType(Q=q[Z],ee,N)){re=Q,q[Z]=void 0,Z===Y-1&&Y--,Z===G&&G++;break}}}re=idiff(re,ee,W,U),te=V[ae],re&&re!==l&&re!==te&&(te==null?l.appendChild(re):re===te.nextSibling?removeNode(te):l.insertBefore(re,te))}if(X)for(var ae in H)H[ae]!==void 0&&recollectNodeTree(H[ae],!1);for(;G<=Y;)(re=q[Y--])!==void 0&&recollectNodeTree(re,!1)}function recollectNodeTree(l,B){l.prevProps!=null&&l.prevProps.ref&&(typeof l.prevProps.ref=="function"?l.prevProps.ref(null):l.prevProps.ref.current&&(l.prevProps.ref.current=null)),(B===!1||l.prevProps==null)&&removeNode(l),removeChildren(l)}function removeChildren(l){for(l=l.lastChild;l;){var B=l.previousSibling;recollectNodeTree(l,!0),l=B}}function diffAttributes(l,B,N,W,U){var V,q=l.update,H;l.receiveProps&&(H=Object.assign({},N));for(V in N)!(B&&B[V]!=null)&&N[V]!=null&&(setAccessor(l,V,N[V],N[V]=void 0,isSvgMode,W),q&&delete l.props[V]);for(V in B)if(q&&typeof B[V]=="object"&&V!=="ref"){V==="style"&&setAccessor(l,V,N[V],N[V]=B[V],isSvgMode,W);var X=camelCase(V);l.props[X]=N[X]=B[V]}else if(V!=="children"&&(!(V in N)||B[V]!==(V==="value"||V==="checked"?l[V]:N[V])))if(setAccessor(l,V,N[V],B[V],isSvgMode,W),l.nodeName.indexOf("-")!==-1){l.props=l.props||{};var G=camelCase(V);l.props[G]=N[G]=B[V]}else N[V]=B[V];q&&!U&&l.parentNode&&l.receiveProps(l.props,H)!==!1&&l.update()}function _classCallCheck$1(l,B){if(!(l instanceof B))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn$1(l,B){if(!l)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return B&&(typeof B=="object"||typeof B=="function")?B:l}function _inherits$1(l,B){if(typeof B!="function"&&B!==null)throw new TypeError("Super expression must either be null or a function, not "+typeof B);l.prototype=Object.create(B&&B.prototype,{constructor:{value:l,enumerable:!1,writable:!0,configurable:!0}}),B&&(Object.setPrototypeOf?Object.setPrototypeOf(l,B):l.__proto__=B)}var id$1=0,WeElement=function(l){_inherits$1(B,l);function B(){_classCallCheck$1(this,B);var N=_possibleConstructorReturn$1(this,l.call(this));return N.props=Object.assign({},N.constructor.defaultProps,N.props),N.elementId=id$1++,N.computed={},N.isInstalled=!1,N}return B.prototype.connectedCallback=function(){for(var W=this,U=this.parentNode;U&&!this.store;)this.store=U.store,U=U.parentNode||U.host;if(this.inject){this.injection={},U=this.parentNode;for(var V;U&&!V;)V=U.provide,U=U.parentNode||U.host;if(V)this.inject.forEach(function(J){W.injection[J]=V[J]});else throw"The provide prop was not found on the parent node or the provide type is incorrect."}this.attrsToProps(),this.beforeInstall(),this.install(),this.afterInstall();var q;if(this.constructor.isLightDom)q=this;else if(!this.shadowRoot)q=this.attachShadow({mode:"open"});else{q=this.shadowRoot;for(var H;H=q.firstChild;)q.removeChild(H)}if(this.constructor.elementStyles)q.adoptedStyleSheets=this.constructor.elementStyles;else{var X=this.constructor.css;if(X){if(typeof X=="string"){var G=new CSSStyleSheet;G.replaceSync(X),q.adoptedStyleSheets=[G]}else if(Object.prototype.toString.call(X)==="[object Array]"){var K=[];X.forEach(function(J){if(typeof J=="string"){var Z=new CSSStyleSheet;Z.replaceSync(J),K.push(Z)}else K.push(J);q.adoptedStyleSheets=K})}else q.adoptedStyleSheets=[X];this.constructor.elementStyles=q.adoptedStyleSheets}}this.beforeRender(),options.afterInstall&&options.afterInstall(this);var Y=this.render(this.props,this.store);this.rootNode=diff(null,Y,null,this),this.rendered(),this.css&&q.appendChild(cssToDom(typeof this.css=="function"?this.css():this.css)),this.props.css&&(this._customStyleElement=cssToDom(this.props.css),this._customStyleContent=this.props.css,q.appendChild(this._customStyleElement)),isArray(this.rootNode)?this.rootNode.forEach(function(J){q.appendChild(J)}):this.rootNode&&q.appendChild(this.rootNode),this.installed(),this.isInstalled=!0},B.prototype.disconnectedCallback=function(){this.uninstall(),this.isInstalled=!1},B.prototype.update=function(W,U){this._willUpdate=!0,this.beforeUpdate(),this.beforeRender(),this._customStyleContent!=this.props.css&&(this._customStyleContent=this.props.css,this._customStyleElement.textContent=this._customStyleContent),this.attrsToProps(W);var V=this.render(this.props,this.store);this.rendered(),this.rootNode=diff(this.rootNode,V,this.constructor.isLightDom?this:this.shadowRoot,this,U),this._willUpdate=!1,this.updated()},B.prototype.forceUpdate=function(){this.update(!0)},B.prototype.updateProps=function(W){var U=this;Object.keys(W).forEach(function(V){U.props[V]=W[V],U.prevProps&&(U.prevProps[V]=W[V])}),this.forceUpdate()},B.prototype.updateSelf=function(W){this.update(W,!0)},B.prototype.removeAttribute=function(W){l.prototype.removeAttribute.call(this,W),this.isInstalled&&this.update()},B.prototype.setAttribute=function(W,U){U&&typeof U=="object"?l.prototype.setAttribute.call(this,W,JSON.stringify(U)):l.prototype.setAttribute.call(this,W,U),this.isInstalled&&this.update()},B.prototype.pureRemoveAttribute=function(W){l.prototype.removeAttribute.call(this,W)},B.prototype.pureSetAttribute=function(W,U){l.prototype.setAttribute.call(this,W,U)},B.prototype.attrsToProps=function(W){if(!(W||this.store&&this.store.ignoreAttrs||this.props.ignoreAttrs)){var U=this;U.props.css=U.getAttribute("css");var V=this.constructor.propTypes;!V||Object.keys(V).forEach(function(q){var H=V[q],X=U.getAttribute(hyphenate$1(q));if(X!==null)switch(H){case String:U.props[q]=X;break;case Number:U.props[q]=Number(X);break;case Boolean:X==="false"||X==="0"?U.props[q]=!1:U.props[q]=!0;break;case Array:case Object:X[0]===":"?U.props[q]=getValByPath(X.substr(1),Omi.$):U.props[q]=JSON.parse(X.replace(/(['"])?([a-zA-Z0-9_-]+)(['"])?:([^\/])/g,'"$2":$4').replace(/'([\s\S]*?)'/g,'"$1"').replace(/,(\s*})/g,"$1"));break}else U.constructor.defaultProps&&U.constructor.defaultProps.hasOwnProperty(q)?U.props[q]=U.constructor.defaultProps[q]:U.props[q]=null})}},B.prototype.fire=function(W,U){var V=this.props["on"+capitalize$2(W)];V?V(new CustomEvent(W,{detail:U})):this.dispatchEvent(new CustomEvent(W,{detail:U}))},B.prototype.beforeInstall=function(){},B.prototype.install=function(){},B.prototype.afterInstall=function(){},B.prototype.installed=function(){},B.prototype.uninstall=function(){},B.prototype.beforeUpdate=function(){},B.prototype.updated=function(){},B.prototype.beforeRender=function(){},B.prototype.rendered=function(){},B.prototype.receiveProps=function(){},B}(HTMLElement);WeElement.is="WeElement";function render(l,B,N){return B=typeof B=="string"?document.querySelector(B):B,N&&(B.store=N),diff(null,l,B,!1)}function _classCallCheck$1$1(l,B){if(!(l instanceof B))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn$1$1(l,B){if(!l)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return B&&(typeof B=="object"||typeof B=="function")?B:l}function _inherits$1$1(l,B){if(typeof B!="function"&&B!==null)throw new TypeError("Super expression must either be null or a function, not "+typeof B);l.prototype=Object.create(B&&B.prototype,{constructor:{value:l,enumerable:!1,writable:!0,configurable:!0}}),B&&(Object.setPrototypeOf?Object.setPrototypeOf(l,B):l.__proto__=B)}var storeHelpers=["use","useSelf"];function define(l,B,N){if(!customElements.get(l)&&!options.mapping[l])if(B.is==="WeElement")customElements.define(l,B),options.mapping[l]=B;else{typeof N=="string"?N={css:N}:N=N||{};var W=function(q){_inherits$1$1(H,q);function H(){var X,G,K;_classCallCheck$1$1(this,H);for(var Y=arguments.length,J=Array(Y),Z=0;Z<Y;Z++)J[Z]=arguments[Z];return K=(X=(G=_possibleConstructorReturn$1$1(this,q.call.apply(q,[this].concat(J))),G),G.compute=N.compute,X),_possibleConstructorReturn$1$1(G,K)}return H.prototype.render=function(){return B.call(this,this)},H}(WeElement);W.css=N.css,W.propTypes=N.propTypes,W.defaultProps=N.defaultProps,W.isLightDom=N.isLightDom;var U=function(H){typeof N[H]=="function"&&(W.prototype[H]=function(){return N[H].apply(this,arguments)})};for(var V in N)U(V);storeHelpers.forEach(function(q){N[q]&&N[q]!=="function"&&(W.prototype[q]=function(){return N[q]})}),customElements.define(l,W),options.mapping[l]=W}}function tag(l){return function(B){define(l,B)}}function cloneElement(l,B){return h$2(l.nodeName,extend(extend({},l.attributes),B),arguments.length>2?[].slice.call(arguments,2):l.children)}function getHost(l){for(var B=l.parentNode;B;){if(B.host)return B.host;if(B.shadowRoot&&B.shadowRoot.host)return B.shadowRoot.host;B=B.parentNode}}function rpx(l){return l.replace(/([1-9]\d*|0)(\.\d*)*rpx/g,function(B,N){return window.innerWidth*Number(N)/750+"px"})}var hasOwn={}.hasOwnProperty;function classNames(){for(var l=[],B=0;B<arguments.length;B++){var N=arguments[B];if(!!N){var W=typeof N;if(W==="string"||W==="number")l.push(N);else if(Array.isArray(N)&&N.length){var U=classNames.apply(null,N);U&&l.push(U)}else if(W==="object")for(var V in N)hasOwn.call(N,V)&&N[V]&&l.push(V)}}return l.join(" ")}function extractClass(){var l=Array.prototype.slice.call(arguments,0),B=l[0],N=l.slice(1);if(B.class?(N.unshift(B.class),delete B.class):B.className&&(N.unshift(B.className),delete B.className),N.length>0)return{class:classNames.apply(null,N)}}function o$4(l){return JSON.stringify(l)}(function(){if("adoptedStyleSheets"in document)return;var l="ShadyCSS"in window&&!ShadyCSS.nativeShadow,B=document.implementation.createHTMLDocument("boot"),N=new WeakMap,W=typeof DOMException=="object"?Error:DOMException,U=Object.defineProperty,V=Array.prototype.forEach,q=/@import.+?;?$/gm;function H(se){var ue=se.replace(q,"");return ue!==se&&console.warn("@import rules are not allowed here. See https://github.com/WICG/construct-stylesheets/issues/119#issuecomment-588352418"),ue.trim()}function X(se){for(var ue=0;ue<se.cssRules.length;ue++)se.deleteRule(0)}function G(se,ue){V.call(se.cssRules,function(de,ve){ue.insertRule(de.cssText,ve)})}function K(se){return"isConnected"in se?se.isConnected:document.contains(se)}function Y(se){return se.filter(function(ue,de){return se.indexOf(ue)===de})}function J(se,ue){return se.filter(function(de){return ue.indexOf(de)===-1})}function Z(se){se.parentNode.removeChild(se)}function Q(se){return se.shadowRoot||N.get(se)}var te=["addImport","addPageRule","addRule","deleteRule","insertRule","removeImport","removeRule"],ee=CSSStyleSheet,re=ee.prototype;re.replace=function(){return Promise.reject(new W("Can't call replace on non-constructed CSSStyleSheets."))},re.replaceSync=function(){throw new W("Failed to execute 'replaceSync' on 'CSSStyleSheet': Can't call replaceSync on non-constructed CSSStyleSheets.")};function ae(se){return typeof se=="object"?be.isPrototypeOf(se)||re.isPrototypeOf(se):!1}function ie(se){return typeof se=="object"?re.isPrototypeOf(se):!1}var ne=new WeakMap,le=new WeakMap,pe=new WeakMap;function oe(se,ue){var de=document.createElement("style");return pe.get(se).set(ue,de),le.get(se).push(ue),de}function ce(se,ue){return pe.get(se).get(ue)}function fe(se,ue){pe.get(se).delete(ue),le.set(se,le.get(se).filter(function(de){return de!==ue}))}function he(se,ue){requestAnimationFrame(function(){X(ue.sheet),G(ne.get(se),ue.sheet)})}function ge(se){if(!ne.has(se))throw new TypeError("Illegal invocation")}function _e(){var se=this,ue=document.createElement("style");B.body.appendChild(ue),ne.set(se,ue.sheet),le.set(se,[]),pe.set(se,new WeakMap)}var be=_e.prototype;be.replace=function(ue){try{return this.replaceSync(ue),Promise.resolve(this)}catch(de){return Promise.reject(de)}},be.replaceSync=function(ue){if(ge(this),typeof ue=="string"){var de=this,ve=ne.get(de).ownerNode;ve.textContent=H(ue),ne.set(de,ve.sheet),le.get(de).forEach(function(Fe){Fe.isConnected()&&he(de,ce(de,Fe))})}},U(be,"cssRules",{configurable:!0,enumerable:!0,get:function(){return ge(this),ne.get(this).cssRules}}),te.forEach(function(se){be[se]=function(){var ue=this;ge(ue);var de=arguments,ve=ne.get(ue),Fe=le.get(ue),Ee=ve[se].apply(ve,de);return Fe.forEach(function(Ae){if(Ae.isConnected()){var Be=ce(ue,Ae).sheet;Be[se].apply(Be,de)}}),Ee}}),U(_e,Symbol.hasInstance,{configurable:!0,value:ae});var ye={childList:!0,subtree:!0},Le=new WeakMap;function we(se){var ue=Le.get(se);return ue||(ue=new me(se),Le.set(se,ue)),ue}function ke(se){U(se.prototype,"adoptedStyleSheets",{configurable:!0,enumerable:!0,get:function(){return we(this).sheets},set:function(ue){we(this).update(ue)}})}function Re(se,ue){for(var de=document.createNodeIterator(se,NodeFilter.SHOW_ELEMENT,function(Fe){return Q(Fe)?NodeFilter.FILTER_ACCEPT:NodeFilter.FILTER_REJECT},null,!1),ve=void 0;ve=de.nextNode();)ue(Q(ve))}var Oe=new WeakMap,Pe=new WeakMap,Se=new WeakMap;function Ce(se,ue){return ue instanceof HTMLStyleElement&&Pe.get(se).some(function(de){return ce(de,se)})}function je(se){var ue=Oe.get(se);return ue instanceof Document?ue.body:ue}function xe(se){var ue=document.createDocumentFragment(),de=Pe.get(se),ve=Se.get(se),Fe=je(se);ve.disconnect(),de.forEach(function(Ee){ue.appendChild(ce(Ee,se)||oe(Ee,se))}),Fe.insertBefore(ue,null),ve.observe(Fe,ye),de.forEach(function(Ee){he(Ee,ce(Ee,se))})}function me(se){var ue=this;ue.sheets=[],Oe.set(ue,se),Pe.set(ue,[]),Se.set(ue,new MutationObserver(function(de,ve){if(!document){ve.disconnect();return}de.forEach(function(Fe){l||V.call(Fe.addedNodes,function(Ee){Ee instanceof Element&&Re(Ee,function(Ae){we(Ae).connect()})}),V.call(Fe.removedNodes,function(Ee){Ee instanceof Element&&(Ce(ue,Ee)&&xe(ue),l||Re(Ee,function(Ae){we(Ae).disconnect()}))})})}))}var Te=me.prototype;if(Te.isConnected=function(){var ue=Oe.get(this);return ue instanceof Document?ue.readyState!=="loading":K(ue.host)},Te.connect=function(){var ue=je(this);Se.get(this).observe(ue,ye),Pe.get(this).length>0&&xe(this),Re(ue,function(de){we(de).connect()})},Te.disconnect=function(){Se.get(this).disconnect()},Te.update=function(ue){var de=this,ve=Oe.get(de)===document?"Document":"ShadowRoot";if(!Array.isArray(ue))throw new TypeError("Failed to set the 'adoptedStyleSheets' property on "+ve+": Iterator getter is not callable.");if(!ue.every(ae))throw new TypeError("Failed to set the 'adoptedStyleSheets' property on "+ve+": Failed to convert value to 'CSSStyleSheet'");if(ue.some(ie))throw new TypeError("Failed to set the 'adoptedStyleSheets' property on "+ve+": Can't adopt non-constructed stylesheets");de.sheets=ue;var Fe=Pe.get(de),Ee=Y(ue),Ae=J(Fe,Ee);Ae.forEach(function(Be){Z(ce(Be,de)),fe(Be,de)}),Pe.set(de,Ee),de.isConnected()&&Ee.length>0&&xe(de)},window.CSSStyleSheet=_e,ke(Document),"ShadowRoot"in window){ke(ShadowRoot);var Me=Element.prototype,$e=Me.attachShadow;Me.attachShadow=function(ue){var de=$e.call(this,ue);return ue.mode==="closed"&&N.set(this,de),de}}var De=we(document);De.isConnected()?De.connect():document.addEventListener("DOMContentLoaded",De.connect.bind(De))})();h$2.f=Fragment;function createRef(){return{}}var $$1={},Component=WeElement,defineElement=define,elements=options.mapping,omi={tag,WeElement,Component,render,h:h$2,createElement:h$2,options,define,cloneElement,getHost,rpx,defineElement,classNames,extractClass,createRef,o:o$4,elements,$:$$1,extend:extend$1,get:get$1,set,bind,unbind};options.root.Omi=omi;options.root.omi=omi;options.root.Omi.version="6.23.0";var omi_esm=Object.freeze(Object.defineProperty({__proto__:null,default:omi,tag,WeElement,Component,render,h:h$2,createElement:h$2,options,define,cloneElement,getHost,rpx,defineElement,classNames,extractClass,createRef,o:o$4,elements,$:$$1,extend:extend$1,get:get$1,set,bind,unbind},Symbol.toStringTag,{value:"Module"})),_pathToRegexp_3_2_0_pathToRegexp=pathToRegexp,match_1=match,regexpToFunction_1=regexpToFunction,parse_1=parse$1,compile_1=compile,tokensToFunction_1=tokensToFunction,tokensToRegExp_1=tokensToRegExp,DEFAULT_DELIMITER="/",PATH_REGEXP=new RegExp(["(\\\\.)","(?:\\:(\\w+)(?:\\(((?:\\\\.|[^\\\\()])+)\\))?|\\(((?:\\\\.|[^\\\\()])+)\\))([+*?])?"].join("|"),"g");function parse$1(l,B){for(var N=[],W=0,U=0,V="",q=B&&B.delimiter||DEFAULT_DELIMITER,H=B&&B.whitelist||void 0,X=!1,G;(G=PATH_REGEXP.exec(l))!==null;){var K=G[0],Y=G[1],J=G.index;if(V+=l.slice(U,J),U=J+K.length,Y){V+=Y[1],X=!0;continue}var Z="",Q=G[2],te=G[3],ee=G[4],re=G[5];if(!X&&V.length){var ae=V.length-1,ie=V[ae],ne=H?H.indexOf(ie)>-1:!0;ne&&(Z=ie,V=V.slice(0,ae))}V&&(N.push(V),V="",X=!1);var le=re==="+"||re==="*",pe=re==="?"||re==="*",oe=te||ee,ce=Z||q;N.push({name:Q||W++,prefix:Z,delimiter:ce,optional:pe,repeat:le,pattern:oe?escapeGroup(oe):"[^"+escapeString(ce===q?ce:ce+q)+"]+?"})}return(V||U<l.length)&&N.push(V+l.substr(U)),N}function compile(l,B){return tokensToFunction(parse$1(l,B),B)}function match(l,B){var N=[],W=pathToRegexp(l,N,B);return regexpToFunction(W,N)}function regexpToFunction(l,B){return function(N,W){var U=l.exec(N);if(!U)return!1;for(var V=U[0],q=U.index,H={},X=W&&W.decode||decodeURIComponent,G=1;G<U.length;G++)if(U[G]!==void 0){var K=B[G-1];K.repeat?H[K.name]=U[G].split(K.delimiter).map(function(Y){return X(Y,K)}):H[K.name]=X(U[G],K)}return{path:V,index:q,params:H}}}function tokensToFunction(l,B){for(var N=new Array(l.length),W=0;W<l.length;W++)typeof l[W]=="object"&&(N[W]=new RegExp("^(?:"+l[W].pattern+")$",flags(B)));return function(U,V){for(var q="",H=V&&V.encode||encodeURIComponent,X=V?V.validate!==!1:!0,G=0;G<l.length;G++){var K=l[G];if(typeof K=="string"){q+=K;continue}var Y=U?U[K.name]:void 0,J;if(Array.isArray(Y)){if(!K.repeat)throw new TypeError('Expected "'+K.name+'" to not repeat, but got array');if(Y.length===0){if(K.optional)continue;throw new TypeError('Expected "'+K.name+'" to not be empty')}for(var Z=0;Z<Y.length;Z++){if(J=H(Y[Z],K),X&&!N[G].test(J))throw new TypeError('Expected all "'+K.name+'" to match "'+K.pattern+'"');q+=(Z===0?K.prefix:K.delimiter)+J}continue}if(typeof Y=="string"||typeof Y=="number"||typeof Y=="boolean"){if(J=H(String(Y),K),X&&!N[G].test(J))throw new TypeError('Expected "'+K.name+'" to match "'+K.pattern+'", but got "'+J+'"');q+=K.prefix+J;continue}if(!K.optional)throw new TypeError('Expected "'+K.name+'" to be '+(K.repeat?"an array":"a string"))}return q}}function escapeString(l){return l.replace(/([.+*?=^!:${}()[\]|/\\])/g,"\\$1")}function escapeGroup(l){return l.replace(/([=!:$/()])/g,"\\$1")}function flags(l){return l&&l.sensitive?"":"i"}function regexpToRegexp(l,B){if(!B)return l;var N=l.source.match(/\((?!\?)/g);if(N)for(var W=0;W<N.length;W++)B.push({name:W,prefix:null,delimiter:null,optional:!1,repeat:!1,pattern:null});return l}function arrayToRegexp(l,B,N){for(var W=[],U=0;U<l.length;U++)W.push(pathToRegexp(l[U],B,N).source);return new RegExp("(?:"+W.join("|")+")",flags(N))}function stringToRegexp(l,B,N){return tokensToRegExp(parse$1(l,N),B,N)}function tokensToRegExp(l,B,N){N=N||{};for(var W=N.strict,U=N.start!==!1,V=N.end!==!1,q=N.delimiter||DEFAULT_DELIMITER,H=[].concat(N.endsWith||[]).map(escapeString).concat("$").join("|"),X=U?"^":"",G=0;G<l.length;G++){var K=l[G];if(typeof K=="string")X+=escapeString(K);else{var Y=K.repeat?"(?:"+K.pattern+")(?:"+escapeString(K.delimiter)+"(?:"+K.pattern+"))*":K.pattern;B&&B.push(K),K.optional?K.prefix?X+="(?:"+escapeString(K.prefix)+"("+Y+"))?":X+="("+Y+")?":X+=escapeString(K.prefix)+"("+Y+")"}}if(V)W||(X+="(?:"+escapeString(q)+")?"),X+=H==="$"?"$":"(?="+H+")";else{var J=l[l.length-1],Z=typeof J=="string"?J[J.length-1]===q:J===void 0;W||(X+="(?:"+escapeString(q)+"(?="+H+"))?"),Z||(X+="(?="+escapeString(q)+"|"+H+")")}return new RegExp(X,flags(N))}function pathToRegexp(l,B,N){return l instanceof RegExp?regexpToRegexp(l,B):Array.isArray(l)?arrayToRegexp(l,B,N):stringToRegexp(l,B,N)}_pathToRegexp_3_2_0_pathToRegexp.match=match_1;_pathToRegexp_3_2_0_pathToRegexp.regexpToFunction=regexpToFunction_1;_pathToRegexp_3_2_0_pathToRegexp.parse=parse_1;_pathToRegexp_3_2_0_pathToRegexp.compile=compile_1;_pathToRegexp_3_2_0_pathToRegexp.tokensToFunction=tokensToFunction_1;_pathToRegexp_3_2_0_pathToRegexp.tokensToRegExp=tokensToRegExp_1;/*!
 *  omi-router v3.0.1 by dntzhang
 *  Router for Omi.
 *  Github: https://github.com/Tencent/omi
 *  MIT Licensed.
 */var mapping={},root=getGlobal();root.route=route$1;root.route.params=null;root.historyLength=0;root.route.to=function(l,B){root.route._routeByTo=!0,root.route.data=B,l[0]==="#"?location.hash=l:location.hash="#"+l};window.addEventListener("hashchange",hashChange);function hashChange(l){var B=!1;window.history.length===root.historyLength&&!root.route._routeByTo&&(B=!0),root.route._routeByTo=!1,root.historyLength=window.history.length;var N=!1;if(root.route.before&&(N=root.route.before(l)===!1),!N){var W=window.location.hash.replace("#","");W===""&&(W="/");var U=!0;Object.keys(mapping).every(function(V){var q=W.split("?")[0].match(mapping[V].reg);if(q){var H=V.match(mapping[V].reg);return root.route.params=getParams(q,H),root.route.query=getUrlParams(W),mapping[V].callback({params:root.route.params,query:getUrlParams(W),data:root.route.data,byNative:B}),root.route.data=null,U=!1,!1}return!0}),U&&mapping["*"]&&mapping["*"].callback({byNative:B}),root.route.after&&root.route.after(l)}}document.addEventListener("DOMContentLoaded",hashChange);function getParams(l,B){var N={};return l.forEach(function(W,U){U>0&&(N[B[U].replace(":","")]=W)}),N}function route$1(l,B){mapping[l]={callback:B,reg:_pathToRegexp_3_2_0_pathToRegexp(l)}}function getGlobal(){return typeof global!="object"||!global||global.Math!==Math||global.Array!==Array?self||window||global||function(){return this}():global}function getUrlParams(l){l=l.replace(/#.*$/,"");var B=l.split(/[?&]/).slice(1),N,W={};for(N=0;N<B.length;N++){var U=B[N].match(/([^=]+)=([^=]+)/);U!==null&&(W[U[1]]=decodeURIComponent(U[2]))}return W}const scriptRel="modulepreload",seen={},base="./",__vitePreload=function(B,N){return!N||N.length===0?B():Promise.all(N.map(W=>{if(W=`${base}${W}`,W in seen)return;seen[W]=!0;const U=W.endsWith(".css"),V=U?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${W}"]${V}`))return;const q=document.createElement("link");if(q.rel=U?"stylesheet":scriptRel,U||(q.as="script",q.crossOrigin=""),q.href=W,document.head.appendChild(q),U)return new Promise((H,X)=>{q.addEventListener("load",H),q.addEventListener("error",()=>X(new Error(`Unable to preload CSS for ${W}`)))})})).then(()=>B())};function __variableDynamicImportRuntime14__(l){switch(l){case"./components/charts/bar-chart.tsx":return __vitePreload(()=>import("./bar-chart.fd8f3e18.js"),["assets/bar-chart.fd8f3e18.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js","assets/index.esm.a8f02775.js"]);case"./components/charts/barline-chart.tsx":return __vitePreload(()=>import("./barline-chart.ee6914b8.js"),["assets/barline-chart.ee6914b8.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js","assets/index.esm.a8f02775.js"]);case"./components/charts/bubble-chart.tsx":return __vitePreload(()=>import("./bubble-chart.6950ae47.js"),["assets/bubble-chart.6950ae47.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js","assets/index.esm.a8f02775.js"]);case"./components/charts/doughnut-chart.tsx":return __vitePreload(()=>import("./doughnut-chart.656568fa.js"),["assets/doughnut-chart.656568fa.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js","assets/index.esm.a8f02775.js"]);case"./components/charts/line-chart.tsx":return __vitePreload(()=>import("./line-chart.1fab46c3.js"),["assets/line-chart.1fab46c3.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js","assets/index.esm.a8f02775.js"]);case"./components/charts/pie-chart.tsx":return __vitePreload(()=>import("./pie-chart.82792cc3.js"),["assets/pie-chart.82792cc3.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js","assets/index.esm.a8f02775.js"]);case"./components/charts/polar-area-chart.tsx":return __vitePreload(()=>import("./polar-area-chart.43b20a07.js"),["assets/polar-area-chart.43b20a07.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js","assets/index.esm.a8f02775.js"]);case"./components/charts/radar-chart.tsx":return __vitePreload(()=>import("./radar-chart.14741701.js"),["assets/radar-chart.14741701.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js","assets/index.esm.a8f02775.js"]);case"./components/charts/scatter-chart.tsx":return __vitePreload(()=>import("./scatter-chart.bf9aa8ce.js"),["assets/scatter-chart.bf9aa8ce.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js","assets/index.esm.a8f02775.js"]);default:return new Promise(function(B,N){(typeof queueMicrotask=="function"?queueMicrotask:setTimeout)(N.bind(null,new Error("Unknown variable dynamic import: "+l)))})}}function __variableDynamicImportRuntime13__(l){switch(l){case"./components/components/action-sheet-component.tsx":return __vitePreload(()=>import("./action-sheet-component.c1dd3eb6.js"),["assets/action-sheet-component.c1dd3eb6.js","assets/index.esm.6ceff79d.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js"]);case"./components/components/avatar-component.tsx":return __vitePreload(()=>import("./avatar-component.277ca0bd.js"),["assets/avatar-component.277ca0bd.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js"]);case"./components/components/badge-component.tsx":return __vitePreload(()=>import("./badge-component.e5dd5d4e.js"),["assets/badge-component.e5dd5d4e.js","assets/favorite.b6a94b10.js","assets/index.esm.4ee1c312.js","assets/index.esm.2b67923b.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js"]);case"./components/components/bottom-nav-component.tsx":return __vitePreload(()=>import("./bottom-nav-component.eb5210c3.js"),["assets/bottom-nav-component.eb5210c3.js","assets/favorite.b6a94b10.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js"]);case"./components/components/breadcrumb-component.tsx":return __vitePreload(()=>import("./breadcrumb-component.5d8d72ff.js"),["assets/breadcrumb-component.5d8d72ff.js","assets/people.ed55dedf.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js"]);case"./components/components/button-component.tsx":return __vitePreload(()=>import("./button-component.2b347b10.js"),["assets/button-component.2b347b10.js","assets/ac-unit-outlined.5e9729f1.js","assets/accessible-rounded.2e85c3c9.js","assets/add-ic-call-rounded.d598ec12.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js"]);case"./components/components/card-component.tsx":return __vitePreload(()=>import("./card-component.5a17c9a9.js"),["assets/card-component.5a17c9a9.js","assets/index.es.10968e38.js","assets/index.esm.50330381.js","assets/add-comment-rounded.696f5b69.js","assets/add-ic-call-rounded.d598ec12.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js"]);case"./components/components/cascader-component.tsx":return __vitePreload(()=>import("./cascader-component.fa0c79b3.js"),["assets/cascader-component.fa0c79b3.js","assets/index.es.515156af.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js"]);case"./components/components/checkbox-component.tsx":return __vitePreload(()=>import("./checkbox-component.0f239906.js"),["assets/checkbox-component.0f239906.js","assets/index.ee0cd57f.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js"]);case"./components/components/collapse-component.tsx":return __vitePreload(()=>import("./collapse-component.0b5492a6.js"),["assets/collapse-component.0b5492a6.js","assets/index.34194374.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/container.b374fd23.js"]);case"./components/components/color-picker-component.tsx":return __vitePreload(()=>import("./color-picker-component.297430a0.js"),["assets/color-picker-component.297430a0.js","assets/index.esm.71f4e586.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js"]);case"./components/components/dialog-component.tsx":return __vitePreload(()=>import("./dialog-component.179eeb55.js"),["assets/dialog-component.179eeb55.js","assets/index.esm.6ceff79d.js","assets/index.esm.d1a76b02.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js"]);case"./components/components/example-component.tsx":return __vitePreload(()=>import("./example-component.b3965ad1.js"),["assets/example-component.b3965ad1.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js"]);case"./components/components/hamburger-menu-component.tsx":return __vitePreload(()=>import("./hamburger-menu-component.e306e188.js"),["assets/hamburger-menu-component.e306e188.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js"]);case"./components/components/input-component.tsx":return __vitePreload(()=>import("./input-component.ad4a3876.js"),["assets/input-component.ad4a3876.js","assets/index.esm.22ff6d2e.js","assets/ac-unit-outlined.5e9729f1.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js"]);case"./components/components/link-component.tsx":return __vitePreload(()=>import("./link-component.eec7d9d8.js"),["assets/link-component.eec7d9d8.js","assets/index.esm.50330381.js","assets/ac-unit-outlined.5e9729f1.js","assets/accessible-rounded.2e85c3c9.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js"]);case"./components/components/loading-component.tsx":return __vitePreload(()=>import("./loading-component.f5e19edd.js"),["assets/loading-component.f5e19edd.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js"]);case"./components/components/pagination-component.tsx":return __vitePreload(()=>import("./pagination-component.cce6255f.js"),["assets/pagination-component.cce6255f.js","assets/index.esm.a9018448.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js"]);case"./components/components/progress-component.tsx":return __vitePreload(()=>import("./progress-component.9247f171.js"),["assets/progress-component.9247f171.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/masonry.e152cf79.js"]);case"./components/components/radio-component.tsx":return __vitePreload(()=>import("./radio-component.fb591f8f.js"),["assets/radio-component.fb591f8f.js","assets/index.esm.5bd81030.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js"]);case"./components/components/rate-component.tsx":return __vitePreload(()=>import("./rate-component.8b8b6072.js"),["assets/rate-component.8b8b6072.js","assets/index.esm.4ee1c312.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js"]);case"./components/components/slider-component.tsx":return __vitePreload(()=>import("./slider-component.f5a8d3c1.js"),["assets/slider-component.f5a8d3c1.js","assets/index.esm.22ff6d2e.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js"]);case"./components/components/switch-component.tsx":return __vitePreload(()=>import("./switch-component.fc7f4e6c.js"),["assets/switch-component.fc7f4e6c.js","assets/index.esm.2b67923b.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js"]);case"./components/components/tabs-component.tsx":return __vitePreload(()=>import("./tabs-component.1bb85f2f.js"),["assets/tabs-component.1bb85f2f.js","assets/ac-unit-outlined.5e9729f1.js","assets/accessible-rounded.2e85c3c9.js","assets/add-ic-call-rounded.d598ec12.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js"]);case"./components/components/tag-component.tsx":return __vitePreload(()=>import("./tag-component.84f375fe.js"),["assets/tag-component.84f375fe.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js"]);case"./components/components/time-picker-component.tsx":return __vitePreload(()=>import("./time-picker-component.8e6c9a77.js"),["assets/time-picker-component.8e6c9a77.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js"]);case"./components/components/toast-component.tsx":return __vitePreload(()=>import("./toast-component.a157a573.js"),["assets/toast-component.a157a573.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js"]);case"./components/components/toggle-icon-component.tsx":return __vitePreload(()=>import("./toggle-icon-component.a150fc17.js"),["assets/toggle-icon-component.a150fc17.js","assets/index.34194374.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/favorite.b6a94b10.js","assets/container.b374fd23.js"]);case"./components/components/tree-component.tsx":return __vitePreload(()=>import("./tree-component.0450feb8.js"),["assets/tree-component.0450feb8.js","assets/ac-unit-outlined.5e9729f1.js","assets/accessible-rounded.2e85c3c9.js","assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js","assets/index.34194374.js","assets/container.b374fd23.js"]);default:return new Promise(function(B,N){(typeof queueMicrotask=="function"?queueMicrotask:setTimeout)(N.bind(null,new Error("Unknown variable dynamic import: "+l)))})}}const components=["breadcrumb","bottom-nav","button","badge","cascader","color-picker","checkbox","hamburger-menu","tabs","slider","input","loading","link","toast","toggle-icon","card","radio","progress","pagination","time-picker","tag","tree","rate","dialog","avatar","action-sheet","switch","collapse"],charts=["bar","line","scatter","pie","doughnut","radar","polar-area","bubble","barline"];function registerRouting(l){route$1("/",()=>{l.update()}),route$1("/welcome",()=>{l.transitionTo("admin-main-welcome")}),route$1("/mobile",()=>{__vitePreload(()=>import("./mobile-show.623dce7e.js"),["assets/mobile-show.623dce7e.js","assets/mobile-show.6bce6f64.css"]).then(()=>l.transitionTo("mobile-show"))}),route$1("/table/basic",()=>{__vitePreload(()=>import("./basic-table.a29153a7.js"),["assets/basic-table.a29153a7.js","assets/index.af367a48.js","assets/index.ee0cd57f.js","assets/index.esm.22ff6d2e.js"]).then(()=>l.transitionTo("basic-table"))}),route$1("/basic-list",()=>{__vitePreload(()=>import("./basic-list.4eda98a1.js"),["assets/basic-list.4eda98a1.js","assets/index.af367a48.js","assets/index.ee0cd57f.js","assets/index.esm.22ff6d2e.js","assets/index.esm.a9018448.js","assets/index.esm.d1a76b02.js"]).then(()=>l.transitionTo("basic-list"))}),route$1("/dashboard",()=>{__vitePreload(()=>import("./admin-dashboard.52717192.js"),["assets/admin-dashboard.52717192.js","assets/people.ed55dedf.js","assets/index.af367a48.js","assets/index.ee0cd57f.js","assets/index.esm.22ff6d2e.js","assets/index.esm.a9018448.js"]).then(()=>l.transitionTo("admin-dashboard"))}),route$1("/md-editor",()=>{__vitePreload(()=>import("./md-editor.9b26acb1.js"),["assets/md-editor.9b26acb1.js","assets/md-editor.f29e0c00.css"]).then(()=>l.transitionTo("md-editor"))}),route$1("/table/edit",()=>{__vitePreload(()=>import("./inline-editing.7fdf4f4a.js"),["assets/inline-editing.7fdf4f4a.js","assets/index.af367a48.js","assets/index.ee0cd57f.js","assets/index.esm.22ff6d2e.js","assets/index.esm.a9018448.js"]).then(()=>l.transitionTo("inline-editing"))}),route$1("/docs/:name",B=>{const N=l.getMdByName(B.params.name,l.store.treeData);N&&N.then(W=>{l.payload={mdContent:W.default,padding:20},__vitePreload(()=>import("./admin-docs.62b78a46.js"),["assets/admin-docs.62b78a46.js","assets/admin-docs.c916457b.css","assets/___vite-browser-external_commonjs-proxy.dec1dc0a.js"]).then(()=>l.transitionTo("admin-docs"))})}),route$1("/table/pagination",()=>{__vitePreload(()=>import("./pagination-table.b9abcf62.js"),["assets/pagination-table.b9abcf62.js","assets/index.af367a48.js","assets/index.ee0cd57f.js","assets/index.esm.22ff6d2e.js","assets/index.esm.a9018448.js"]).then(()=>l.transitionTo("pagination-table"))}),route$1("/form",()=>{__vitePreload(()=>import("./admin-form.54706edd.js"),["assets/admin-form.54706edd.js","assets/index.esm.22ff6d2e.js","assets/index.esm.2b67923b.js","assets/index.esm.5bd81030.js","assets/index.ee0cd57f.js","assets/index.es.c36c03b3.js","assets/index.es.515156af.js"]).then(()=>l.transitionTo("admin-form"))}),route$1("/steps-form",()=>{__vitePreload(()=>import("./steps-form.f2ae7bfa.js"),["assets/steps-form.f2ae7bfa.js","assets/index.esm.22ff6d2e.js","assets/index.esm.2b67923b.js","assets/index.esm.5bd81030.js","assets/index.ee0cd57f.js","assets/index.es.c36c03b3.js","assets/index.es.515156af.js"]).then(()=>l.transitionTo("steps-form"))}),route$1("/comment",()=>{__vitePreload(()=>import("./admin-comment.2764870b.js"),["assets/admin-comment.2764870b.js","assets/admin-comment.38a7e410.css","assets/index.esm.22ff6d2e.js","assets/delete-outline.cf4fc376.js"]).then(()=>l.transitionTo("admin-comment"))}),route$1("/icon",()=>{__vitePreload(()=>import("./admin-icon.ab2616df.js"),[]).then(()=>l.transitionTo("admin-icon"))}),route$1("/error",()=>{__vitePreload(()=>import("./status-error.6bbaf6ae.js"),[]).then(()=>l.transitionTo("status-error"))}),components.map(B=>route$1(`/${B}-component`,()=>{__variableDynamicImportRuntime13__(`./components/components/${B}-component.tsx`).then(()=>l.transitionTo(`${B}-component`))})),charts.map(B=>route$1(`/${B}-chart`,()=>{__variableDynamicImportRuntime14__(`./components/charts/${B}-chart.tsx`).then(()=>l.transitionTo(`${B}-chart`))})),route$1("/mind-map",()=>{__vitePreload(()=>import("./mind-map.de0bc247.js"),[]).then(()=>l.transitionTo("mind-map"))}),route$1("/warning",()=>{__vitePreload(()=>import("./status-warning.b0995e0f.js"),[]).then(()=>l.transitionTo("status-warning"))}),route$1("/results/browser-incompatible",()=>{__vitePreload(()=>import("./browser-incompatible.dddde581.js"),[]).then(()=>l.transitionTo("browser-incompatible"))}),route$1("/success",()=>{__vitePreload(()=>import("./admin-success.4cd9d6b8.js"),[]).then(()=>l.transitionTo("admin-success"))}),route$1("/failure",()=>{__vitePreload(()=>import("./admin-failure.0545e158.js"),[]).then(()=>l.transitionTo("admin-failure"))}),route$1("/results/network-error",()=>{__vitePreload(()=>import("./network-error.1a33e1f6.js"),[]).then(()=>l.transitionTo("network-error"))}),route$1("/results/not-found",()=>{__vitePreload(()=>import("./not-found.a51ea0f8.js"),[]).then(()=>l.transitionTo("not-found"))}),route$1("/results/permission-denied",()=>{__vitePreload(()=>import("./permission-denied.0c4d2efa.js"),[]).then(()=>l.transitionTo("permission-denied"))}),route$1("/results/server-error",()=>{__vitePreload(()=>import("./server-error.c99ac235.js"),[]).then(()=>l.transitionTo("server-error"))}),route$1("/masonry-list",()=>{__vitePreload(()=>import("./masonry-list.600a0d6e.js"),["assets/masonry-list.600a0d6e.js","assets/index.es.10968e38.js","assets/index.esm.50330381.js","assets/add-comment-rounded.696f5b69.js","assets/add-ic-call-rounded.d598ec12.js","assets/masonry.e152cf79.js"]).then(()=>l.transitionTo("masonry-list"))}),route$1("/notification-list",()=>{__vitePreload(()=>import("./notification-list.e62656e4.js"),["assets/notification-list.e62656e4.js","assets/index.af367a48.js","assets/index.ee0cd57f.js","assets/index.esm.22ff6d2e.js","assets/index.esm.a9018448.js","assets/delete-outline.cf4fc376.js","assets/chat-outlined.c05a23b4.js"]).then(()=>l.transitionTo("notification-list"))}),route$1("/personal-center",()=>{__vitePreload(()=>import("./personal-center.62bae5b3.js"),["assets/personal-center.62bae5b3.js","assets/index.es.10968e38.js","assets/index.esm.50330381.js","assets/chat-outlined.c05a23b4.js"]).then(()=>l.transitionTo("personal-center"))}),route$1("*",function(){console.log("not found")})}/*! *****************************************************************************
