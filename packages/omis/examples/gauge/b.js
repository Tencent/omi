(function () {
	...
	*/
	...
	var Gauge = function Gauge(props, _ref) {
			var data = _ref.data;

			var getPathValues = function getPathValues(value) {
					var dx = 0;
					var dy = 0;
			...
			return Omis.h(
					...
					Omis.h(
							"svg",
							{ height: "100%", version: "1.1", width: "100%", xmlns: "http://www.w3.org/2000/svg", style: { width: data.width, height: data.height, overflow: 'hidden', position: 'relative', left: 0, top: 0, maxWidth: '100%' } },
							Omis.h("path", { fill: data.backgroundColor, stroke: "none", d: getPath(data.max) }),
							Omis.h("path", { fill: data.color, stroke: "none", d: getPath(data.value) }),
							Omis.h(
									"text",
									{ x: data.width / 2, y: data.height / 5 * 3.5, "text-anchor": "middle", fill: data.color, style: { fontSize: data.valueFontSize, fontWeight: 400, fontFamily: 'Lato' } },
									data.value / data.max * 100,
									"%"
							),
							Omis.h(
									"text",
									{ x: data.width / 2, y: data.height / 5 * 4, "text-anchor": "middle", fill: data.color, style: { fontSize: data.labelFontSize } },
									data.label
							)
					)
			);
