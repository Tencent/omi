  ...
  return (
    <div class="flex items-center justify-center" style="height:calc(100vh - 58px)">
      <div class="p-8  text-center">
        <div class="mb-4 text-zinc-600 dark:text-foreground">
        ...
        <h2 class="text-2xl font-bold mb-2 text-zinc-700 dark:text-foreground">创建失败</h2>

        <p class="text-zinc-600 mb-6 dark:text-foreground">
