...
!(function(e) {
  ...
  function l(e, t, i, a) {
    ...
    function d() {
      let e = 'string' == typeof E.sL
      if (e && !x[E.sL]) return n(B)
      let t = e ? l(E.sL, B, !0, L[E.sL]) : f(B, E.sL.length ? E.sL : void 0)
      return (
        E.r > 0 && (M += t.r),
        e && (L[E.sL] = t.top),
  ...
  return (
    ...
    (e.C = function(n, t, r) {
      let i = e.inherit({ cN: 'comment', b: n, e: t, c: [] }, r || {})
      return (
        i.c.push(e.PWM),
