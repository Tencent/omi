...
const mpOption = const mpOption = const mpOption = const mpOption = const mpOption = const mpOption = const mpOption = const mpOption = const mpOption = const mpOption = const mpOption = Component({
  /**
   * 组件的属性列表
   */
  properties: {
