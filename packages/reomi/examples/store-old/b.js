(function () {
  ...
  define('todo-app', function (_WeElement2) {
    ...
    _class3.prototype.render = function render$$1(props, data, store) {
      return Omi.h(
        'div',
        null,
        Omi.h(
        ...
        Omi.h(
          ...
          Omi.h('input', { id: 'new-todo', onChange: this.handleChange, value: store.data.text }),
          Omi.h(
            'button',
            null,
            'Add #',
