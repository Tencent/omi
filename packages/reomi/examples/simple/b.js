  ...
  */
  ...
  define('my-app', (_temp2 = _class$2 = function (_WeElement) {
    ...
    function _class() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn$4(this, _WeElement.call.apply(_WeElement, [this].concat(args))), _this), _this.name = 'Reomi', _this.onClick = function () {
