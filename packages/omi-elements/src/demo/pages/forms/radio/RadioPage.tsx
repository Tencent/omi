...
export default class RadioPage extends Component {
  ...
  render() {
    return (
      <div className="container my-12 !max-w-full">
        ...
        <p className="mb-3">
          Radio buttons are most commonly used when you have a group of mutually exclusive choices and only one choice
          from that group is allowed.
        </p>
        <code-showcase
  ...
  <div>
    ...
    <div className="mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem]">
      ...
      <label className="mt-px inline-block pl-[0.15rem] hover:cursor-pointer" htmlFor="radioDefault02">
        ...
        <p className="mb-3">
          Use <code>disabled</code> attribute to both the <code>label</code> and the
          <code>input</code> to disable radio buttons component.
        </p>
        <code-showcase
          code={`<div className="flex justify-center">
  <div>
    ...
    <div className="mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem]">
      ...
      >
        ...
        <p className="mb-3">
          Group radios in the same horizontal row by adding <code>flex</code> class for parent container.
        </p>
        <code-showcase
          code={`<div className="flex justify-center">
  {
  ...
  <div className="mb-[0.125rem] mr-4 inline-block min-h-[1.5rem] pl-[1.5rem]">
    <input
      ...
      value="option1"
    />
    <label className="mt-px inline-block pl-[0.15rem] hover:cursor-pointer" htmlFor="inlineRadio1">
      1
    </label>
  </div>
  {
  ...
  <div className="mb-[0.125rem] mr-4 inline-block min-h-[1.5rem] pl-[1.5rem]">
    <input
      ...
      value="option2"
    />
    <label className="mt-px inline-block pl-[0.15rem] hover:cursor-pointer" htmlFor="inlineRadio2">
      2
    </label>
  </div>
  {
