import { ButtonWithRipple } from './examples/ButtonWithRipple'
import { ButtonLinkExample } from './examples/ButtonLinkExample'
import { ButtonOutline } from './examples/ButtonOutline'
import { ButtonRoundedOutline } from './examples/ButtonRoundedOutline'
import { ButtonFloating } from './examples/ButtonFloating'
import { ButtonWithIcon } from './examples/ButtonWithIcon'
import { ButtonBlock } from './examples/ButtonBlock'
import '@/components/code-showcase'

import ButtonWithRippleCode from './examples/ButtonWithRipple?raw'
import ButtonLinkExampleCode from './examples/ButtonLinkExample?raw'
import ButtonOutlineCode from './examples/ButtonOutline?raw'
import ButtonRoundedOutlineCode from './examples/ButtonRoundedOutline?raw'
import ButtonFloatingCode from './examples/ButtonFloating?raw'
import ButtonWithIconCode from './examples/ButtonWithIcon?raw'
import ButtonBlockCode from './examples/ButtonBlock?raw'
...
>
  Button
        ...
        <section>
          ...
          {/* <!-- Description --> */}
          <p className="mb-3">
            Use the ripple effect and provide feedback to users in a simple and elegant way in the form of a wave
            animation. It also changes position depending on where each button is clicked.
          </p>
          <code-showcase code={ButtonWithRippleCode}>
            <ButtonWithRipple.tagName />
          </code-showcase>
        </section>
        {/* <!-- Section: With ripple --> */}
        ...
        <section>
          ...
          {/* <!-- Description --> */}
          <p className="mb-3">
            Buttons, as one of the key UI elements, must have their own hierarchy. This means that the user should be
            able to easily identify which button is the most important (primary button), which is less important
            (secondary button) and which presents completely additional information (tertiary button).
          </p>

          <p className="mb-3">
            Elements with strong, filled backgrounds and shadows attract attention the most, which is why{' '}
            <strong>button primary</strong> is built in this way.
          </p>

          <p className="mb-3">
            A delicate background without shadows is less engaging, so it is well suited for{' '}
            <strong>button secondary</strong>.
          </p>

          <p className="mb-3">
            The lack of background and shadow makes the element the least visible. These features characterize the
            <strong>button tertiary</strong>.
          </p>

          <p className="mb-3">
            <strong>Note:</strong> Button tertiary may require additional margins. Without extra margins, the button
            edge will be flush with adjacent elements (which is sometimes the desired result). If you need margin -
            simply add margin utility classes like <code>mx-2</code>.
          </p>
  ...
  >
    Tetriary
        ...
        <section>
          ...
          {/* <!-- Description --> */}
          <p className="mb-3">
            Tailwind Elements includes several predefined button styles, each serving its own semantic purpose.
          </p>
  ...
  >
    Info
        ...
        <section>
          {/* <!-- Title --> */}
          <h2 className="mb-5 mt-0 text-3xl font-semibold leading-normal" id="neutral" data-te-spy-item>
            Neutral
          </h2>
          {/* <!-- Description --> */}
          <p className="mb-3">Neutral buttons provide additional light and dark colors.</p>
  ...
  >
    Dark
        ...
        <section>
          {/* <!-- Title --> */}
          <h2 className="mb-5 mt-0 text-3xl font-semibold leading-normal" id="link" data-te-spy-item>
            Link
          </h2>
          {/* <!-- Description --> */}
          <p className="mb-3">
            Link button is similar to the tertiary button (and often is used as a substitute). The difference is, that
            the link button has a background on hover and also has a default padding.
          </p>
        ...
        <section>
          ...
          {/* <!-- Description --> */}
          <p className="mb-3">Use the following button styles to show the colors only for the border of the element.</p>
          <code-showcase code={ButtonOutlineCode}>
            <ButtonOutline.tagName />
          </code-showcase>
        </section>
        {/* <!-- Section: Outline --> */}
        ...
        <section>
          ...
          {/* <!-- Description --> */}
          <p className="mb-3">
            Use elements rounded corners with the <code>.rounded-full</code> property.
          </p>
  ...
  <div className="space-y-2 space-x-2">
    ...
    >
      Dark
        ...
        <section>
          {/* <!-- Title --> */}
          <h2 className="mb-5 mt-0 text-3xl font-semibold leading-normal" id="rounded_outline" data-te-spy-item>
            Rounded outline
          </h2>
          {/* <!-- Description --> */}
          <p className="mb-3">
            Use the border styles with <code>.rounded-full</code> class.
          </p>

          <code-showcase code={ButtonRoundedOutlineCode}>
            <ButtonRoundedOutline.tagName />
          </code-showcase>
        </section>
        {/* <!-- Section: Rounded Outline --> */}
        ...
        <section>
          ...
          {/* <!-- Description --> */}
          <p className="mb-3">
            Use floating action button that represents the primary action in an application. It's button that appears in
            front of all screen content, typically as a circular shape with an icon in its center.
          </p>
          <code-showcase code={ButtonFloatingCode}>
            <ButtonFloating.tagName />
          </code-showcase>
        </section>
        {/* <!-- Section: Floating --> */}
        ...
        <section>
          ...
          {/* <!-- Description --> */}
          <p className="mb-3">See the live example of a fixed button in the bottom right corner of this page.</p>
          <code-showcase
            code={`<div className="group fixed bottom-10 right-10 z-10 flex h-14 w-14 items-center justify-center rounded-full bg-danger-600 uppercase leading-normal text-white">
<a href="#" className="cursor-pointer rounded-full p-5">
  <svg
...
<ul className="absolute z-0 flex translate-y-full flex-col items-center justify-center opacity-0 transition-all duration-500 ease-in-out group-hover:-translate-y-[60%] group-hover:opacity-100">
  ...
  <li>
    <div className="mx-5 mb-10 flex h-12 w-12 cursor-pointer items-center justify-center rounded-full bg-primary-600 shadow-md hover:shadow-lg">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        viewBox="0 0 24 24"
      ...
      >
        ...
        <section>
          ...
          {/* <!-- Description --> */}
          <p className="mb-3">Use these examples if you want to use smaller or larger buttons.</p>
...
`}
          >
            <div className="flex flex-wrap items-end justify-center space-x-1">
              <div className="space-y-2 space-x-2">
                <button
                  type="button"
                  className="inline-block rounded bg-primary px-4 pb-[5px] pt-[6px] text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(59,113,202,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)]"
  ...
  >
    Secondary
        ...
        <section>
          ...
          {/* <!-- Description --> */}
          <p className="mb-3">
            Use the following styles to indicate a disabled button. This can be often used inside form elements to
            disable the submit button before all the form elements have been completed and validated.
          </p>
          <code-showcase
            code={`
  <>
    ...
    <button
      type="button"
      className="pointer-events-none inline-block rounded bg-primary-accent-100 px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-primary-700 transition duration-150 ease-in-out hover:bg-primary-accent-100 focus:bg-primary-accent-100 focus:outline-none focus:ring-0 active:bg-primary-accent-200 disabled:opacity-70"
      disabled
    >
      Secondary
    </button>
        ...
        <section>
          ...
          {/* <!-- Description --> */}
          <p className="mb-3">Use the icon inside the button to more clearly indicate the action.</p>

          <code-showcase code={ButtonWithIconCode}>
            <ButtonWithIcon.tagName />
          </code-showcase>
        </section>
        {/* <!-- Section: With Icon --> */}
        ...
        <section>
          ...
          {/* <!-- Description --> */}
          <p className="mb-3">
            Use full width button to adjust it to the column width. Block buttons is more often used when creating
            layout for mobile devices.
          </p>
          <code-showcase code={ButtonBlockCode}>
            <ButtonBlock.tagName />
          </code-showcase>
        </section>
        {/* <!-- Section: Block buttons --> */}
