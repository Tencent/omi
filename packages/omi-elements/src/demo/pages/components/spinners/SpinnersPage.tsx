...
@tag('spinners-page')
export class SpinnersPage extends Component {
  static css = [tailwind]
  ...
  >
    <span className="!absolute !-m-px !h-px !w-px !overflow-hidden !whitespace-nowrap !border-0 !p-0 ![clip:rect(0,0,0,0)]">
      Loading...
        ...
        <h2 className="mb-5 mt-0 text-3xl font-semibold leading-normal">Growing spinner</h2>
...
>
  <span className="!absolute !-m-px !h-px !w-px !overflow-hidden !whitespace-nowrap !border-0 !p-0 ![clip:rect(0,0,0,0)]">
    Loading...
        ...
        <h2 className="mb-5 mt-0 text-3xl font-semibold leading-normal">Colors of growing spinner</h2>
  ...
  >
    <span className="!absolute !-m-px !h-px !w-px !overflow-hidden !whitespace-nowrap !border-0 !p-0 ![clip:rect(0,0,0,0)]">
      Loading...
        ...
        <h2 className="mb-5 mt-0 text-3xl font-semibold leading-normal">Margin</h2>
...
>
  <span className="!absolute !-m-px !h-px !w-px !overflow-hidden !whitespace-nowrap !border-0 !p-0 ![clip:rect(0,0,0,0)]">
    Loading...
        ...
        <h2 className="mb-5 mt-0 text-3xl font-semibold leading-normal">Flex</h2>
...
>
  <span className="!absolute !-m-px !h-px !w-px !overflow-hidden !whitespace-nowrap !border-0 !p-0 ![clip:rect(0,0,0,0)]">
    Loading...
        ...
        <h2 className="mb-5 mt-0 text-3xl font-semibold leading-normal">Floats</h2>
...
>
  ...
  ></div>
        ...
        <h2 className="mb-5 mt-0 text-3xl font-semibold leading-normal">Size small</h2>
  ...
  >
    <span className="!absolute !-m-px !h-px !w-px !overflow-hidden !whitespace-nowrap !border-0 !p-0 ![clip:rect(0,0,0,0)]">
      Loading...
        ...
        <h2 className="mb-5 mt-0 text-3xl font-semibold leading-normal">Size large</h2>
...
;<code-showcase code={``}></code-showcase>
