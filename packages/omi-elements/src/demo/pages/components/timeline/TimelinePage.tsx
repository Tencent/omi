...
<code-showcase code={`<ol className="border-l border-neutral-300 dark:border-neutral-500">
  {/* <!--First item--> */}
  <li>
...
</ol>`}><ol className="border-l border-neutral-300 dark:border-neutral-500">
            {/* <!--First item--> */}
            <li>
              <div className="flex-start flex items-center pt-3">
                <div className="-ml-[5px] mr-3 h-[9px] w-[9px] rounded-full bg-neutral-300 dark:bg-neutral-500"></div>
...
<code-showcase code={`<ol className="border-l border-neutral-300 dark:border-neutral-500 md:flex md:justify-center md:gap-6 md:border-l-0 md:border-t">
  {/* <!--First item--> */}
  <li>
    ...
    <div className="ml-4 mt-2 pb-5 md:ml-0">
      ...
      <p className="mb-3 text-neutral-500 dark:text-neutral-300">
...
</ol>`}><ol className="border-l border-neutral-300 dark:border-neutral-500 md:flex md:justify-center md:gap-6 md:border-l-0 md:border-t">
            {/* <!--First item--> */}
            <li>
              <div className="flex-start flex items-center pt-2 md:block md:pt-0">
                <div className="-ml-[5px] mr-3 h-[9px] w-[9px] rounded-full bg-neutral-300 dark:bg-neutral-500 md:-mt-[5px] md:ml-0 md:mr-0"></div>
        ...
        <section>
          ...
          <code-showcase code={TimelinePrimaryColorCode}><TimelinePrimaryColor.tagName /></code-showcase>
        ...
        <section>
          ...
          <code-showcase code={TimelineIconsCode}><TimelineIcons.tagName /></code-showcase>
