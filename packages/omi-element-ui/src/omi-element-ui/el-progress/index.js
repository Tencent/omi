...
class ElProgress extends WeElement {
  ...
  render(props, data) {
    ...
    if (data.success) {
      text = <i class="el-icon-circle-check" />
    }
    if (data.error) {
      text = <i class="el-icon-circle-close" />
    }
    let innerText = ''
    if (props.textInside) {
      innerText = (
        <div class="el-progress-bar__innerText">{data.percentage + '%'}</div>
      )
    }
    ...
    return (
      <div
        ...
        class={`el-progress el-progress--line${
          data.success ? ' is-success' : ''
        }${data.error ? ' is-exception' : ''}${
      ...
      >
        <div class="el-progress-bar">
          <div
            ...
            style={`height:${props.strokeWidth || 6}px`}
          >
  ...
  renderCircel(props, data) {
    ...
    this.relativeStrokeWidth = ((this.strokeWidth / this.width) * 100).toFixed(
      1
    )
        ...
        <div class="el-progress-circle" style="height: 126px; width: 126px;">
          <svg viewBox="0 0 100 100">
            ...
            <path
              ...
              style={`stroke-dasharray:${this.perimeter}px,${
                this.perimeter
              }px; stroke-dashoffset: ${(1 - this.data.percentage / 100) *
                this
                  .perimeter}px; transition: stroke-dashoffset 0.6s ease 0s, stroke 0.6s ease 0s;`}
            />
          </svg>
        </div>
