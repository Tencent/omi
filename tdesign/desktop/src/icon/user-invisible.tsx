...
export default class UserInvisible extends WeElement<IconProps> {
  ...
  render(props: OmiProps<IconProps>) {
    ...
    return (
      ...
      >
        <path d="M11.5 2C8.46243 2 6 4.46243 6 7.5C6 10.5376 8.46243 13 11.5 13C14.5376 13 17 10.5376 17 7.5C17 4.46243 14.5376 2 11.5 2ZM8 7.5C8 5.567 9.567 4 11.5 4C13.433 4 15 5.567 15 7.5C15 9.433 13.433 11 11.5 11C9.567 11 8 9.433 8 7.5Z" />
        <path d="M4 20C4 17.7909 5.79086 16 8 16H11V14H8C4.68629 14 2 16.6863 2 20V22H11.05V20H4Z" />
