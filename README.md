...
| ----------------------------------------- | ------------------ |-----------------|
|[Snake-Eating Game Making with Web Components of Omi and MVP Architecture](https://github.com/Tencent/omi/blob/master/tutorial/omi-web-components-snake-game.md)|||
