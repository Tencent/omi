...
/***/ function(module, exports, __webpack_require__) {
	...
	var _head = __webpack_require__(45);
...
/***/ function(module, exports) {
	...
	var config = {
	    ...
	    menus: {
	        cn: [{ title: '快速开始', list: [{ 'name': '安装', md: 'installation' }, { 'name': 'Hello World', md: 'hello_world' }, { 'name': '组件', md: 'components' }, { 'name': '组件通讯', md: 'communication' }, { 'name': '生命周期', md: 'lifecycle' }, { 'name': '事件处理', md: 'events' }, { 'name': '条件判断', md: 'condition' }, { 'name': '循环遍历', md: 'loop' }, { 'name': '表单', md: 'form' }, { 'name': '继承', md: 'inherit' },
	            //{'name': '容器系统'},
	            { 'name': '模板切换', md: 'template' }, { 'name': '获取DOM节点', md: 'get_dom' }, { 'name': '插件体系', md: 'thinking_in_omi' },
	            //{'name': '服务器端渲染'},
	            { 'name': 'Omi的理念' }] }, { title: 'Omi原理', list: [{ 'name': '环境搭建', md: 'pr_env' }, { 'name': 'Hello Omi', md: 'pr_hello' }, { 'name': '未完待续..', md: 'pr_hello' }, { 'name': '...' }] }],
	        en: [{ title: 'QUICK START', list: [{ 'name': 'Installation', md: 'installation' }, { 'name': 'Hello World', md: 'hello_world' }, { 'name': 'Components', md: 'components' }, { 'name': 'Communication', md: 'communication' }, { 'name': 'Lifecycle', md: 'lifecycle' }, { 'name': 'Handling Events', md: 'events' }, { 'name': 'Conditional Rendering', md: 'condition' }, { 'name': 'Loop', md: 'loop' },
	            //{'name': 'Lists and Keys'},
	            { 'name': 'Forms', md: 'form' }, { 'name': 'Inheritance', md: 'inherit' }, { 'name': 'Templates', md: 'template' }, { 'name': 'Get DOM', md: 'get_dom' }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		...
		"./en_form.md": 35,
		"./en_get_dom.md": 36,
		"./en_hello_world.md": 37,
		"./en_inherit.md": 38,
		"./en_installation.md": 39,
		"./en_lifecycle.md": 40,
		"./en_loop.md": 41,
		"./en_template.md": 42
	};
	...
	var List = function (_Omi$Component) {
	    ...
	    _createClass(List, [{
	        ...
	        value: function goto(name) {
	            _index2['default'].get('content').data.name = name;
	            _index2['default'].get('content').update();
	        }
	    }, {
	        key: 'render',
	        value: function render() {
