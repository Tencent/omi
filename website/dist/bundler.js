...
/***/ function(module, exports) {
	...
	var config = {
	    ...
	    menus: {
	        ...
	        en: [{ title: "QUICK START", list: [{ "name": "Installation" }, { "name": "Hello World" }, { "name": "Components" }, { "name": "Communication" }, { "name": "Lifecycle" }, { "name": "Handling Events" }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		...
		"./cn_pr_hello.md": 27,
		"./cn_template.md": 28,
		"./cn_thinking_in_omi.md": 29,
		"./en_communication.md": 30,
		"./en_components.md": 31,
		"./en_events.md": 32,
		"./en_hello_world.md": 33,
		"./en_installation.md": 34,
		"./en_lifecycle.md": 35
	};
