	    ...
	    _createClass(Frame, [{
	        ...
	        value: function install() {
	            ...
	            window.onresize = function () {
	                _this2.data.width = window.innerWidth - 300;
	                _this2.update();
	            };
	        }
	    }, {
	        ...
	        value: function highlightBlock(lh) {
	            ...
	            //1,5-6,8
	            var mapping = { 3: '6', 6: '5', 9: '3,36', 14: '22', 17: '6-12' };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		...
		"./cn_condition.md": 12,
		"./cn_events.md": 13,
		"./cn_hello_world.md": 14,
		"./cn_installation.md": 15,
		"./cn_lifecycle.md": 16,
		"./cn_template.md": 23,
		"./cn_thinking_in_omi.md": 17,
		"./en_hello_world.md": 18,
		"./en_installation.md": 19
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Sidebar = function (_Omi$Component) {
	    ...
	    _createClass(Sidebar, [{
	        ...
	        value: function install() {
	            if (this.data.lan === "cn") {
	                this.data.items = [{ title: "快速开始", list: [{ "name": "安装" }, { "name": "Hello World" }, { "name": "组件" }, { "name": "生命周期" }, { "name": "事件处理" }, { "name": "条件判断" }, { "name": "数组列表" }, { "name": "表单" }, { "name": "继承" }, { "name": "容器系统" }, { "name": "模板切换" }, { "name": "服务器端渲染" }, { "name": "Omi的理念" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "AasfsfasBC", list: [{ "name": "aaa" }, { "name": "ddd" }] }];
	            } else {
	                this.data.items = [{ title: "QUICK START", list: [{ "name": "Installation" }, { "name": "Hello World" }, { "name": "Components" }, { "name": "Lifecycle" }, { "name": "Handling Events" }, { "name": "Conditional Rendering" }, { "name": "Lists and Keys" }, { "name": "Forms" }, { "name": "Inheritance" }, { "name": "Sever-side Rendering" }, { "name": "Thinking In Omi" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "ABC", list: [{ "name": "aaa" }, { "name": "cccdd" }] }, { title: "AasfsfasBC", list: [{ "name": "aaa" }, { "name": "ddd" }] }];
	            }
...
/***/ function(module, exports) {
	...
	module.exports = "module.exports = \"![Omi](./asset/omi.png)\\r\\n\\r\\nOpen and modern framework for building user interfaces.\\r\\n\\r\\n## Omiʹ���ĵ�\\r\\n\\r\\n### ����\\r\\n* [��װ](./website/cn_installation.md)\\r\\n* [Hello World](./website/cn_hello_world.md)\\r\\n* [����](./docs/cn_components.md)\\r\\n* [��������](./docs/cn_lifecycle.md)\\r\\n* [�¼�����](./docs/cn_events.md)\\r\\n* [�����ж�](./docs/cn_condition.md)\\r\\n* [�����б�](./docs/cn_array.md)\\r\\n* [����](./docs/cn_form.md)\\r\\n* [�̳�](./docs/cn_inherit.md)\\r\\n* [����ϵͳ](./docs/cn_ctn.md)\\r\\n* [ģ���л�](./docs/cn_template.md)\\r\\n* [����������Ⱦ](./docs/cn_server_rendering.md)\\r\\n* [Omi����](./docs/cn_thinking_in_omi.md)\\r\\n\\r\\n### Omi��ԭ������\\r\\n\\r\\n* [�ֲ�CSS����](./docs/cn_ex_scoped_css.md)\\r\\n* [����Ƕ�׽���](./docs/cn_ex_scoped_css.md)\\r\\n* [�¼���������](./docs/cn_ex_scoped_css.md)\\r\\n* [����������Ⱦ����](./docs/cn_server_rendering.md)\\r\\n* [ģ���л�����](./docs/cn_template.md)\\r\\n* [����ϵͳ����](./docs/cn_ctn.md)\""
