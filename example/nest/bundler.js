    ...
    _createClass(App, [{
        ...
        value: function render() {
            ...
            return _index2['default'].x(
                'div',
                { aaa: true, className: 'MarkdownEditor', onClick: function onClick(event) {
                ...
                _index2['default'].x('div', {
                    className: 'content',
                    dangerouslySetInnerHTML: this.getRawMarkup()
                }),
                _index2['default'].x(_hello2['default'], { aa: 'bb' }),
                _index2['default'].x(
                    'ul',
                    null,
...
_index2['default'].render(_index2['default'].x(App, null), 'body');
...
var _sub_hello = __webpack_require__(13);
    ...
    _createClass(Hello, [{
        ...
        value: function render() {
            return _index2['default'].x(
                ...
                null,
                ' Hello Omi!',
                _index2['default'].x(_sub_hello2['default'], null)
            );
        }
    }]);
