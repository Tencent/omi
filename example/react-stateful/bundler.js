...
var Timer = function (_Omi$Component) {
  _inherits(Timer, _Omi$Component);

  function Timer(data) {
    _classCallCheck(this, Timer);

    var _this = _possibleConstructorReturn(this, (Timer.__proto__ || Object.getPrototypeOf(Timer)).call(this, data));
...
_index2['default'].render(_index2['default'].x(Timer, null), 'body');
