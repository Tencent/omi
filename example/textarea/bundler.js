...
/***/ function(module, exports, __webpack_require__) {
	...
	_index2['default'].makeHTML('List', List);

	var Todo = function (_Omi$Component2) {
	    _inherits(Todo, _Omi$Component2);

	    function Todo(data) {
	        _classCallCheck(this, Todo);

	        var _this2 = _possibleConstructorReturn(this, (Todo.__proto__ || Object.getPrototypeOf(Todo)).call(this, data));

	        _this2.data.length = _this2.data.items.length;
	        _this2.childrenData = [{ items: _this2.data.items }];
	        return _this2;
	    }
	...
	_index2['default'].render(new Todo({ items: ['Omi', 'dntzhang', 'AlloyTeam'], text: '' }), '#container');
