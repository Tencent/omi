...
var MarkdownEditor = function (_Omi$Component) {
  _inherits(MarkdownEditor, _Omi$Component);

  function MarkdownEditor(data) {
    _classCallCheck(this, MarkdownEditor);

    var _this = _possibleConstructorReturn(this, (MarkdownEditor.__proto__ || Object.getPrototypeOf(MarkdownEditor)).call(this, data));

    _this.handleChange = _this.handleChange.bind(_this);
    _this.md = new Remarkable();
    _this.data = { value: 'Hello, **world**!', html: _this.md.render(_this.data.value) };
    return _this;
  }
...
_index2['default'].render(_index2['default'].x(MarkdownEditor, null), 'body');
