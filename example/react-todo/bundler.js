  ...
  _createClass(TodoApp, [{
    ...
    value: function render() {
      return _index2['default'].x(
        ...
        _index2['default'].x(TodoList, { items: this.data.items }),
        _index2['default'].x(
          'form',
...
var TodoList = function (_Omi$Component2) {
  _inherits(TodoList, _Omi$Component2);
...
_index2['default'].render(_index2['default'].x(TodoApp, null), 'body');
