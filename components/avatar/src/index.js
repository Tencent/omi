(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["OAvatar"] = factory(require("omi"));
	else
		root["OAvatar"] = factory(root["Omi"]);
...
var Avatar = /** @class */ (function (_super) {
    ...
    Avatar.prototype.render = function (props) {
        ...
        return (omi_1.h("div", __assign({}, omi_1.extractClass(props, 'm-avatar', {
            ...
            } }), props.icon ? omi_1.h(this._iconTag, { class: "material-icons mdc-icon-button__icon", style: { lineHeight: (props.size + 6) + 'px', color: props.color } }) : (props.src ?
            omi_1.h("img", { alt: props.alt, src: props.src }) :
            props.children ? props.children : omi_1.h("slot", null))));
    };
    Avatar.css = css;
    Avatar.defaultProps = {
        size: 40,
