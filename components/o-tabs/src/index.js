...
var Tabs = /** @class */ (function (_super) {
    ...
    Tabs.prototype.render = function (props) {
        var _this = this;
        return (omi_1.h("div", { class: "el-tabs el-tabs--top" },
            omi_1.h("div", { class: "el-tabs__header is-top" },
                omi_1.h("div", { class: "el-tabs__nav-wrap is-top" },
                    omi_1.h("div", { class: "el-tabs__nav-scroll" },
                        omi_1.h("div", { role: "tablist", class: "el-tabs__nav is-top", style: "transform: translateX(0px);" },
                            omi_1.h("div", { class: "el-tabs__active-bar is-top", style: "width: " + this._width + "px; transform: translateX(" + this._x + "px);" }),
                            props.list.map(function (tab, index) {
                                return omi_1.h("div", __assign({ ref: function (e) { _this['$tab' + index] = e; }, role: "tab", onClick: function (evt) { return _this.onTabClick(evt, index); }, tabindex: props.active === index ? '0' : -1 }, omi_1.extractClass(props, 'el-tabs__item', {
                                    'is-top': true,
