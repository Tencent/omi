(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["OBottomNav"] = factory(require("omi"));
	else
		root["OBottomNav"] = factory(root["Omi"]);
...
var BottomNav = /** @class */ (function (_super) {
    ...
    BottomNav.prototype.render = function (props) {
        var _this = this;
        return omi_1.h("div", { class: "o-bottom-nav" }, props.items.map(function (item, index) {
            _this._iconTag = 'o-icon-' + item.icon;
            return omi_1.h("button", __assign({ onClick: function (_) { _this.clickHandler(item); } }, omi_1.extractClass({}, 'item', {
