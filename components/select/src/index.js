...
var resize_event_1 = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module './resize-event'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
var Select = /** @class */ (function (_super) {
    ...
    Select.prototype.installed = function () {
        this.resetSize();
        resize_event_1.addResizeListener(this._refInput, this.resetSize);
    };
    Select.prototype.uninstall = function () {
        resize_event_1.removeResizeListener(this._refInput, this.resetSize);
    };
