...
var OSlider = /** @class */ (function (_super) {
    ...
    OSlider.prototype.render = function (props) {
        ...
        return (omi_1.h("div", __assign({}, cls, { ref: function (e) {
            ...
            omi_1.h("input", { class: "o-slider", type: "range", min: props.min, max: props.max, value: this.props.value, onInput: this.handleSliderOne, id: "slider-1", ref: function (e) {
                    _this.sliderOne = e;
                } }),
            this.props.range === 'double' && (omi_1.h("input", { class: "o-slider", type: "range", min: props.min, max: props.max, value: this.props.second_value, onInput: this.handleSliderTwo, id: "slider-2", ref: function (e) {
                    _this.sliderTwo = e;
                } })),
