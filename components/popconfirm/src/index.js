...
`;
    ...
    Button.prototype.render = function (props) {
      var _a;
      return omi.h("button", __assign({ disabled: props.disabled }, omi.extractClass(props, 'o-button', (_a = {},
        ...
        props.loading && [omi.h("svg", { class: "loading", viewBox: "0 0 1024 1024", focusable: "false", "data-icon": "loading", width: "1em", height: "1em", fill: "currentColor", "aria-hidden": "true" },
          omi.h("path", { d: "M988 548c-19.9 0-36-16.1-36-36 0-59.4-11.6-117-34.6-171.3a440.45 440.45 0 00-94.3-139.9 437.71 437.71 0 00-139.9-94.3C629 83.6 571.4 72 512 72c-19.9 0-36-16.1-36-36s16.1-36 36-36c69.1 0 136.2 13.5 199.3 40.3C772.3 66 827 103 874 150c47 47 83.9 101.8 109.7 162.7 26.7 63.1 40.2 130.2 40.2 199.3.1 19.9-16 36-35.9 36z" })), ' '],
        props.text,
        omi.h("slot", null));
    };
    Button.css = css$1;
  ...
  var ToolTip = /** @class */ (function (_super) {
    ...
    ToolTip.prototype.render = function (props) {
      ...
      return omi.h(omi.h.f, null,
        ...
        omi.h("div", {
          ref: function (e) { return _this.popEl = e; }, class: omi.classNames((_a = {
            tip: true,
            show: this.isShow
          },
          ...
          omi.h("p", { class: "content" },
            omi.h("slot", { name: "icon" }),
            props.content),
          omi.h("div", { class: "btns" },
            omi.h("o-button", { size: "mini", onclick: this.cancel }, props.cancelButtonText || '取消'),
            " ",
            omi.h("o-button", { onclick: this.confirm, type: "primary", size: "mini" }, props.confirmButtonText || '确认')),
