...
var Table = /** @class */ (function (_super) {
    ...
    Table.prototype.render = function (props) {
        return (omi_1.h("div", __assign({}, omi_1.extractClass(props, 'o-checkbox', {
            ...
            omi_1.h("input", __assign({ type: "checkbox", onChange: this.changeHandler }, extract(props, ['checked', 'value', 'indeterminate']), { class: "o-checkbox__native-control", id: "checkbox" })),
