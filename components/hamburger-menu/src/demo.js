...
/***/ (function (module, exports, __webpack_require__) {
      ...
      Object.defineProperty(exports, "__esModule", { value: true });
      var omi_1 = __webpack_require__(/*! omi */ "./node_modules/_omi@6.19.21@omi/dist/omi.esm.js");
      ...
      var Button = /** @class */ (function (_super) {
        ...
        function Button() {
          ...
          _this.onClick = function () {
            ...
            console.log(_this.props.active);
            _this.fire('change', _this.props.active);
          };
          return _this;
        }
        Button.prototype.render = function (props) {
          return omi_1.h("a", __assign({ href: "javascript:", onClick: this.onClick }, omi_1.extractClass(props, 'o-hamburger-menu', {
            'active': props.active,
          }), { "aria-label": props.ariaLabel }),
            omi_1.h("span", { style: { backgroundColor: props.color }, class: "fixin top-bun" }),
            omi_1.h("span", { style: { backgroundColor: props.color }, class: "fixin patty" }),
            omi_1.h("span", { style: { backgroundColor: props.color }, class: "fixin bottom-bun" }));
        };
        Button.css = css;
        Button.defaultProps = {
          active: false,
