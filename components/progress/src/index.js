(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["OProgress"] = factory(require("omi"));
	else
		root["OProgress"] = factory(root["Omi"]);
...
var type_status2icon = {
    'circle': {
        'success': omi_1.h("o-icon-check-rounded", null),
        'error': omi_1.h("o-icon-close-rounded", null)
    },
    'line': {
        'success': omi_1.h("o-icon-check-circle-rounded", null),
...
var default_1 = /** @class */ (function (_super) {
    ...
    default_1.prototype.render = function (props) {
        ...
        if (type === "circle") {
            ...
            return (omi_1.h("div", { style: { width: width, height: width } },
            ...
            return (omi_1.h("div", null,
                omi_1.h("div", { className: "o-progress-line__outer", style: { width: width } },
