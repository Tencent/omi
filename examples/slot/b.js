(function () {
	...
	function render(vnode, parent, store) {
	    ...
	    if (store) {
	        ...
	        options.store = store;
	        var jp = new JSONPatcherProxy(store.data);
	        store.data = jp.observe(true, handler);
	    }
	...
	var HelloElement = (_dec = tag('hello-element'), _dec(_class = function (_WeElement) {
	...
	var MyApp = (_dec2 = tag('my-app'), _dec2(_class2 = function (_WeElement2) {
	    _inherits$1(MyApp, _WeElement2);

	    function MyApp() {
	        _classCallCheck$1(this, MyApp);
